...
class SendPostcardRequestRecipientsInner(BaseModel):
    """
    ...
    return_address_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["address_name", "address_city", "address_state", "address_postal_code", "address_country", "address_line_1", "return_address_id"]
