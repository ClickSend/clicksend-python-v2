...
class CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt(BaseModel):
    """
    The parameters related to the time of your request.
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, description="The time you made the request. It will be in <a href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601</a> format.", alias="date")
    timezone_type: Optional[StrictInt] = Field(default=None, description="The offset value from the time you made the request.")
    timezone: Optional[StrictStr] = Field(default=None, description="The timezone when you made the request.")
