...
class SmsTemplate(BaseModel):
    ...
    body: Optional[StrictStr] = Field(default=None, description="The main content of the template.", json_schema_extra={"examples": ["This is a sample template."]})
    template_name: Optional[StrictStr] = Field(default=None, description="The name of the template.", json_schema_extra={"examples": ["My Awesome Template"]})
