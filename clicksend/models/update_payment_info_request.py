...
class UpdatePaymentInfoRequest(BaseModel):
    ...
    expiry_month: Optional[StrictInt] = None
    expiry_year: Optional[StrictInt] = None
    cvc: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    bank_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["number", "expiry_month", "expiry_year", "cvc", "name", "bank_name"]
