...
class VoiceDeliveryReceiptRule(BaseModel):
    """
    VoiceDeliveryReceiptRule
    """ # noqa: E501
    receipt_rule_id: Optional[StrictInt] = Field(default=None, description="The ID of the receipt rule.", json_schema_extra={"examples": [2]})
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the receipt rule.", json_schema_extra={"examples": ["My Rule 2"]})
    match_type: Optional[StrictInt] = Field(default=None, description="The match type of the receipt rule.", json_schema_extra={"examples": [3]})
    action: Optional[StrictStr] = Field(default=None, description="The action of the receipt rule.", json_schema_extra={"examples": ["URL"]})
    action_address: Optional[StrictStr] = Field(default=None, description="The action address of the receipt rule.", json_schema_extra={"examples": ["http://yourdomain.com"]})
    enabled: Optional[StrictInt] = Field(default=None, description="The enabled status of the receipt rule.", json_schema_extra={"examples": [1]})
