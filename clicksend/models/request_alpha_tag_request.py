...
class RequestAlphaTagRequest(BaseModel):
    """
    RequestAlphaTagRequest
    """ # noqa: E501
    alpha_tag: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    countries: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=1)]] = None
    businesses: Optional[Annotated[List[RequestAlphaTagRequestBusinessesInner], Field(min_length=1, max_length=1)]] = None
    __properties: ClassVar[List[str]] = ["alpha_tag", "reason", "countries", "businesses"]
    ...
    def countries_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['AU']):
                raise ValueError("each list item must be one of ('AU')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.businesses:
            for _item_businesses in self.businesses:
                if _item_businesses:
                    _items.append(_item_businesses.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "businesses": [RequestAlphaTagRequestBusinessesInner.from_dict(_item) for _item in obj["businesses"]] if obj.get("businesses") is not None else None
        })
        return _obj
