...
class ViewSmsTemplatesData(BaseModel):
    """
    ...
    data: Optional[List[SmsTemplate]] = Field(default=None, description="The parameters related to the actual templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [SmsTemplate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
