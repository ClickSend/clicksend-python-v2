...
class EmailDeliveryReceiptRule(BaseModel):
    """
    EmailDeliveryReceiptRule
    """ # noqa: E501
    receipt_rule_id: Optional[StrictInt] = Field(default=None, description="The ID of the receipt rule.", json_schema_extra={"examples": [1]})
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the receipt rule.", json_schema_extra={"examples": ["Email Test Rule"]})
    match_type: Optional[StrictInt] = Field(default=None, description="The type of match for the rule.", json_schema_extra={"examples": [0]})
    action: Optional[StrictStr] = Field(default=None, description="The action to be taken by the rule.", json_schema_extra={"examples": ["URL"]})
    action_address: Optional[StrictStr] = Field(default=None, description="The address associated with the action.", json_schema_extra={"examples": ["http://yourdomain.com"]})
    ...
    __properties: ClassVar[List[str]] = ["receipt_rule_id", "rule_name", "match_type", "action", "action_address", "enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "receipt_rule_id": obj.get("receipt_rule_id"),
