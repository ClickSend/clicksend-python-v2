...
class CreateReturnAddress(BaseModel):
    """
    CreateReturnAddress
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["New return address has been added."]})
