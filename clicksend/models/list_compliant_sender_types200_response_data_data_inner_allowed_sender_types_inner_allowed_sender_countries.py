...
class ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries(BaseModel):
    """
    ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries
    """ # noqa: E501
    var_global: StrictBool = Field(description="Whether this sender type is allowed sending from any country", alias="global")
    country_codes: Optional[List[StrictStr]] = Field(default=None, description="List of ISO 3166-1 alpha-2 formatted country codes")
    __properties: ClassVar[List[str]] = ["global", "country_codes"]
