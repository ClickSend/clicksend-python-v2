...
class Sms(BaseModel):
    ...
    Sms
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, description="The date you sent the message. It is in <a href=\"http://help.clicksend.com/what-is-a-unix-timestamp\" target=\"_blank\">Unix format</a>. Returned as a string since it may be an empty string in price-calculation responses where no message has actually been sent yet.", alias="date", json_schema_extra={"examples": ["1436871253"]})
