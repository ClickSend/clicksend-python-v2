...
class CalculateSmsPriceDataSummary(BaseModel):
    """
    The parameters for additional summary. It shows the guidelines for each country you have selected.
    """ # noqa: E501
    test_message: Optional[StrictStr] = Field(default=None, description="This parameter is used for internal developers. This is used when your account is in trial period.")
    countries: Optional[List[CalculateSmsPriceDataSummaryCountriesInner]] = Field(default=None, description="The list of countries of the receipients in two-letter format (e.g. US, UK, AU, NZ, etc).")
    __properties: ClassVar[List[str]] = ["test_message", "countries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "countries": [CalculateSmsPriceDataSummaryCountriesInner.from_dict(_item) for _item in obj["countries"]] if obj.get("countries") is not None else None
        })
        return _obj
