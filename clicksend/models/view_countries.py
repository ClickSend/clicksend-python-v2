...
class ViewCountries(BaseModel):
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["List of Countries."]})
    data: Optional[List[Country]] = Field(default=None, json_schema_extra={"examples": [[{"code": "AF", "value": "Afghanistan"}, {"code": "AU", "value": "Australia"}, {"code": "FI", "value": "Finland"}]]})
