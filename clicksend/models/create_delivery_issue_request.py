...
class CreateDeliveryIssueRequest(BaseModel):
    """
    ...
    client_comments: Optional[StrictStr] = None
    support_comments: Optional[StrictStr] = None
    resolved: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["message_id", "type", "description", "email_address", "client_comments", "support_comments", "resolved"]
