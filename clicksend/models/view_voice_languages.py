...
class ViewVoiceLanguages(BaseModel):
    ...
    data: Optional[List[ViewVoiceLanguagesDataInner]] = Field(default=None, json_schema_extra={"examples": [[{"code": "en-us", "country": "English, US", "gender": ["male", "female"]}, {"code": "en-au", "country": "English, Australia", "gender": ["male", "female"]}]]})
