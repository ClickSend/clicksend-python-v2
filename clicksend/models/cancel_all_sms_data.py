...
class CancelAllSmsData(BaseModel):
    """
    The parameters related to the cancelled scheduled SMS.
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The number of scehduled SMS cancelled.", json_schema_extra={"examples": [2]})
