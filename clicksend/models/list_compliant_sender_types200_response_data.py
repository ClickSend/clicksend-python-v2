...
class ListCompliantSenderTypes200ResponseData(BaseModel):
    """
    ListCompliantSenderTypes200ResponseData
    """ # noqa: E501
    data: Annotated[List[ListCompliantSenderTypes200ResponseDataDataInner], Field(min_length=1)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCompliantSenderTypes200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCompliantSenderTypes200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ListCompliantSenderTypes200ResponseDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
