...
class CalculateLetterPriceData(BaseModel):
    """
    CalculateLetterPriceData
    """ # noqa: E501
    total_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total price of the letter.", json_schema_extra={"examples": [1.87]})
    total_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total cost of the letter.", json_schema_extra={"examples": [1]})
    recipients: Optional[List[Recipient]] = Field(default=None, json_schema_extra={"examples": [[{"user_id": 1, "subaccount_id": 1, "message_id": "06FAD39C-78FD-4D2F-B606-9846D1979F35", "address_name": "John Smith", "address_line_1": "131", "address_line_2": "Scheuvront Drive", "address_city": "DENVER", "address_state": "CO", "address_postal_code": 80202, "address_country": "AU", "return_address_id": 1, "schedule": 1449573604, "post_pages": 3, "post_price": "1.8700", "priority_post": 0, "date_added": 1449662203, "status": "SUCCESS"}]]})
    __properties: ClassVar[List[str]] = ["total_price", "total_cost", "recipients"]
