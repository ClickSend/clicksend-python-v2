...
class CalculateMmsPriceRequest(BaseModel):
    """
    CalculateMmsPriceRequest
    """ # noqa: E501
    media_file: Optional[StrictStr] = None
    messages: Optional[List[CalculateMmsPriceRequestMessagesInner]] = None
    __properties: ClassVar[List[str]] = ["media_file", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [CalculateMmsPriceRequestMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
