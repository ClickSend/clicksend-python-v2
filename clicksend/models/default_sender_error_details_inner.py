...
class DefaultSenderErrorDetailsInner(BaseModel):
    """
    DefaultSenderErrorDetailsInner
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="The field that caused the error", alias="field", json_schema_extra={"examples": ["default_sender_strategies[0].sender_id"]})
    reason: Optional[StrictStr] = Field(default=None, description="The error message", json_schema_extra={"examples": ["Invalid sender ID format"]})
