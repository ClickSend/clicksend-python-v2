...
class MarkSpecificInboundSmsMessageAsRead(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Receipt have been marked as read."]})
    data: Optional[StrictInt] = Field(default=None, description="The number of SMS marked as read.  If you have multiple inbound rules set to POLL, you will receive the inbound message multiple times. Reading it will mark all those messages as read.", json_schema_extra={"examples": [1]})
