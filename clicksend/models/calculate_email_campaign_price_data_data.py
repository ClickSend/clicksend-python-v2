...
class CalculateEmailCampaignPriceDataData(BaseModel):
    """
    CalculateEmailCampaignPriceDataData
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name.", json_schema_extra={"examples": ["John Doe"]})
    subject: Optional[StrictStr] = Field(default=None, description="Your template subject.", json_schema_extra={"examples": ["Lorem Ipsum"]})
    from_email_address_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The allowed email address id.", json_schema_extra={"examples": [2]})
    from_name: Optional[StrictStr] = Field(default=None, description="Your sender name.", json_schema_extra={"examples": ["From name"]})
    body: Optional[StrictStr] = Field(default=None, description="Your message.", json_schema_extra={"examples": ["<p>This is a test</p>"]})
    list_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Your list id.", json_schema_extra={"examples": [456]})
    __properties: ClassVar[List[str]] = ["name", "subject", "from_email_address_id", "from_name", "body", "list_id"]
