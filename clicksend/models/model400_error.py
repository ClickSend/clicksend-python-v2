...
class Model400Error(BaseModel):
    ...
    response_msg: StrictStr = Field(description="Message providing additional information.", json_schema_extra={"examples": ["Invalid input."]})
    data: Optional[Dict[str, Any]] = Field(default=None, json_schema_extra={"examples": [{"name": "Name field is required.", "email": "Email field is required."}]})
