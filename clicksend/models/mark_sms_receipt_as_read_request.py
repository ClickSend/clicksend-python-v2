...
class MarkSmsReceiptAsReadRequest(BaseModel):
    """
    MarkSmsReceiptAsReadRequest
    """ # noqa: E501
    date_before: Optional[StrictInt] = Field(default=None, description="The cutoff date. Receipts sent before this time will be marked as read. It’s in the <a target=\"_blank\" href=\"http://help.clicksend.com/what-is-a-unix-timestamp\">Unix format</a>.")
    __properties: ClassVar[List[str]] = ["date_before"]
