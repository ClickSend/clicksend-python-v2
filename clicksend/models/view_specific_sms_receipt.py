...
class ViewSpecificSmsReceipt(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Your receipt."]})
    data: Optional[SmsReceipt] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SmsReceipt.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
