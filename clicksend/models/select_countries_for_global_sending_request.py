...
class SelectCountriesForGlobalSendingRequest(BaseModel):
    """
    SelectCountriesForGlobalSendingRequest
    """ # noqa: E501
    country_list_ids: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["country_list_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country_list_ids": obj.get("country_list_ids")
        })
        return _obj
