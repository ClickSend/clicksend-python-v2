...
class SendMmsCampaignRequest(BaseModel):
    """
    ...
    url_to_shorten: Optional[StrictStr] = None
    subject: Optional[StrictStr] = None
    media_file: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["list_id", "name", "from", "body", "url_to_shorten", "subject", "media_file"]
