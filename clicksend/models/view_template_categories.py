...
class ViewTemplateCategories(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["List of Email Categories"]})
    data: Optional[List[ViewTemplateCategoriesDataInner]] = Field(default=None, json_schema_extra={"examples": [[{"category_id": 2, "category_name": "Alerts/Notificartions"}, {"category_id": 3, "category_name": "Art"}, {"category_id": 4, "category_name": "Birthday"}, {"category_id": 23, "category_name": "Blank Template"}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ViewTemplateCategoriesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
