...
class GetTrackingDataInnerContact(BaseModel):
    """
    GetTrackingDataInnerContact
    """ # noqa: E501
    contact_id: Optional[StrictStr] = Field(default=None, description="Contact ID of the recipient. Null if the recipient is not a contact.", json_schema_extra={"examples": ["224466"]})
    first_name: Optional[StrictStr] = Field(default=None, description="First name of the recipient. Null if the recipient has no data for first name.", json_schema_extra={"examples": ["John"]})
    last_name: Optional[StrictStr] = Field(default=None, description="Last name of the recipient. Null if the recipient has no data last name.", json_schema_extra={"examples": ["Doe"]})
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number of the recipient", json_schema_extra={"examples": ["+1234567890"]})
    __properties: ClassVar[List[str]] = ["contact_id", "first_name", "last_name", "phone_number"]
