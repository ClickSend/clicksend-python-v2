...
class ListCompliantSenderTypes200Response(BaseModel):
    """
    ListCompliantSenderTypes200Response
    """ # noqa: E501
    http_code: StrictInt = Field(description="HTTP status code of the response")
    response_code: StrictStr = Field(description="Code indicating the result of the response")
    response_msg: StrictStr = Field(description="Message providing additional information")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ListCompliantSenderTypes200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
