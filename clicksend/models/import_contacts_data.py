...
class ImportContactsData(BaseModel):
    """
    ImportContactsData
    """ # noqa: E501
    msg: Optional[StrictStr] = Field(default=None, description="The message to display.", json_schema_extra={"examples": ["Messages put on queue."]})
    ids: Optional[List[StrictStr]] = Field(default=None, description="The list of ids of the imported contacts.", json_schema_extra={"examples": [["6254358460638066203"]]})
    id: Optional[StrictStr] = Field(default=None, description="The list id of the imported contacts.", json_schema_extra={"examples": ["6254358460638066203"]})
    __properties: ClassVar[List[str]] = ["msg", "ids", "id"]
