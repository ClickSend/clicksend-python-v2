...
class ViewAllowedEmailAddressesData(BaseModel):
    """
    ...
    data: Optional[List[EmailAddress]] = Field(default=None, json_schema_extra={"examples": [[{"email_address_id": 2, "email_address": "test@user.com", "verified": 1, "date_added": "1447736880"}, {"email_address_id": 3, "email_address": "test2@user.com", "verified": 0, "date_added": "1449042967"}]]})
