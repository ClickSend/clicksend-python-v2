...
class RequestAlphaTagRequestBusinessesInnerPartnerRepresentative(BaseModel):
    """
    ...
    title: Annotated[str, Field(strict=True, max_length=50)]
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "email", "title"]
