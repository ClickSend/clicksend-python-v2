...
class CreateResellerAccountRequest(BaseModel):
    """
    ...
    user_first_name: Optional[StrictStr] = None
    user_last_name: Optional[StrictStr] = None
    account_name: Optional[StrictStr] = None
    user_phone: Optional[StrictStr] = None
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["country", "password", "user_email", "user_first_name", "user_last_name", "account_name", "user_phone", "username"]
