...
class GlobalSendingRegistrationStatus(BaseModel):
    """
    GlobalSendingRegistrationStatus
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the registration status.", json_schema_extra={"examples": [1]})
    name: Optional[StrictStr] = Field(default=None, description="The name of the registration status.", json_schema_extra={"examples": ["NOT_INITIATED"]})
