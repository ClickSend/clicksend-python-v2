...
class SmsTemplateUpdate(BaseModel):
    ...
    """ # noqa: E501
    template_id: Optional[StrictInt] = Field(default=None, description="The generated ID of the template. This remains the same and can’t be updated.", json_schema_extra={"examples": [1]})
    body: Optional[StrictStr] = Field(default=None, description="The new updated content of the template.", json_schema_extra={"examples": ["This is a sample template."]})
    template_name: Optional[StrictStr] = Field(default=None, description="The new updated name of the template.", json_schema_extra={"examples": ["My Awesome Template"]})
    __properties: ClassVar[List[str]] = ["template_id", "body", "template_name"]
