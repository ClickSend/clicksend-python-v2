...
class PostcardRecipientReturnAddress(BaseModel):
    """
    PostcardRecipientReturnAddress
    """ # noqa: E501
    return_address_id: Optional[StrictInt] = Field(default=None, description="The ID of the return address.")
    user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user associated with the return address.")
    address_name: Optional[StrictStr] = Field(default=None, description="The name associated with the return address.")
    address_line_1: Optional[StrictStr] = Field(default=None, description="The first line of the return address.")
    address_line_2: Optional[StrictStr] = Field(default=None, description="The second line of the return address.")
    address_city: Optional[StrictStr] = Field(default=None, description="The city of the return address.")
    address_state: Optional[StrictStr] = Field(default=None, description="The state of the return address.")
    address_postal_code: Optional[StrictStr] = Field(default=None, description="The postal code of the return address.")
    address_country: Optional[StrictStr] = Field(default=None, description="The country code of the return address.")
