...
class UpdateVoiceDeliveryReceiptRule(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Your rule incoming voice receipt."]})
