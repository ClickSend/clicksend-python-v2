...
class CancelEmailCampaignRequest(BaseModel):
    """
    CancelEmailCampaignRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    subject: Optional[StrictStr] = None
    from_email_address_id: Optional[StrictInt] = None
    template_id: Optional[StrictInt] = None
    list_id: Optional[StrictInt] = None
    from_name: Optional[StrictStr] = None
    draft: Optional[StrictInt] = None
    schedule: Optional[StrictStr] = None
    custom_string: Optional[StrictStr] = None
    body: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "subject", "from_email_address_id", "template_id", "list_id", "from_name", "draft", "schedule", "custom_string", "body"]
