...
class EmailAddress(BaseModel):
    ...
    EmailAddress
    """ # noqa: E501
    email_address_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for the email address.", json_schema_extra={"examples": [2]})
    email_address: Optional[StrictStr] = Field(default=None, description="The email address.", json_schema_extra={"examples": ["test2@user.com"]})
    verified: Optional[StrictInt] = Field(default=None, description="Flag indicating if the email address is verified.", json_schema_extra={"examples": [0]})
    date_added: Optional[StrictStr] = Field(default=None, description="The date the email address was added.", json_schema_extra={"examples": ["1436157486"]})
    __properties: ClassVar[List[str]] = ["email_address_id", "email_address", "verified", "date_added"]
