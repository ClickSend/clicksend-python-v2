...
class CreateFaxDeliveryReceiptRuleRequest(BaseModel):
    """
    CreateFaxDeliveryReceiptRuleRequest
    """ # noqa: E501
    rule_name: Optional[StrictStr] = None
    match_type: Optional[StrictInt] = None
    action: Optional[StrictStr] = None
    action_address: Optional[StrictStr] = None
    enabled: Optional[StrictInt] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["rule_name", "match_type", "action", "action_address", "enabled", "url"]
