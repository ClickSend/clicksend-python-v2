...
class ViewTemplatesInCategory(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["List of Email Templates By Category"]})
    data: Optional[List[MasterEmailTemplate]] = Field(default=None, json_schema_extra={"examples": [[{"template_id_master": 1, "category_id": 1, "template_name": "Minty", "body": "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" ...\n                     </tr>\n                  </tbody>\n               </table>\n            </td>\n         </tr>\n      </tbody>\n   </table>\n</body>\n</html>", "date_added": "1445848821", "thumbnail": {"small": "https://s3-ap-southeast-2.amazonaws.com/clicksend-api-downloads/_email-marketing/_templates-master/basic2/thumb-small.jpg", "large": "https://s3-ap-southeast-2.amazonaws.com/clicksend-api-downloads/_email-marketing/_templates-master/basic2/thumb-large.jpg"}}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [MasterEmailTemplate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
