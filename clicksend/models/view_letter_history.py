...
class ViewLetterHistory(BaseModel):
    """
    ViewLetterHistory
    """ # noqa: E501
    ...
    data: Optional[ViewLetterHistoryData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ViewLetterHistoryData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
