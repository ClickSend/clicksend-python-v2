...
class ViewFaxReceiptsData(BaseModel):
    """
    ViewFaxReceiptsData
    """ # noqa: E501
    ...
    data: Optional[List[FaxReceipt]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [FaxReceipt.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
