...
class InboundFaxRule(BaseModel):
    """
    InboundFaxRule
    """ # noqa: E501
    inbound_rule_id: Optional[StrictInt] = Field(default=None, description="The ID of the inbound rule", json_schema_extra={"examples": [1]})
    dedicated_number: Optional[StrictStr] = Field(default=None, description="The dedicated number", json_schema_extra={"examples": ["19"]})
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the inbound rule", json_schema_extra={"examples": ["Email"]})
    user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user", json_schema_extra={"examples": [1]})
    action: Optional[StrictStr] = Field(default=None, description="The action", json_schema_extra={"examples": ["EMAIL_FIXED"]})
    action_address: Optional[StrictStr] = Field(default=None, description="The address associated with the action", json_schema_extra={"examples": ["test@test.com"]})
    enabled: Optional[StrictInt] = Field(default=None, description="Indicates whether the rule is enabled", json_schema_extra={"examples": [1]})
    __properties: ClassVar[List[str]] = ["inbound_rule_id", "dedicated_number", "rule_name", "user_id", "action", "action_address", "enabled"]
