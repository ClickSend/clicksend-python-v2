...
class UpdatePaymentInfoData(BaseModel):
    """
    UpdatePaymentInfoData
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="The token.", json_schema_extra={"examples": ["cus_6Z3mHM9QvQQoJ28WsIWuLA"]})
