...
class DeleteSubaccount(BaseModel):
    """
    DeleteSubaccount
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Subaccount #59 has been deleted"]})
    data: Optional[StrictBool] = Field(default=None, description="The status of the operation.", json_schema_extra={"examples": [True]})
