...
class CreateSmsInboundAutomationRequest(BaseModel):
    """
    CreateSmsInboundAutomationRequest
    """ # noqa: E501
    dedicated_number: Optional[StrictStr] = None
    rule_name: Optional[StrictStr] = None
    message_search_type: Optional[StrictInt] = None
    message_search_term: Optional[StrictStr] = None
    action: Optional[StrictStr] = None
    action_address: Optional[StrictStr] = None
    body: Optional[StrictStr] = None
    enabled: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["dedicated_number", "rule_name", "message_search_type", "message_search_term", "action", "action_address", "body", "enabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if message_search_term (nullable) is None
        # and model_fields_set contains the field
        if self.message_search_term is None and "message_search_term" in self.model_fields_set:
            _dict['message_search_term'] = None
