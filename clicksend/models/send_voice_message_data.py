...
class SendVoiceMessageData(BaseModel):
    """
    SendVoiceMessageData
    """ # noqa: E501
    total_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total price of the message.", json_schema_extra={"examples": [0.07]})
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total count of the message.", json_schema_extra={"examples": [1]})
    queued_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The count of the queued message.", json_schema_extra={"examples": [1]})
    messages: Optional[List[VoiceMessage]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [VoiceMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
