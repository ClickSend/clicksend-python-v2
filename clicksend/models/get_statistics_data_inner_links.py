...
class GetStatisticsDataInnerLinks(BaseModel):
    """
    Link statistics
    """ # noqa: E501
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of recipients", json_schema_extra={"examples": [2]})
    opened_unique: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of recipients that clicked the short URL", json_schema_extra={"examples": [2]})
    opened_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of clicks on the short URL (e.g. when a recipient clicked the short URL twice, then it will add 2 here)", json_schema_extra={"examples": [5]})
    unopened: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of recipients that did not click the short URL (i.e. `total` - `opened_unique`)", json_schema_extra={"examples": [0]})
    __properties: ClassVar[List[str]] = ["total", "opened_unique", "opened_total", "unopened"]
