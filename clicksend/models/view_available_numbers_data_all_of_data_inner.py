...
class ViewAvailableNumbersDataAllOfDataInner(BaseModel):
    """
    ViewAvailableNumbersDataAllOfDataInner
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="The country code of the number.")
    country_name: Optional[StrictStr] = Field(default=None, description="The country name of the number.")
    dedicated_number: Optional[StrictStr] = Field(default=None, description="The dedicated number.")
    price_setup: Optional[StrictStr] = Field(default=None, description="The setup price of the number.")
    price_monthly: Optional[StrictStr] = Field(default=None, description="The monthly price of the number.")
    price_total: Optional[StrictStr] = Field(default=None, description="The total price of the number.")
    address_requirement: Optional[StrictStr] = Field(default=None, description="The address requirement for the number.  <br> `local`: requires an address that corresponds  to the phone number's prefix.")
    __properties: ClassVar[List[str]] = ["country", "country_name", "dedicated_number", "price_setup", "price_monthly", "price_total", "address_requirement"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if address_requirement (nullable) is None
        # and model_fields_set contains the field
        if self.address_requirement is None and "address_requirement" in self.model_fields_set:
            _dict['address_requirement'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_setup": obj.get("price_setup"),
            "price_monthly": obj.get("price_monthly"),
            "price_total": obj.get("price_total"),
            "address_requirement": obj.get("address_requirement")
        })
        return _obj
