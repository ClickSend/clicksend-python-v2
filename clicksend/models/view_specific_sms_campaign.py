...
class ViewSpecificSmsCampaign(BaseModel):
    """
    ...
    response_code: Optional[StrictStr] = Field(default=None, description="The response code of the operation. Visit Visit [this page](/#status-codes) for more information.", json_schema_extra={"examples": ["SUCCESS"]})
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Your SMS Campaign."]})
    data: Optional[SmsCampaign] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SmsCampaign.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
