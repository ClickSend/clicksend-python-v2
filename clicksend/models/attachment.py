...
class Attachment(BaseModel):
    ...
    Attachment
    """ # noqa: E501
    file_name: Optional[StrictStr] = Field(default=None, description="The name of the attached file.")
    content_type: Optional[StrictStr] = Field(default=None, description="The MIME type of the attached file.")
    content_disposition: Optional[StrictStr] = Field(default=None, description="The content disposition of the attached file.")
    content_id: Optional[StrictStr] = Field(default=None, description="The content ID of the attached file.")
    attachment_file_url: Optional[StrictStr] = Field(default=None, description="The URL to download the attached file.", alias="_attachment_file_url")
    __properties: ClassVar[List[str]] = ["file_name", "content_type", "content_disposition", "content_id", "_attachment_file_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_attachment_file_url": obj.get("_attachment_file_url")
        })
        return _obj
