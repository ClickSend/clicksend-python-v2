...
class SendSmsRequestMessagesInner(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default='sdk-python', description="The source of the request. For example, the name of your application. It's used to identify messages sent from various applications.")
