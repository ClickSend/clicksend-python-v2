...
class ViewTemplateCategoryData(BaseModel):
    """
    ViewTemplateCategoryData
    """ # noqa: E501
    category_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the category.", json_schema_extra={"examples": [4]})
    name: Optional[StrictStr] = Field(default=None, description="The name of the category.", json_schema_extra={"examples": ["Birthday"]})
