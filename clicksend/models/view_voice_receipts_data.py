...
class ViewVoiceReceiptsData(BaseModel):
    """
    ...
    data: Optional[List[VoiceReceipt]] = Field(default=None, json_schema_extra={"examples": [[{"timestamp_send": "1442381791", "timestamp": "1442381791", "message_id": "31BC271B-1E0C-45F6-9E7E-97186C46BB82", "status_code": "201", "status_text": "Success: Message received on handset.", "message_type": "voice", "digits": 2}, {"timestamp_send": "1442381829", "timestamp": "1442381829", "message_id": "23C8ADA3-FD8B-420B-801A-F829BB87AC6F", "status_code": "201", "status_text": "Success: Message received on handset.", "message_type": "voice", "digits": 5}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [VoiceReceipt.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
