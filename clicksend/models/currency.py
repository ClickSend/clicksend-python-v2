...
class Currency(BaseModel):
    ...
    """ # noqa: E501
    currency_name_short: Optional[StrictStr] = Field(default=None, description="The currency used for the sender in three-letter format (e.g. USD, EUR, AUD, NZD, etc).", json_schema_extra={"examples": ["AUD"]})
