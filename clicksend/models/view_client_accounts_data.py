...
class ViewClientAccountsData(BaseModel):
    """
    ...
    data: Optional[List[ResellerAccount]] = None
    ...
    __properties: ClassVar[List[str]] = ["total", "per_page", "current_page", "last_page", "next_page_url", "prev_page_url", "from", "to", "data", "_currency", "_subaccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [ResellerAccount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
