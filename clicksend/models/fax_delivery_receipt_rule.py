...
class FaxDeliveryReceiptRule(BaseModel):
    """
    ...
    match_type: Optional[StrictInt] = Field(default=None, description="The type of match.", json_schema_extra={"examples": [0]})
    action: Optional[StrictStr] = Field(default=None, description="The action triggered by the rule.", json_schema_extra={"examples": ["URL"]})
