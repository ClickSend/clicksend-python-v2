...
class RemoveDuplicateContactsRequest(BaseModel):
    """
    RemoveDuplicateContactsRequest
    """ # noqa: E501
    fields: Optional[RemoveDuplicateContactsRequestFields] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": RemoveDuplicateContactsRequestFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
        return _obj
