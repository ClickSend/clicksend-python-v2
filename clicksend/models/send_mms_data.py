...
class SendMmsData(BaseModel):
    """
    SendMmsData
    """ # noqa: E501
    total_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total price of the MMS messages.", json_schema_extra={"examples": [13.2]})
    total_count: Optional[StrictInt] = Field(default=None, description="The total count of the MMS messages.", json_schema_extra={"examples": [1]})
    queued_count: Optional[StrictInt] = Field(default=None, description="The count of the queued MMS messages.", json_schema_extra={"examples": [1]})
    messages: Optional[List[Mms]] = None
    __properties: ClassVar[List[str]] = ["total_price", "total_count", "queued_count", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [Mms.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
