...
class ViewFaxDeliveryReceiptRulesData(BaseModel):
    """
    ...
    data: Optional[List[FaxDeliveryReceiptRule]] = Field(default=None, json_schema_extra={"examples": [[{"receipt_rule_id": 1, "rule_name": "Email Test Rule", "match_type": 0, "action": "URL", "action_address": "http://yourdomain.com", "enabled": 1}, {"receipt_rule_id": 2, "rule_name": "test", "match_type": 0, "action": "URL", "action_address": "http://yourdomain.com", "enabled": 1}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [FaxDeliveryReceiptRule.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
