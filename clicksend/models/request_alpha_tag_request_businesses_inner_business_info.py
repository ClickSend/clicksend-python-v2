...
class RequestAlphaTagRequestBusinessesInnerBusinessInfo(BaseModel):
    """
    RequestAlphaTagRequestBusinessesInnerBusinessInfo
    """ # noqa: E501
    website: Annotated[str, Field(strict=True, max_length=128)] = Field(description="Business website URL")
    phone_number: Annotated[str, Field(strict=True, max_length=15)] = Field(description="E.164 or local format")
    __properties: ClassVar[List[str]] = ["website", "phone_number"]
