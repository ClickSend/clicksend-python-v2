...
class ViewFaxInboundRulesData(BaseModel):
    """
    ...
    data: Optional[List[InboundFaxRule]] = Field(default=None, json_schema_extra={"examples": [[{"inbound_rule_id": 1, "dedicated_number": 19, "rule_name": "Email", "user_id": "1", "action": "EMAIL_FIXED", "action_address": "test@test.com", "enabled": "1"}, {"inbound_rule_id": 2, "dedicated_number": 19, "rule_name": "URL", "user_id": "1", "action": "URL", "action_address": "http://yourdomain.com", "enabled": "0"}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [InboundFaxRule.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
