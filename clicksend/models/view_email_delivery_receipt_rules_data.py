...
class ViewEmailDeliveryReceiptRulesData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total", "per_page", "current_page", "last_page", "next_page_url", "prev_page_url", "from", "to"]
