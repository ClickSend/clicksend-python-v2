...
class CalculateSmsPriceDataSummaryCountriesInner(BaseModel):
    """
    CalculateSmsPriceDataSummaryCountriesInner
    """ # noqa: E501
    country: Optional[CalculateSmsPriceDataSummaryCountriesInnerCountry] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CalculateSmsPriceDataSummaryCountriesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CalculateSmsPriceDataSummaryCountriesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "country": CalculateSmsPriceDataSummaryCountriesInnerCountry.from_dict(obj["country"]) if obj.get("country") is not None else None
        })
        return _obj
