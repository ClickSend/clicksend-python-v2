...
class GetStatisticsDataInnerDeviceInner(BaseModel):
    """
    GetStatisticsDataInnerDeviceInner
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Device name", json_schema_extra={"examples": ["mobile"]})
    count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of clicks on the short URL where the recipient has the specified device name", json_schema_extra={"examples": [2]})
