...
class ViewInboundSmsData(BaseModel):
    """
    ViewInboundSmsData
    """ # noqa: E501
    ...
    data: Optional[List[InboundSms]] = Field(default=None, description="The parameters related to the actual inbound SMS.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [InboundSms.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
