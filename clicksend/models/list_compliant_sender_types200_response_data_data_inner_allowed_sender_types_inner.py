...
class ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner(BaseModel):
    """
    ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner
    """ # noqa: E501
    sender_type: StrictStr = Field(description="Type of sender")
    allowed_sender_countries: ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries
    __properties: ClassVar[List[str]] = ["sender_type", "allowed_sender_countries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of allowed_sender_countries
        if self.allowed_sender_countries:
            _dict['allowed_sender_countries'] = self.allowed_sender_countries.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowed_sender_countries": ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries.from_dict(obj["allowed_sender_countries"]) if obj.get("allowed_sender_countries") is not None else None
        })
        return _obj
