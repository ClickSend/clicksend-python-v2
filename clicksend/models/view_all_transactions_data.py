...
class ViewAllTransactionsData(BaseModel):
    """
    ...
    data: Optional[List[ViewAllTransactionsDataAllOfDataInner]] = Field(default=None, json_schema_extra={"examples": [[{"invoice_number": "cb726c65-1c65-47fa-aea2-3ded9ed57557", "amount": 20, "currency": "AUD", "date": 1443420196}, {"invoice_number": "13d35606-5f10-4d31-9de4-065b025aa5b8", "amount": 20, "currency": "AUD", "date": 1443420094}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [ViewAllTransactionsDataAllOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
