...
class PurchaseRechargePackageData(BaseModel):
    """
    ...
    amount: Optional[StrictInt] = Field(default=None, description="The amount of the package.", json_schema_extra={"examples": [50]})
    currency: Optional[StrictStr] = Field(default=None, description="The currency of the package.", json_schema_extra={"examples": ["USD"]})
    amount_aud: Optional[StrictInt] = Field(default=None, description="The amount of the package in AUD.")
    var_date: Optional[StrictInt] = Field(default=None, description="The timestamp of when the package was purchased.", alias="date", json_schema_extra={"examples": [1481610495]})
    __properties: ClassVar[List[str]] = ["user_id", "amount", "currency", "amount_aud", "date"]
