...
class ViewAllTransactionsDataAllOfDataInner(BaseModel):
    """
    ViewAllTransactionsDataAllOfDataInner
    """ # noqa: E501
    invoice_number: Optional[StrictStr] = Field(default=None, description="The invoice number.", json_schema_extra={"examples": ["cb726c65-1c65-47fa-aea2-3ded9ed57557"]})
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of the transaction.", json_schema_extra={"examples": [20]})
    currency: Optional[StrictStr] = Field(default=None, description="The currency of the transaction.", json_schema_extra={"examples": ["AUD"]})
    var_date: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The date of the transaction.", alias="date", json_schema_extra={"examples": [1443420196]})
    __properties: ClassVar[List[str]] = ["invoice_number", "amount", "currency", "date"]
