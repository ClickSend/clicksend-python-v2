...
class CopyContactToList(BaseModel):
    """
    CopyContactToList
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Contact #1 has been copied to List #429"]})
