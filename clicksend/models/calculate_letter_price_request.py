...
class CalculateLetterPriceRequest(BaseModel):
    """
    CalculateLetterPriceRequest
    """ # noqa: E501
    file_url: Optional[StrictStr] = None
    template_used: Optional[StrictInt] = None
    duplex: Optional[StrictInt] = None
    colour: Optional[StrictInt] = None
    source: Optional[StrictStr] = None
    recipients: Optional[List[SendPostcardRequestRecipientsInner]] = None
    __properties: ClassVar[List[str]] = ["file_url", "template_used", "duplex", "colour", "source", "recipients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipients": [SendPostcardRequestRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None
        })
        return _obj
