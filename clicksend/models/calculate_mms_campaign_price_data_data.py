...
class CalculateMmsCampaignPriceDataData(BaseModel):
    """
    CalculateMmsCampaignPriceDataData
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, description="The sender id.", alias="from", json_schema_extra={"examples": ["+61411111111"]})
    schedule: Optional[StrictStr] = Field(default=None, description="The schedule timestamp.", json_schema_extra={"examples": ["1577833200"]})
    body: Optional[StrictStr] = Field(default=None, description="The message body.", json_schema_extra={"examples": ["Hey test, I want to ask if this is your lastname: ? Also, do you like koalas?"]})
    __properties: ClassVar[List[str]] = ["from", "schedule", "body"]
