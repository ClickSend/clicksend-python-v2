...
class UserEmailTemplate(BaseModel):
    """
    UserEmailTemplate
    """ # noqa: E501
    template_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for the template.", json_schema_extra={"examples": [292]})
    ...
    template_name: Optional[StrictStr] = Field(default=None, description="The name of the template.", json_schema_extra={"examples": ["new minion template!"]})
    body: Optional[StrictStr] = Field(default=None, description="The body of the template.", json_schema_extra={"examples": ["<div id=\"nb_wrapper\"><!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"..."]})
    __properties: ClassVar[List[str]] = ["template_id", "template_id_master", "template_name", "body"]
