...
class CurrentPaymentInfoData(BaseModel):
    """
    The data returned by the API call.
    """ # noqa: E501
    display_number: Optional[StrictStr] = Field(default=None, description="The credit card number.", json_schema_extra={"examples": ["XXXX-XXXX-XXXX-0000"]})
    expiry_month: Optional[StrictInt] = Field(default=None, description="The credit card expiry month.", json_schema_extra={"examples": [1]})
    expiry_year: Optional[StrictInt] = Field(default=None, description="The credit card expiry year.", json_schema_extra={"examples": [2020]})
    name: Optional[StrictStr] = Field(default=None, description="The credit card name.", json_schema_extra={"examples": ["Roland Robot"]})
    __properties: ClassVar[List[str]] = ["display_number", "expiry_month", "expiry_year", "name"]
