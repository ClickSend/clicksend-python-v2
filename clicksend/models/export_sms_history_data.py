...
class ExportSmsHistoryData(BaseModel):
    """
    The parameters related to the generated SMS history file.
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The download link to the generated SMS history file.", json_schema_extra={"examples": ["https://rest.clicksend.com/files/22D55AF9-6CF0-476D-A8B3-82A998FD2738?filename=export.csv"]})
