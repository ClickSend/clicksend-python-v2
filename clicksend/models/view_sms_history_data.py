...
class ViewSmsHistoryData(BaseModel):
    """
    ...
    data: Optional[List[ViewSmsHistoryDataAllOfDataInner]] = Field(default=None, description="The parameters related to the actual SMS.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [ViewSmsHistoryDataAllOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
