...
class ViewVoiceStatisticsDataTotal(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["outbound", "bounced"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bounced
        if self.bounced:
            _dict['bounced'] = self.bounced.to_dict()
        return _dict
