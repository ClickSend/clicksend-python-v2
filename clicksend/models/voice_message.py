...
class VoiceMessage(BaseModel):
    ...
    schedule: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The timestamp when the message should be sent.", json_schema_extra={"examples": [1436874701]})
    ...
    message_parts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of parts in the message.", json_schema_extra={"examples": [1]})
    message_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price of the message.", json_schema_extra={"examples": [0.07]})
