...
class VoiceMessage(BaseModel):
    ...
    schedule: Optional[StrictStr] = Field(default=None, description="The timestamp when the message should be sent.", json_schema_extra={"examples": ["1436874701"]})
    ...
    message_parts: Optional[StrictStr] = Field(default=None, description="The number of parts in the message.", json_schema_extra={"examples": ["1"]})
