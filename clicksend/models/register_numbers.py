...
class RegisterNumbers(BaseModel):
    """
    RegisterNumbers
    """ # noqa: E501
    ...
    response_msg: StrictStr = Field(description="Message providing additional information.", json_schema_extra={"examples": ["10DLC number registration notification sent successfully."]})
