...
class CreateSubaccountRequest(BaseModel):
    ...
    sms_deidentify_message: Optional[StrictInt] = None
    access_smpp: Optional[StrictInt] = None
    access_users: Optional[StrictInt] = None
    access_billing: Optional[StrictInt] = None
    access_reporting: Optional[StrictInt] = None
    access_contacts: Optional[StrictInt] = None
    access_settings: Optional[StrictInt] = None
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["api_username", "password", "email", "phone_number", "first_name", "last_name", "user_id", "sms_deidentify_message", "access_smpp", "access_users", "access_billing", "access_reporting", "access_contacts", "access_settings", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sms_deidentify_message": obj.get("sms_deidentify_message"),
