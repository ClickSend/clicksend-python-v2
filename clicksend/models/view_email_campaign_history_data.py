...
class ViewEmailCampaignHistoryData(BaseModel):
    """
    ...
    data: Optional[List[EmailCampaignHistory]] = Field(default=None, json_schema_extra={"examples": [[{"email_campaign_id": 77, "from_name": "test name", "from_address": "4", "to_name": "test2@test.com", "to_address": "test2@test.com", "contact_id": 669105, "subject": "test subject", "message_id": "7CB3227C-7F8C-4A72-A0CB-36283236D99F", "status": "SpamReport", "open_count": 0, "click_count": 0, "hard_bounce_count": 13, "soft_bounce_count": 1}, {"email_campaign_id": 77, "from_name": "test name", "from_address": "4", "to_name": "test2@test.com", "to_address": "test2@test.com", "contact_id": 669105, "subject": "test subject", "message_id": "603C5349-5A24-40B4-89ED-F7619F7CC8A3", "open_count": 0, "click_count": 0, "hard_bounce_count": 0, "soft_bounce_count": 0}, {"email_campaign_id": 77, "from_name": "test name", "from_address": "4", "to_name": "test2@test.com", "to_address": "test2@test.com", "contact_id": 669105, "subject": "test subject", "message_id": "5C5C0918-B263-42AA-8B5D-9E8ACECC0C64", "open_count": 0, "click_count": 0, "hard_bounce_count": 0, "soft_bounce_count": 0}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [EmailCampaignHistory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
