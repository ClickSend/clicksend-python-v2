...
class SmsDeliveryReceiptRule(BaseModel):
    """
    SmsDeliveryReceiptRule
    """ # noqa: E501
    receipt_rule_id: Optional[StrictInt] = Field(default=None, description="The ID of the receipt rule.", json_schema_extra={"examples": [5]})
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the receipt rule.", json_schema_extra={"examples": ["My Rule"]})
    match_type: Optional[StrictInt] = Field(default=None, description="The type of match.", json_schema_extra={"examples": [0]})
    action: Optional[StrictStr] = Field(default=None, description="The type of action.", json_schema_extra={"examples": ["EMAIL_FIXED"]})
    action_address: Optional[StrictStr] = Field(default=None, description="The address associated with the action.", json_schema_extra={"examples": ["john@doe.com"]})
