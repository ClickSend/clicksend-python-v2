...
class ViewAllowedEmailsData(BaseModel):
    """
    ...
    data: Optional[List[ViewAllowedEmailsDataAllOfDataInner]] = Field(default=None, json_schema_extra={"examples": [[{"email_address_id": 84, "email_address": "my@email.com", "from": "+13523944199", "subaccount_id": 345789, "from_fax": "", "voice": "male", "lang": "en-us", "_subaccount_name": "my@email.com"}, {"email_address_id": 85, "email_address": "my@email.com", "from": "+13523944199", "subaccount_id": 345789, "from_fax": "", "voice": "male", "lang": "en-us", "_subaccount_name": "my@email.com"}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [ViewAllowedEmailsDataAllOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
