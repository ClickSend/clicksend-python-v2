...
class CancelMmsCampaign(BaseModel):
    """
    CancelMmsCampaign
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Scheduled MMS campaign has been cancelled."]})
    data: Optional[MmsCampaign] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": MmsCampaign.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
