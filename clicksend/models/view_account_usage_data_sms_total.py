...
class ViewAccountUsageDataSmsTotal(BaseModel):
    """
    ViewAccountUsageDataSmsTotal
    """ # noqa: E501
    count: Optional[StrictStr] = Field(default=None, description="The total count of SMS.")
    price: Optional[StrictStr] = Field(default=None, description="The total price of SMS.")
