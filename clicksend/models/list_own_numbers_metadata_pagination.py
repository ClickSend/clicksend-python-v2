...
class ListOwnNumbersMetadataPagination(BaseModel):
    """
    ListOwnNumbersMetadataPagination
    """ # noqa: E501
    var_self: Optional[StrictStr] = Field(default=None, description="The URL of the current page.", alias="self", json_schema_extra={"examples": ["https://rest.clicksend.com/v3/own-numbers?offset=f99872cc-11a6-48ba-a9f2-bcfb6dd1e3d4#8fa5ebc2-777b-45db-a448-ec76a40d4384&page_size=10"]})
    next: Optional[StrictStr] = Field(default=None, description="The URL of the next page.", json_schema_extra={"examples": ["https://rest.clicksend.com/v3/own-numbers?offset=f99872cc-11a6-48ba-a9f2-bcfb6dd1e3d4#8fa5ebc2-777b-45db-a448-ec76a40d4384&page_size=10"]})
    page_size: Optional[StrictInt] = Field(default=None, description="The number of items returned per page.", json_schema_extra={"examples": [10]})
    __properties: ClassVar[List[str]] = ["self", "next", "page_size"]
