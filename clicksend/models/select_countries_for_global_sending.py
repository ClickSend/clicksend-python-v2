...
class SelectCountriesForGlobalSending(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Here are your countries selection."]})
    data: Optional[List[GlobalSending]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GlobalSending.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
