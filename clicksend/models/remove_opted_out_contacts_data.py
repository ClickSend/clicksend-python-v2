...
class RemoveOptedOutContactsData(BaseModel):
    """
    RemoveOptedOutContactsData
    """ # noqa: E501
    deleted: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of contacts deleted.", json_schema_extra={"examples": [6]})
