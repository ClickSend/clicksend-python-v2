...
class ListOwnNumbers(BaseModel):
    """
    ListOwnNumbers
    """ # noqa: E501
    own_numbers: Optional[List[OwnNumber]] = Field(default=None, description="The list of own numbers.")
    metadata: Optional[ListOwnNumbersMetadata] = Field(default=None, alias="_metadata")
    __properties: ClassVar[List[str]] = ["own_numbers", "_metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in own_numbers (list)
        _items = []
        if self.own_numbers:
            for _item_own_numbers in self.own_numbers:
                if _item_own_numbers:
                    _items.append(_item_own_numbers.to_dict())
            _dict['own_numbers'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "own_numbers": [OwnNumber.from_dict(_item) for _item in obj["own_numbers"]] if obj.get("own_numbers") is not None else None,
            "_metadata": ListOwnNumbersMetadata.from_dict(obj["_metadata"]) if obj.get("_metadata") is not None else None
        })
        return _obj
