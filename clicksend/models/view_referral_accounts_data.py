...
class ViewReferralAccountsData(BaseModel):
    """
    ...
    data: Optional[List[ViewReferralAccountsDataAllOfDataInner]] = Field(default=None, json_schema_extra={"examples": [[{"referral_rule_id": 1, "refered_user_id": 24, "date_referred": 1438260940, "percentage_referral": 5}, {"referral_rule_id": 2, "refered_user_id": 25, "date_referred": 1438260989, "percentage_referral": 5}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [ViewReferralAccountsDataAllOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
