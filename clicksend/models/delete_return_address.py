...
class DeleteReturnAddress(BaseModel):
    """
    DeleteReturnAddress
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Your return address has been deleted."]})
