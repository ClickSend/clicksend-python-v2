...
class ListAlphaTags(BaseModel):
    """
    ListAlphaTags
    """ # noqa: E501
    alpha_tags: Optional[List[AlphaTag]] = Field(default=None, description="The list of alpha tags.")
    metadata: Optional[ListOwnNumbersMetadata] = Field(default=None, alias="_metadata")
    __properties: ClassVar[List[str]] = ["alpha_tags", "_metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in alpha_tags (list)
        _items = []
        if self.alpha_tags:
            for _item_alpha_tags in self.alpha_tags:
                if _item_alpha_tags:
                    _items.append(_item_alpha_tags.to_dict())
            _dict['alpha_tags'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alpha_tags": [AlphaTag.from_dict(_item) for _item in obj["alpha_tags"]] if obj.get("alpha_tags") is not None else None,
