...
class UpdateSmsInboundAutomationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dedicated_number", "rule_name", "message_search_type", "message_search_term", "action", "action_address", "enabled"]
