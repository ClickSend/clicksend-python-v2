...
class BuyNumberRequest(BaseModel):
    ...
    BuyNumberRequest
    """ # noqa: E501
    dedicated_number: StrictStr = Field(description="Phone number to purchase", json_schema_extra={"examples": ["+614197651956"]})
    type: StrictStr = Field(description="Service type for the number", json_schema_extra={"examples": ["sms"]})
    registration_data: Optional[BuyNumberRequestRegistrationData] = None
    __properties: ClassVar[List[str]] = ["dedicated_number", "type", "registration_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of registration_data
        if self.registration_data:
            _dict['registration_data'] = self.registration_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "registration_data": BuyNumberRequestRegistrationData.from_dict(obj["registration_data"]) if obj.get("registration_data") is not None else None
        })
        return _obj
