...
class RequestAlphaTagRequestBusinessesInnerBusinessAddress(BaseModel):
    """
    RequestAlphaTagRequestBusinessesInnerBusinessAddress
    """ # noqa: E501
    addr_line1: Annotated[str, Field(strict=True, max_length=80)]
    addr_line2: Optional[Annotated[str, Field(strict=True, max_length=80)]] = None
    city: Annotated[str, Field(strict=True, max_length=50)]
    state: Annotated[str, Field(strict=True, max_length=100)]
    postal: Annotated[str, Field(strict=True, max_length=10)]
    __properties: ClassVar[List[str]] = ["addr_line1", "addr_line2", "city", "state", "postal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addr_line1": obj.get("addr_line1"),
            "addr_line2": obj.get("addr_line2"),
            "city": obj.get("city"),
            "state": obj.get("state"),
