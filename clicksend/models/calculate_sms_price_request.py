...
class CalculateSmsPriceRequest(BaseModel):
    """
    ...
    messages: Optional[List[CalculateSmsPriceRequestMessagesInner]] = Field(default=None, description="Messages to send to customers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [CalculateSmsPriceRequestMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
