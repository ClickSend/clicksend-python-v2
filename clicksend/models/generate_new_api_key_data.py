...
class GenerateNewApiKeyData(BaseModel):
    """
    GenerateNewApiKeyData
    """ # noqa: E501
    api_key: Optional[StrictStr] = Field(default=None, description="The new API key", json_schema_extra={"examples": ["E72D09F6-AC80-0A5C-F7F0-1A244A377A5C"]})
