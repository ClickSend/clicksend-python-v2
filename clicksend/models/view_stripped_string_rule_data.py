...
class ViewStrippedStringRuleData(BaseModel):
    """
    ViewStrippedStringRuleData
    """ # noqa: E501
    rule_id: Optional[StrictInt] = Field(default=None, description="The rule id", json_schema_extra={"examples": [18]})
    stripped_string: Optional[StrictStr] = Field(default=None, description="The string to be stripped", json_schema_extra={"examples": ["You've received a reply from."]})
    __properties: ClassVar[List[str]] = ["rule_id", "stripped_string"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stripped_string": obj.get("stripped_string")
        })
        return _obj
