...
class MasterEmailTemplateThumbnail(BaseModel):
    """
    MasterEmailTemplateThumbnail
    """ # noqa: E501
    small: Optional[StrictStr] = Field(default=None, description="The small thumbnail of the template.", json_schema_extra={"examples": ["https://s3-ap-southeast-2.amazonaws.com/clicksend-api-downloads/_email-marketing/_templates-master/basic2/thumb-small.jpg"]})
    large: Optional[StrictStr] = Field(default=None, description="The large thumbnail of the template.", json_schema_extra={"examples": ["https://s3-ap-southeast-2.amazonaws.com/clicksend-api-downloads/_email-marketing/_templates-master/basic2/thumb-large.jpg"]})
    __properties: ClassVar[List[str]] = ["small", "large"]
