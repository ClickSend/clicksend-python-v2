...
class CalculateEmailCampaignPriceData(BaseModel):
    """
    CalculateEmailCampaignPriceData
    """ # noqa: E501
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total count of the email campaigns.", json_schema_extra={"examples": [1]})
    total_price: Optional[StrictStr] = Field(default=None, description="The total price of the email campaigns.", json_schema_extra={"examples": ["0.0066"]})
    queued_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The count of the queued email campaigns.", json_schema_extra={"examples": [2]})
    data: Optional[CalculateEmailCampaignPriceDataData] = None
    currency: Optional[Currency] = Field(default=None, alias="_currency")
    __properties: ClassVar[List[str]] = ["total_count", "total_price", "queued_count", "data", "_currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CalculateEmailCampaignPriceDataData.from_dict(obj["data"]) if obj.get("data") is not None else None,
