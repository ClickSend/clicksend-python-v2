...
class DetectAddressData(BaseModel):
    """
    DetectAddressData
    """ # noqa: E501
    address_name: Optional[StrictStr] = Field(default=None, description="The recipient's name.", json_schema_extra={"examples": ["John Doe"]})
    address_line_1: Optional[StrictStr] = Field(default=None, description="The first line of the recipient's address.", json_schema_extra={"examples": ["123 Main Street"]})
    address_line_2: Optional[StrictStr] = Field(default=None, description="The second line of the recipient's address (optional).", json_schema_extra={"examples": [""]})
    address_city: Optional[StrictStr] = Field(default=None, description="The city of the recipient's address.", json_schema_extra={"examples": ["Perth"]})
    address_state: Optional[StrictStr] = Field(default=None, description="The state or region of the recipient's address.", json_schema_extra={"examples": ["WA"]})
    address_postal_code: Optional[StrictStr] = Field(default=None, description="The postal code or ZIP code of the recipient's address.", json_schema_extra={"examples": ["6000"]})
    address_country: Optional[StrictStr] = Field(default=None, description="The country of the recipient's address.", json_schema_extra={"examples": ["AU"]})
    __properties: ClassVar[List[str]] = ["address_name", "address_line_1", "address_line_2", "address_city", "address_state", "address_postal_code", "address_country"]
