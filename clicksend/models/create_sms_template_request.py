...
class CreateSmsTemplateRequest(BaseModel):
    ...
    """ # noqa: E501
    template_name: Optional[StrictStr] = Field(default=None, description="The name of the template.", json_schema_extra={"examples": ["Template 501916"]})
    body: Optional[StrictStr] = Field(default=None, description="body String The main content of your template.")
    __properties: ClassVar[List[str]] = ["template_name", "body"]
