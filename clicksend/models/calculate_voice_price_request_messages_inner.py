...
class CalculateVoicePriceRequestMessagesInner(BaseModel):
    """
    ...
    asdasd: Optional[StrictStr] = None
    machine_detection: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["source", "from", "body", "to", "voice", "lang", "schedule", "custom_string", "asdasd", "machine_detection"]
