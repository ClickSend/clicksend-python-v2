...
class ViewASpecificSmsTemplateData(BaseModel):
    """
    The parameters related to the template.
    """ # noqa: E501
    template_id: Optional[StrictInt] = Field(default=None, description="The generated ID of the template.", json_schema_extra={"examples": [1]})
    template_name: Optional[StrictStr] = Field(default=None, description="The main content of the template.", json_schema_extra={"examples": ["Template 501916"]})
    body: Optional[StrictStr] = Field(default=None, description="The name of the template.", json_schema_extra={"examples": ["This is a test template.\r\nnew line 漢字 here."]})
    __properties: ClassVar[List[str]] = ["template_id", "template_name", "body"]
