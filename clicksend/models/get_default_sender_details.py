...
class GetDefaultSenderDetails(BaseModel):
    """
    ...
    response_msg: StrictStr = Field(description="Message providing additional information.", json_schema_extra={"examples": ["Operation completed successfully"]})
    data: DefaultSender
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DefaultSender.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
