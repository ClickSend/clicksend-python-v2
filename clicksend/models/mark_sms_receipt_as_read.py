...
class MarkSmsReceiptAsRead(BaseModel):
    """
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Receipts have been marked as read."]})
    data: Optional[Dict[str, Any]] = Field(default=None, description="The parameters related to the SMS receipt.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong/>.</p> </div>")
