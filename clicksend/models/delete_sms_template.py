...
class DeleteSmsTemplate(BaseModel):
    """
    DeleteSmsTemplate
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="A message describing the outcome of the operation.", json_schema_extra={"examples": ["Your template has been deleted."]})
    data: Optional[List[StrictStr]] = Field(default=None, description="The parameters related to the SMS template.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong>.</p> </div>")
