...
class CreateReturnAddressRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address_name", "address_line_1", "address_line_2", "address_city", "address_postal_code", "address_country"]
