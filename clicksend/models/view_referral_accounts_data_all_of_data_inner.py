...
class ViewReferralAccountsDataAllOfDataInner(BaseModel):
    """
    ViewReferralAccountsDataAllOfDataInner
    """ # noqa: E501
    referral_rule_id: Optional[StrictInt] = Field(default=None, description="The ID of the Referral Account.")
    refered_user_id: Optional[StrictInt] = Field(default=None, description="The ID of the Referral Account.")
    date_referred: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the Referral Account.", json_schema_extra={"examples": [1438260940]})
    percentage_referral: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The Percentage of the Referral.", json_schema_extra={"examples": [5]})
    __properties: ClassVar[List[str]] = ["referral_rule_id", "refered_user_id", "date_referred", "percentage_referral"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "referral_rule_id": obj.get("referral_rule_id"),
            "refered_user_id": obj.get("refered_user_id"),
            "date_referred": obj.get("date_referred"),
            "percentage_referral": obj.get("percentage_referral")
        })
        return _obj
