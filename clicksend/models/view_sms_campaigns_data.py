...
class ViewSmsCampaignsData(BaseModel):
    """
    ...
    data: Optional[List[SmsCampaign]] = Field(default=None, description="The parameters related to the SMS campaign.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "data": [SmsCampaign.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
