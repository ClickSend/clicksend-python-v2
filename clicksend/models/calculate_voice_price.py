...
class CalculateVoicePrice(BaseModel):
    """
    CalculateVoicePrice
    """ # noqa: E501
    ...
    response_msg: Optional[StrictStr] = Field(default=None, description="Here are your data.")
    data: Optional[SendVoiceMessageData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SendVoiceMessageData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
