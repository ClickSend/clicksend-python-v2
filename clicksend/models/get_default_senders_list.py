...
class GetDefaultSendersList(BaseModel):
    """
    GetDefaultSendersList
    """ # noqa: E501
    http_code: StrictInt = Field(description="HTTP status code of the response.", json_schema_extra={"examples": [200]})
    response_code: StrictStr = Field(description="Code indicating the result of the response.", json_schema_extra={"examples": ["SUCCESS"]})
    response_msg: StrictStr = Field(description="Message providing additional information.", json_schema_extra={"examples": ["Default senders retrieved successfully"]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetDefaultSendersListData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
