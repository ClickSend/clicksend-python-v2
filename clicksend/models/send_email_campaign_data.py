...
class SendEmailCampaignData(BaseModel):
    """
    SendEmailCampaignData
    """ # noqa: E501
    totlal_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total count of the email campaigns.", json_schema_extra={"examples": [1]})
    ...
    queued_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The count of the queued email campaigns.", json_schema_extra={"examples": [1]})
    data: Optional[EmailCampaign] = None
    currency: Optional[Currency] = Field(default=None, alias="_currency")
    __properties: ClassVar[List[str]] = ["totlal_count", "total_price", "queued_count", "data", "_currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totlal_count": obj.get("totlal_count"),
            "total_price": obj.get("total_price"),
            "queued_count": obj.get("queued_count"),
            "data": EmailCampaign.from_dict(obj["data"]) if obj.get("data") is not None else None,
