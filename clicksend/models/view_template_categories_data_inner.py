...
class ViewTemplateCategoriesDataInner(BaseModel):
    """
    ViewTemplateCategoriesDataInner
    """ # noqa: E501
    category_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the category.", json_schema_extra={"examples": [1]})
    category_name: Optional[StrictStr] = Field(default=None, description="The name of the category.", json_schema_extra={"examples": ["Art"]})
    __properties: ClassVar[List[str]] = ["category_id", "category_name"]
