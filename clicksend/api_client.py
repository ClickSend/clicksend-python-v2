...
from clicksend.api_response import ApiResponse, T as ApiResponseT
import clicksend.models
from clicksend import rest
from clicksend.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'ClickSend-SDK/6.0.0/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clicksend.models, klass)
