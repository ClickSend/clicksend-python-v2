...
class UploadsOtherApi:
    ...
    def upload_a_media_file(
        ...
        _param = self._upload_a_media_file_serialize(
    ...
    @validate_call
    def upload_a_media_file_with_http_info(
        self,
        content_type: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def upload_a_media_file_without_preload_content(
        self,
        content_type: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    def _upload_a_media_file_serialize(
        self,
        content_type,
        body,
        _request_auth,
