...
class ManagementOtherApi:
    ...
    def view_account_details(
        ...
        _param = self._view_account_details_serialize(
    ...
    @validate_call
    def view_account_details_with_http_info(
        self,
        content_type: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ViewAccountDetails]:
        """View Account Details
    ...
    @validate_call
    def view_account_details_without_preload_content(
        self,
        content_type: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _view_account_details_serialize(
        self,
        content_type,
        _request_auth,
        _content_type,
    ...
    def view_account_usage(
        ...
        _param = self._view_account_usage_serialize(
            year=year,
            month=month,
            content_type=content_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def view_account_usage_with_http_info(
        self,
        year: StrictStr,
        month: StrictStr,
        content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def view_account_usage_without_preload_content(
        self,
        year: StrictStr,
        month: StrictStr,
        content_type: Optional[StrictStr] = None,
    ...
    def _view_account_usage_serialize(
        self,
        year,
        month,
        content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/account/usage/{year}/{month}/subaccount',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
