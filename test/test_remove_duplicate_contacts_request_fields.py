...
class TestRemoveDuplicateContactsRequestFields(unittest.TestCase):
    """RemoveDuplicateContactsRequestFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveDuplicateContactsRequestFields:
        """Test RemoveDuplicateContactsRequestFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveDuplicateContactsRequestFields`
        """
        model = RemoveDuplicateContactsRequestFields()
        if include_optional:
            return RemoveDuplicateContactsRequestFields(
                first_name = '',
                last_name = ''
            )
        else:
    ...
    def testRemoveDuplicateContactsRequestFields(self):
        """Test RemoveDuplicateContactsRequestFields"""
