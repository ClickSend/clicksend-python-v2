...
class TestCalculateSmsPrice(unittest.TestCase):
    """CalculateSmsPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsPrice:
        """Test CalculateSmsPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsPrice`
        """
    ...
    def testCalculateSmsPrice(self):
        """Test CalculateSmsPrice"""
