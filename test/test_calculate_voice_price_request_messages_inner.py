...
class TestCalculateVoicePriceRequestMessagesInner(unittest.TestCase):
    """CalculateVoicePriceRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateVoicePriceRequestMessagesInner:
        """Test CalculateVoicePriceRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateVoicePriceRequestMessagesInner`
        """
        model = CalculateVoicePriceRequestMessagesInner()
        if include_optional:
            return CalculateVoicePriceRequestMessagesInner(
                source = '',
                var_from = '',
                body = '',
                to = '',
    ...
    def testCalculateVoicePriceRequestMessagesInner(self):
        """Test CalculateVoicePriceRequestMessagesInner"""
