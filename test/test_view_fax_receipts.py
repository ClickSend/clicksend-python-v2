...
class TestViewFaxReceipts(unittest.TestCase):
    """ViewFaxReceipts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxReceipts:
        """Test ViewFaxReceipts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxReceipts`
        """
        model = ViewFaxReceipts()
        if include_optional:
