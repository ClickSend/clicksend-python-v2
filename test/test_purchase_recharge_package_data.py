...
class TestPurchaseRechargePackageData(unittest.TestCase):
    """PurchaseRechargePackageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseRechargePackageData:
        """Test PurchaseRechargePackageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseRechargePackageData`
        """
        model = PurchaseRechargePackageData()
        if include_optional:
            return PurchaseRechargePackageData(
                user_id = 1,
                amount = 50,
                currency = 'USD',
                amount_aud = 56,
    ...
    def testPurchaseRechargePackageData(self):
        """Test PurchaseRechargePackageData"""
