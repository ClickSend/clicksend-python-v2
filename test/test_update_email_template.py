...
class TestUpdateEmailTemplate(unittest.TestCase):
    """UpdateEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEmailTemplate:
        """Test UpdateEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateEmailTemplate`
        """
        model = UpdateEmailTemplate()
        if include_optional:
            return UpdateEmailTemplate(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your email template has been updated.',
                data = clicksend.models.user_email_template.user_email_template(
                    template_id = 292, 
    ...
    def testUpdateEmailTemplate(self):
        """Test UpdateEmailTemplate"""
