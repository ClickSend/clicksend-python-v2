...
class TestSendSmsRequestMessagesInner(unittest.TestCase):
    """SendSmsRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSmsRequestMessagesInner:
        """Test SendSmsRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSmsRequestMessagesInner`
        """
        model = SendSmsRequestMessagesInner()
        if include_optional:
            return SendSmsRequestMessagesInner(
                body = '',
                to = '',
                var_from = '',
                source = 'sdk',
    ...
    def testSendSmsRequestMessagesInner(self):
        """Test SendSmsRequestMessagesInner"""
