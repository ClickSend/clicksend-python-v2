...
class TestViewRechargePackagesData(unittest.TestCase):
    """ViewRechargePackagesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewRechargePackagesData:
        """Test ViewRechargePackagesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewRechargePackagesData`
        """
        model = ViewRechargePackagesData()
        if include_optional:
            return ViewRechargePackagesData(
                packages = [
    ...
    def testViewRechargePackagesData(self):
        """Test ViewRechargePackagesData"""
