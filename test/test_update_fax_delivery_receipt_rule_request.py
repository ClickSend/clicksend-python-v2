...
class TestUpdateFaxDeliveryReceiptRuleRequest(unittest.TestCase):
    """UpdateFaxDeliveryReceiptRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFaxDeliveryReceiptRuleRequest:
        """Test UpdateFaxDeliveryReceiptRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFaxDeliveryReceiptRuleRequest`
        """
        model = UpdateFaxDeliveryReceiptRuleRequest()
        if include_optional:
            return UpdateFaxDeliveryReceiptRuleRequest(
                action_address = ''
            )
        else:
            return UpdateFaxDeliveryReceiptRuleRequest(
    ...
    def testUpdateFaxDeliveryReceiptRuleRequest(self):
        """Test UpdateFaxDeliveryReceiptRuleRequest"""
