...
class TestUpdateSmsInboundAutomationRequest(unittest.TestCase):
    """UpdateSmsInboundAutomationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSmsInboundAutomationRequest:
        """Test UpdateSmsInboundAutomationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSmsInboundAutomationRequest`
        """
        model = UpdateSmsInboundAutomationRequest()
        if include_optional:
            return UpdateSmsInboundAutomationRequest(
                dedicated_number = '',
                rule_name = '',
                message_search_type = 56,
                message_search_term = '',
                action = '',
                action_address = '',
                enabled = 56
    ...
    def testUpdateSmsInboundAutomationRequest(self):
        """Test UpdateSmsInboundAutomationRequest"""
