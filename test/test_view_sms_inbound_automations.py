...
class TestViewSmsInboundAutomations(unittest.TestCase):
    """ViewSmsInboundAutomations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsInboundAutomations:
        """Test ViewSmsInboundAutomations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsInboundAutomations`
        """
        model = ViewSmsInboundAutomations()
        if include_optional:
    ...
    def testViewSmsInboundAutomations(self):
        """Test ViewSmsInboundAutomations"""
