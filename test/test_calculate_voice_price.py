...
class TestCalculateVoicePrice(unittest.TestCase):
    """CalculateVoicePrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateVoicePrice:
        """Test CalculateVoicePrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateVoicePrice`
        """
        model = CalculateVoicePrice()
        if include_optional:
    ...
    def testCalculateVoicePrice(self):
        """Test CalculateVoicePrice"""
