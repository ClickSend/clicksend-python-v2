...
class TestCalculateEmailCampaignPriceDataData(unittest.TestCase):
    """CalculateEmailCampaignPriceDataData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailCampaignPriceDataData:
        """Test CalculateEmailCampaignPriceDataData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailCampaignPriceDataData`
        """
        model = CalculateEmailCampaignPriceDataData()
        if include_optional:
            return CalculateEmailCampaignPriceDataData(
                name = 'John Doe',
                subject = 'Lorem Ipsum',
    ...
    def testCalculateEmailCampaignPriceDataData(self):
        """Test CalculateEmailCampaignPriceDataData"""
