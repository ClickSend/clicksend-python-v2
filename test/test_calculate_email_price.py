...
class TestCalculateEmailPrice(unittest.TestCase):
    """CalculateEmailPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailPrice:
        """Test CalculateEmailPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailPrice`
        """
        model = CalculateEmailPrice()
        if include_optional:
    ...
    def testCalculateEmailPrice(self):
        """Test CalculateEmailPrice"""
