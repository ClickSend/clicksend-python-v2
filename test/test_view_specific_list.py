...
class TestViewSpecificList(unittest.TestCase):
    """ViewSpecificList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificList:
        """Test ViewSpecificList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificList`
        """
        model = ViewSpecificList()
        if include_optional:
            return ViewSpecificList(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your data.',
                data = clicksend.models.contact_list.contact_list(
                    list_id = 428, 
