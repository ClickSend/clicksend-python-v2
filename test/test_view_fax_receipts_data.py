...
class TestViewFaxReceiptsData(unittest.TestCase):
    """ViewFaxReceiptsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxReceiptsData:
        """Test ViewFaxReceiptsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxReceiptsData`
        """
        model = ViewFaxReceiptsData()
        if include_optional:
            return ViewFaxReceiptsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.fax_receipt.fax_receipt(
    ...
    def testViewFaxReceiptsData(self):
        """Test ViewFaxReceiptsData"""
