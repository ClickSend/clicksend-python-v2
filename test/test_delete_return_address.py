...
class TestDeleteReturnAddress(unittest.TestCase):
    """DeleteReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteReturnAddress:
        """Test DeleteReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteReturnAddress`
        """
        model = DeleteReturnAddress()
        if include_optional:
    ...
    def testDeleteReturnAddress(self):
        """Test DeleteReturnAddress"""
