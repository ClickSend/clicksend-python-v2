...
class TestVerifyAllowedEmailAddressRequest(unittest.TestCase):
    """VerifyAllowedEmailAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAllowedEmailAddressRequest:
        """Test VerifyAllowedEmailAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAllowedEmailAddressRequest`
        """
        model = VerifyAllowedEmailAddressRequest()
        if include_optional:
            return VerifyAllowedEmailAddressRequest(
                to = [
                    clicksend.models.send_email_request_to_inner.send_email_request_to_inner(
                        email = '', 
                        name = '', )
                    ],
    ...
    def testVerifyAllowedEmailAddressRequest(self):
        """Test VerifyAllowedEmailAddressRequest"""
