...
class TestViewTemplateCategoriesDataInner(unittest.TestCase):
    """ViewTemplateCategoriesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewTemplateCategoriesDataInner:
        """Test ViewTemplateCategoriesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewTemplateCategoriesDataInner`
        """
        model = ViewTemplateCategoriesDataInner()
        if include_optional:
            return ViewTemplateCategoriesDataInner(
                category_id = 1,
                category_name = 'Art'
            )
        else:
    ...
    def testViewTemplateCategoriesDataInner(self):
        """Test ViewTemplateCategoriesDataInner"""
