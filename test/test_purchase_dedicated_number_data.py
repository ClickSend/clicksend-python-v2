...
class TestPurchaseDedicatedNumberData(unittest.TestCase):
    """PurchaseDedicatedNumberData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseDedicatedNumberData:
        """Test PurchaseDedicatedNumberData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseDedicatedNumberData`
        """
        model = PurchaseDedicatedNumberData()
        if include_optional:
            return PurchaseDedicatedNumberData(
    ...
    def testPurchaseDedicatedNumberData(self):
        """Test PurchaseDedicatedNumberData"""
