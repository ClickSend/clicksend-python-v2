...
class TestViewAccountUsageDataEmailInner(unittest.TestCase):
    """ViewAccountUsageDataEmailInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAccountUsageDataEmailInner:
        """Test ViewAccountUsageDataEmailInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAccountUsageDataEmailInner`
        """
        model = ViewAccountUsageDataEmailInner()
        if include_optional:
    ...
    def testViewAccountUsageDataEmailInner(self):
        """Test ViewAccountUsageDataEmailInner"""
