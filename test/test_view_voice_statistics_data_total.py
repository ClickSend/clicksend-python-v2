...
class TestViewVoiceStatisticsDataTotal(unittest.TestCase):
    """ViewVoiceStatisticsDataTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceStatisticsDataTotal:
        """Test ViewVoiceStatisticsDataTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceStatisticsDataTotal`
        """
        model = ViewVoiceStatisticsDataTotal()
        if include_optional:
    ...
    def testViewVoiceStatisticsDataTotal(self):
        """Test ViewVoiceStatisticsDataTotal"""
