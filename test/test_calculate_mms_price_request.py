...
class TestCalculateMmsPriceRequest(unittest.TestCase):
    """CalculateMmsPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateMmsPriceRequest:
        """Test CalculateMmsPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateMmsPriceRequest`
        """
        model = CalculateMmsPriceRequest()
        if include_optional:
            return CalculateMmsPriceRequest(
                media_file = '',
                messages = [
                    clicksend.models.calculate_mms_price_request_messages_inner.calculate_mms_price_request_messages_inner(
                        source = '', 
                        subject = '', 
                        from = '', 
                        body = '', 
    ...
    def testCalculateMmsPriceRequest(self):
        """Test CalculateMmsPriceRequest"""
