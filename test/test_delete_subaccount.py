...
class TestDeleteSubaccount(unittest.TestCase):
    """DeleteSubaccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteSubaccount:
        """Test DeleteSubaccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteSubaccount`
        """
        model = DeleteSubaccount()
        if include_optional:
