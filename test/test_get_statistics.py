...
class TestGetStatistics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetStatistics:
        """Test GetStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatistics`
        """
        model = GetStatistics()
        if include_optional:
            return GetStatistics(
                data = [
                    clicksend.models.get_statistics_data_inner.get_statistics_data_inner(
