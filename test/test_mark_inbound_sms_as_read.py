...
class TestMarkInboundSmsAsRead(unittest.TestCase):
    """MarkInboundSmsAsRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkInboundSmsAsRead:
        """Test MarkInboundSmsAsRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkInboundSmsAsRead`
        """
        model = MarkInboundSmsAsRead()
        if include_optional:
    ...
    def testMarkInboundSmsAsRead(self):
        """Test MarkInboundSmsAsRead"""
