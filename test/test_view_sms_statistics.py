...
class TestViewSmsStatistics(unittest.TestCase):
    """ViewSmsStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsStatistics:
        """Test ViewSmsStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsStatistics`
        """
        model = ViewSmsStatistics()
        if include_optional:
    ...
    def testViewSmsStatistics(self):
        """Test ViewSmsStatistics"""
