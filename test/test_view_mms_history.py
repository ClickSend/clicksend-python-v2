...
class TestViewMmsHistory(unittest.TestCase):
    """ViewMmsHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewMmsHistory:
        """Test ViewMmsHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewMmsHistory`
        """
        model = ViewMmsHistory()
        if include_optional:
