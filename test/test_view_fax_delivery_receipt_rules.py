...
class TestViewFaxDeliveryReceiptRules(unittest.TestCase):
    """ViewFaxDeliveryReceiptRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxDeliveryReceiptRules:
        """Test ViewFaxDeliveryReceiptRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxDeliveryReceiptRules`
        """
        model = ViewFaxDeliveryReceiptRules()
        if include_optional:
    ...
    def testViewFaxDeliveryReceiptRules(self):
        """Test ViewFaxDeliveryReceiptRules"""
