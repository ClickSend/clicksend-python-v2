...
class TestViewSmsStatisticsData(unittest.TestCase):
    """ViewSmsStatisticsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsStatisticsData:
        """Test ViewSmsStatisticsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsStatisticsData`
        """
        model = ViewSmsStatisticsData()
        if include_optional:
    ...
    def testViewSmsStatisticsData(self):
        """Test ViewSmsStatisticsData"""
