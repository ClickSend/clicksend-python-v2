...
class TestDeleteSmsInboundAutomation(unittest.TestCase):
    """DeleteSmsInboundAutomation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteSmsInboundAutomation:
        """Test DeleteSmsInboundAutomation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteSmsInboundAutomation`
        """
        model = DeleteSmsInboundAutomation()
        if include_optional:
    ...
    def testDeleteSmsInboundAutomation(self):
        """Test DeleteSmsInboundAutomation"""
