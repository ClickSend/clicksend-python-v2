...
class TestViewVoiceLanguagesDataInner(unittest.TestCase):
    """ViewVoiceLanguagesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceLanguagesDataInner:
        """Test ViewVoiceLanguagesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceLanguagesDataInner`
        """
        model = ViewVoiceLanguagesDataInner()
        if include_optional:
    ...
    def testViewVoiceLanguagesDataInner(self):
        """Test ViewVoiceLanguagesDataInner"""
