...
class TestSendEmailRequestFrom(unittest.TestCase):
    """SendEmailRequestFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailRequestFrom:
        """Test SendEmailRequestFrom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailRequestFrom`
        """
        model = SendEmailRequestFrom()
        if include_optional:
            return SendEmailRequestFrom(
                email_address_id = '',
                name = ''
            )
        else:
    ...
    def testSendEmailRequestFrom(self):
        """Test SendEmailRequestFrom"""
