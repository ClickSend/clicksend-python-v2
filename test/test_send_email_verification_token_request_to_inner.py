...
class TestSendEmailVerificationTokenRequestToInner(unittest.TestCase):
    """SendEmailVerificationTokenRequestToInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailVerificationTokenRequestToInner:
        """Test SendEmailVerificationTokenRequestToInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailVerificationTokenRequestToInner`
        """
        model = SendEmailVerificationTokenRequestToInner()
        if include_optional:
            return SendEmailVerificationTokenRequestToInner(
                email = '',
                name = ''
            )
        else:
    ...
    def testSendEmailVerificationTokenRequestToInner(self):
        """Test SendEmailVerificationTokenRequestToInner"""
