...
class TestCalculateLetterPrice(unittest.TestCase):
    """CalculateLetterPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateLetterPrice:
        """Test CalculateLetterPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateLetterPrice`
        """
        model = CalculateLetterPrice()
        if include_optional:
            return CalculateLetterPrice(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are some results.',
                data = clicksend.models.calculate_letter_price_data.calculate_letter_price_data(
                    total_price = 1.87, 
                    total_cost = 1, 
    ...
    def testCalculateLetterPrice(self):
        """Test CalculateLetterPrice"""
