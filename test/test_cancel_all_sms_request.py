...
class TestCancelAllSmsRequest(unittest.TestCase):
    """CancelAllSmsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelAllSmsRequest:
        """Test CancelAllSmsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelAllSmsRequest`
        """
        model = CancelAllSmsRequest()
        if include_optional:
            return CancelAllSmsRequest(
                custom_string = ''
            )
        else:
            return CancelAllSmsRequest(
    ...
    def testCancelAllSmsRequest(self):
        """Test CancelAllSmsRequest"""
