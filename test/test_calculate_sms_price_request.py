...
class TestCalculateSmsPriceRequest(unittest.TestCase):
    """CalculateSmsPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsPriceRequest:
        """Test CalculateSmsPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsPriceRequest`
        """
        model = CalculateSmsPriceRequest()
        if include_optional:
            return CalculateSmsPriceRequest(
                senders = [
                ...
                shorten_urls = True,
                messages = [
                    clicksend.models.calculate_sms_price_request_messages_inner.calculate_sms_price_request_messages_inner(
                        body = '', 
                        to = '', 
                        from = '', 
                        source = '', 
    ...
    def testCalculateSmsPriceRequest(self):
        """Test CalculateSmsPriceRequest"""
