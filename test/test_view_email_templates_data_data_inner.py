...
class TestViewEmailTemplatesDataDataInner(unittest.TestCase):
    """ViewEmailTemplatesDataDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailTemplatesDataDataInner:
        """Test ViewEmailTemplatesDataDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailTemplatesDataDataInner`
        """
        model = ViewEmailTemplatesDataDataInner()
        if include_optional:
            return ViewEmailTemplatesDataDataInner(
                template_id = 56,
                template_name = ''
            )
        else:
    ...
    def testViewEmailTemplatesDataDataInner(self):
        """Test ViewEmailTemplatesDataDataInner"""
