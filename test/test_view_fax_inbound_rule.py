...
class TestViewFaxInboundRule(unittest.TestCase):
    """ViewFaxInboundRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxInboundRule:
        """Test ViewFaxInboundRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxInboundRule`
        """
        model = ViewFaxInboundRule()
        if include_optional:
    ...
    def testViewFaxInboundRule(self):
        """Test ViewFaxInboundRule"""
