...
class TestRequestAlphaTagRequestBusinessesInnerBusinessAddress(unittest.TestCase):
    """RequestAlphaTagRequestBusinessesInnerBusinessAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAlphaTagRequestBusinessesInnerBusinessAddress:
        """Test RequestAlphaTagRequestBusinessesInnerBusinessAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAlphaTagRequestBusinessesInnerBusinessAddress`
        """
        model = RequestAlphaTagRequestBusinessesInnerBusinessAddress()
        if include_optional:
            return RequestAlphaTagRequestBusinessesInnerBusinessAddress(
                addr_line1 = '',
                addr_line2 = '',
                city = '',
                state = '',
    ...
    def testRequestAlphaTagRequestBusinessesInnerBusinessAddress(self):
        """Test RequestAlphaTagRequestBusinessesInnerBusinessAddress"""
