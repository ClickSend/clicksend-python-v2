...
class TestVerifyOwnNumberOtp(unittest.TestCase):
    """VerifyOwnNumberOtp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyOwnNumberOtp:
        """Test VerifyOwnNumberOtp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyOwnNumberOtp`
        """
        model = VerifyOwnNumberOtp()
        if include_optional:
    ...
    def testVerifyOwnNumberOtp(self):
        """Test VerifyOwnNumberOtp"""
