...
class TestVoiceReceipt(unittest.TestCase):
    """VoiceReceipt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoiceReceipt:
        """Test VoiceReceipt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoiceReceipt`
        """
        model = VoiceReceipt()
        if include_optional:
            return VoiceReceipt(
