...
class TestSendEmailCampaignRequest(unittest.TestCase):
    """SendEmailCampaignRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailCampaignRequest:
        """Test SendEmailCampaignRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailCampaignRequest`
        """
        model = SendEmailCampaignRequest()
        if include_optional:
            return SendEmailCampaignRequest(
                name = '',
                subject = '',
    ...
    def testSendEmailCampaignRequest(self):
        """Test SendEmailCampaignRequest"""
