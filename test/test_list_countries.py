...
class TestListCountries(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListCountries:
        """Test ListCountries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCountries`
        """
        model = ListCountries()
        if include_optional:
            return ListCountries(
                ...
                data = [
                    clicksend.models.list_countries_data_inner.list_countries_data_inner(
                        id = 1, 
                        name = 'Australia', 
                        code = 'AU', 
                        region = 'Oceania', )
