...
class TestExportSmsHistory(unittest.TestCase):
    """ExportSmsHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportSmsHistory:
        """Test ExportSmsHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportSmsHistory`
        """
        model = ExportSmsHistory()
        if include_optional:
