...
class TestViewAllEmailCampaignsData(unittest.TestCase):
    """ViewAllEmailCampaignsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllEmailCampaignsData:
        """Test ViewAllEmailCampaignsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllEmailCampaignsData`
        """
        model = ViewAllEmailCampaignsData()
        if include_optional:
            return ViewAllEmailCampaignsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewAllEmailCampaignsData(self):
        """Test ViewAllEmailCampaignsData"""
