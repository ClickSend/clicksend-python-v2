...
class TestSmsSendSms(unittest.TestCase):
    """SmsSendSms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmsSendSms:
        """Test SmsSendSms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmsSendSms`
        """
        model = SmsSendSms()
        if include_optional:
            return SmsSendSms(
