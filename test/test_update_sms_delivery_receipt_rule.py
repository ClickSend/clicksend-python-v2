...
class TestUpdateSmsDeliveryReceiptRule(unittest.TestCase):
    """UpdateSmsDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSmsDeliveryReceiptRule:
        """Test UpdateSmsDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSmsDeliveryReceiptRule`
        """
        model = UpdateSmsDeliveryReceiptRule()
        if include_optional:
            return UpdateSmsDeliveryReceiptRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your rule incoming sms receipt has been updated.',
                data = clicksend.models.sms_delivery_receipt_rule.sms_delivery_receipt_rule(
                    receipt_rule_id = 5, 
                    rule_name = 'My Rule', 
                    match_type = 0, 
                    action = 'EMAIL_FIXED', 
    ...
    def testUpdateSmsDeliveryReceiptRule(self):
        """Test UpdateSmsDeliveryReceiptRule"""
