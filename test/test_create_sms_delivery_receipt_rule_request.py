...
class TestCreateSmsDeliveryReceiptRuleRequest(unittest.TestCase):
    """CreateSmsDeliveryReceiptRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmsDeliveryReceiptRuleRequest:
        """Test CreateSmsDeliveryReceiptRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmsDeliveryReceiptRuleRequest`
        """
        model = CreateSmsDeliveryReceiptRuleRequest()
        if include_optional:
            return CreateSmsDeliveryReceiptRuleRequest(
                rule_name = '',
                match_type = 56,
                action = '',
                action_address = '',
    ...
    def testCreateSmsDeliveryReceiptRuleRequest(self):
        """Test CreateSmsDeliveryReceiptRuleRequest"""
