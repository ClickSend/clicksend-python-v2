...
class TestCreateDeliveryIssueData(unittest.TestCase):
    """CreateDeliveryIssueData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDeliveryIssueData:
        """Test CreateDeliveryIssueData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDeliveryIssueData`
        """
        model = CreateDeliveryIssueData()
        if include_optional:
            return CreateDeliveryIssueData(
                issue_id = 1,
                user_id = 3820,
    ...
    def testCreateDeliveryIssueData(self):
        """Test CreateDeliveryIssueData"""
