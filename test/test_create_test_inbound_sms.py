...
class TestCreateTestInboundSms(unittest.TestCase):
    """CreateTestInboundSms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTestInboundSms:
        """Test CreateTestInboundSms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestInboundSms`
        """
        model = CreateTestInboundSms()
        if include_optional:
            return CreateTestInboundSms(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your incoming messages.',
                data = clicksend.models.inbound_sms_test.inbound_sms_test(
    ...
    def testCreateTestInboundSms(self):
        """Test CreateTestInboundSms"""
