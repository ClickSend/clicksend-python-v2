...
class TestViewInboundSms(unittest.TestCase):
    """ViewInboundSms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewInboundSms:
        """Test ViewInboundSms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewInboundSms`
        """
        model = ViewInboundSms()
        if include_optional:
