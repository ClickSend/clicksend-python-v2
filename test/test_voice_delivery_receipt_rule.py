...
class TestVoiceDeliveryReceiptRule(unittest.TestCase):
    """VoiceDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoiceDeliveryReceiptRule:
        """Test VoiceDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoiceDeliveryReceiptRule`
        """
        model = VoiceDeliveryReceiptRule()
        if include_optional:
            return VoiceDeliveryReceiptRule(
                receipt_rule_id = 2,
                rule_name = 'My Rule 2',
                match_type = 3,
                action = 'URL',
    ...
    def testVoiceDeliveryReceiptRule(self):
        """Test VoiceDeliveryReceiptRule"""
