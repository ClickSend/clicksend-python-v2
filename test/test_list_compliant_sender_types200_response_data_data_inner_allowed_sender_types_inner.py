...
class TestListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner(unittest.TestCase):
    """ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner:
        """Test ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner`
        """
        model = ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner()
        if include_optional:
            return ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner(
    ...
    def testListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner(self):
        """Test ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner"""
