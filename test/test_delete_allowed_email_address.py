...
class TestDeleteAllowedEmailAddress(unittest.TestCase):
    """DeleteAllowedEmailAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteAllowedEmailAddress:
        """Test DeleteAllowedEmailAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteAllowedEmailAddress`
        """
        model = DeleteAllowedEmailAddress()
        if include_optional:
    ...
    def testDeleteAllowedEmailAddress(self):
        """Test DeleteAllowedEmailAddress"""
