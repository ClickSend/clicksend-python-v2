...
class TestViewStrippedStringRuleData(unittest.TestCase):
    """ViewStrippedStringRuleData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewStrippedStringRuleData:
        """Test ViewStrippedStringRuleData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewStrippedStringRuleData`
        """
        model = ViewStrippedStringRuleData()
        if include_optional:
            return ViewStrippedStringRuleData(
                rule_id = 18,
    ...
    def testViewStrippedStringRuleData(self):
        """Test ViewStrippedStringRuleData"""
