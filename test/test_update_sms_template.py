...
class TestUpdateSmsTemplate(unittest.TestCase):
    """UpdateSmsTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSmsTemplate:
        """Test UpdateSmsTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSmsTemplate`
        """
    ...
    def testUpdateSmsTemplate(self):
        """Test UpdateSmsTemplate"""
