...
class TestExportEmailHistory(unittest.TestCase):
    """ExportEmailHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportEmailHistory:
        """Test ExportEmailHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportEmailHistory`
        """
        model = ExportEmailHistory()
        if include_optional:
    ...
    def testExportEmailHistory(self):
        """Test ExportEmailHistory"""
