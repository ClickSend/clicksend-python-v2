...
class TestPostReturnAddress(unittest.TestCase):
    """PostReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostReturnAddress:
        """Test PostReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostReturnAddress`
        """
        model = PostReturnAddress()
        if include_optional:
    ...
    def testPostReturnAddress(self):
        """Test PostReturnAddress"""
