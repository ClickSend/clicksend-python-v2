...
class TestUpdatePaymentInfoRequest(unittest.TestCase):
    """UpdatePaymentInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePaymentInfoRequest:
        """Test UpdatePaymentInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePaymentInfoRequest`
        """
        model = UpdatePaymentInfoRequest()
        if include_optional:
    ...
    def testUpdatePaymentInfoRequest(self):
        """Test UpdatePaymentInfoRequest"""
