...
class TestListOwnNumbersMetadataPagination(unittest.TestCase):
    """ListOwnNumbersMetadataPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOwnNumbersMetadataPagination:
        """Test ListOwnNumbersMetadataPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOwnNumbersMetadataPagination`
        """
        model = ListOwnNumbersMetadataPagination()
        if include_optional:
            return ListOwnNumbersMetadataPagination(
                var_self = 'https://rest.clicksend.com/v3/own-numbers?offset=f99872cc-11a6-48ba-a9f2-bcfb6dd1e3d4#8fa5ebc2-777b-45db-a448-ec76a40d4384&page_size=10',
    ...
    def testListOwnNumbersMetadataPagination(self):
        """Test ListOwnNumbersMetadataPagination"""
