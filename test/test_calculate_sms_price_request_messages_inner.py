...
class TestCalculateSmsPriceRequestMessagesInner(unittest.TestCase):
    """CalculateSmsPriceRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsPriceRequestMessagesInner:
        """Test CalculateSmsPriceRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsPriceRequestMessagesInner`
        """
        model = CalculateSmsPriceRequestMessagesInner()
        if include_optional:
            return CalculateSmsPriceRequestMessagesInner(
                body = '',
                to = '',
                var_from = '',
                source = '',
    ...
    def testCalculateSmsPriceRequestMessagesInner(self):
        """Test CalculateSmsPriceRequestMessagesInner"""
