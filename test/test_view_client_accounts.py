...
class TestViewClientAccounts(unittest.TestCase):
    """ViewClientAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewClientAccounts:
        """Test ViewClientAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewClientAccounts`
        """
        model = ViewClientAccounts()
        if include_optional:
    ...
    def testViewClientAccounts(self):
        """Test ViewClientAccounts"""
