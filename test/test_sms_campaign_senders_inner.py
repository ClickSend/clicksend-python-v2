...
class TestSmsCampaignSendersInner(unittest.TestCase):
    """SmsCampaignSendersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmsCampaignSendersInner:
        """Test SmsCampaignSendersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmsCampaignSendersInner`
        """
        model = SmsCampaignSendersInner()
        if include_optional:
            return SmsCampaignSendersInner(
    ...
    def testSmsCampaignSendersInner(self):
        """Test SmsCampaignSendersInner"""
