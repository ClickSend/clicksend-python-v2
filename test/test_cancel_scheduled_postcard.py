...
class TestCancelScheduledPostcard(unittest.TestCase):
    """CancelScheduledPostcard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelScheduledPostcard:
        """Test CancelScheduledPostcard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelScheduledPostcard`
        """
        model = CancelScheduledPostcard()
        if include_optional:
    ...
    def testCancelScheduledPostcard(self):
        """Test CancelScheduledPostcard"""
