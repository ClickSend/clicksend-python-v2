...
class TestViewVoiceDeliveryReceiptRules(unittest.TestCase):
    """ViewVoiceDeliveryReceiptRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceDeliveryReceiptRules:
        """Test ViewVoiceDeliveryReceiptRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceDeliveryReceiptRules`
        """
        model = ViewVoiceDeliveryReceiptRules()
        if include_optional:
    ...
    def testViewVoiceDeliveryReceiptRules(self):
        """Test ViewVoiceDeliveryReceiptRules"""
