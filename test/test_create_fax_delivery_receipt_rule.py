...
class TestCreateFaxDeliveryReceiptRule(unittest.TestCase):
    """CreateFaxDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFaxDeliveryReceiptRule:
        """Test CreateFaxDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFaxDeliveryReceiptRule`
        """
        model = CreateFaxDeliveryReceiptRule()
        if include_optional:
    ...
    def testCreateFaxDeliveryReceiptRule(self):
        """Test CreateFaxDeliveryReceiptRule"""
