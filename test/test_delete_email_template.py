...
class TestDeleteEmailTemplate(unittest.TestCase):
    """DeleteEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteEmailTemplate:
        """Test DeleteEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteEmailTemplate`
        """
        model = DeleteEmailTemplate()
        if include_optional:
    ...
    def testDeleteEmailTemplate(self):
        """Test DeleteEmailTemplate"""
