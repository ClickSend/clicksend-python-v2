...
class TestDeleteSmsDeliveryReceiptRule(unittest.TestCase):
    """DeleteSmsDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteSmsDeliveryReceiptRule:
        """Test DeleteSmsDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteSmsDeliveryReceiptRule`
        """
        model = DeleteSmsDeliveryReceiptRule()
        if include_optional:
    ...
    def testDeleteSmsDeliveryReceiptRule(self):
        """Test DeleteSmsDeliveryReceiptRule"""
