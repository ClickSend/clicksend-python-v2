...
class TestUpdateSmsInboundAutomation(unittest.TestCase):
    """UpdateSmsInboundAutomation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSmsInboundAutomation:
        """Test UpdateSmsInboundAutomation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSmsInboundAutomation`
        """
        model = UpdateSmsInboundAutomation()
        if include_optional:
    ...
    def testUpdateSmsInboundAutomation(self):
        """Test UpdateSmsInboundAutomation"""
