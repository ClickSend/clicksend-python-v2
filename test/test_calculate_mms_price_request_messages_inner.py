...
class TestCalculateMmsPriceRequestMessagesInner(unittest.TestCase):
    """CalculateMmsPriceRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateMmsPriceRequestMessagesInner:
        """Test CalculateMmsPriceRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateMmsPriceRequestMessagesInner`
        """
        model = CalculateMmsPriceRequestMessagesInner()
        if include_optional:
            return CalculateMmsPriceRequestMessagesInner(
                source = '',
                subject = '',
                var_from = '',
                body = '',
    ...
    def testCalculateMmsPriceRequestMessagesInner(self):
        """Test CalculateMmsPriceRequestMessagesInner"""
