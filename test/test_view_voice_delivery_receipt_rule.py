...
class TestViewVoiceDeliveryReceiptRule(unittest.TestCase):
    """ViewVoiceDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceDeliveryReceiptRule:
        """Test ViewVoiceDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceDeliveryReceiptRule`
        """
        model = ViewVoiceDeliveryReceiptRule()
        if include_optional:
    ...
    def testViewVoiceDeliveryReceiptRule(self):
        """Test ViewVoiceDeliveryReceiptRule"""
