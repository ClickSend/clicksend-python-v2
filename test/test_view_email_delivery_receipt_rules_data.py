...
class TestViewEmailDeliveryReceiptRulesData(unittest.TestCase):
    """ViewEmailDeliveryReceiptRulesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailDeliveryReceiptRulesData:
        """Test ViewEmailDeliveryReceiptRulesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailDeliveryReceiptRulesData`
        """
        model = ViewEmailDeliveryReceiptRulesData()
        if include_optional:
            return ViewEmailDeliveryReceiptRulesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewEmailDeliveryReceiptRulesData(self):
        """Test ViewEmailDeliveryReceiptRulesData"""
