...
class TestViewAccountUsage(unittest.TestCase):
    """ViewAccountUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAccountUsage:
        """Test ViewAccountUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAccountUsage`
        """
        model = ViewAccountUsage()
        if include_optional:
            return ViewAccountUsage(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here is your usage for this month.',
                data = clicksend.models.view_account_usage_data.view_account_usage_data(
