...
class TestPurchaseDedicatedNumber(unittest.TestCase):
    """PurchaseDedicatedNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseDedicatedNumber:
        """Test PurchaseDedicatedNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseDedicatedNumber`
        """
        model = PurchaseDedicatedNumber()
        if include_optional:
            return PurchaseDedicatedNumber(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here is your new number.',
                data = {"dedicated_number":"+12282060576","country":"US","price_total":"8.98","_price_setup":"22.22","_price_monthly":"11.11","_currency":{"currency_name_short":"USD","currency_prefix_d":"$","currency_prefix_c":"¢","currency_name_long":"US Dollar"}}
            )
        else:
            return PurchaseDedicatedNumber(
        )
    ...
    def testPurchaseDedicatedNumber(self):
        """Test PurchaseDedicatedNumber"""
