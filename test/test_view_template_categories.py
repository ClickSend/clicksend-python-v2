...
class TestViewTemplateCategories(unittest.TestCase):
    """ViewTemplateCategories unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewTemplateCategories:
        """Test ViewTemplateCategories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewTemplateCategories`
        """
        model = ViewTemplateCategories()
        if include_optional:
    ...
    def testViewTemplateCategories(self):
        """Test ViewTemplateCategories"""
