...
class TestSendVoiceMessageData(unittest.TestCase):
    """SendVoiceMessageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVoiceMessageData:
        """Test SendVoiceMessageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVoiceMessageData`
        """
        model = SendVoiceMessageData()
        if include_optional:
    ...
    def testSendVoiceMessageData(self):
        """Test SendVoiceMessageData"""
