...
class TestSendEmailRequestToInner(unittest.TestCase):
    """SendEmailRequestToInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailRequestToInner:
        """Test SendEmailRequestToInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailRequestToInner`
        """
        model = SendEmailRequestToInner()
        if include_optional:
            return SendEmailRequestToInner(
                email = '',
                name = ''
            )
        else:
    ...
    def testSendEmailRequestToInner(self):
        """Test SendEmailRequestToInner"""
