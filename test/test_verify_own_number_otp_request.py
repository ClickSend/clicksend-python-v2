...
class TestVerifyOwnNumberOtpRequest(unittest.TestCase):
    """VerifyOwnNumberOtpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyOwnNumberOtpRequest:
        """Test VerifyOwnNumberOtpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyOwnNumberOtpRequest`
        """
        model = VerifyOwnNumberOtpRequest()
        if include_optional:
            return VerifyOwnNumberOtpRequest(
                country = '',
                phone_number = '',
                code = ''
            )
    ...
    def testVerifyOwnNumberOtpRequest(self):
        """Test VerifyOwnNumberOtpRequest"""
