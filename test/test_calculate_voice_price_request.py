...
class TestCalculateVoicePriceRequest(unittest.TestCase):
    """CalculateVoicePriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateVoicePriceRequest:
        """Test CalculateVoicePriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateVoicePriceRequest`
        """
        model = CalculateVoicePriceRequest()
        if include_optional:
            return CalculateVoicePriceRequest(
                messages = [
                    clicksend.models.calculate_voice_price_request_messages_inner.calculate_voice_price_request_messages_inner(
                        source = '', 
                        from = '', 
                        body = '', 
                        to = '', 
    ...
    def testCalculateVoicePriceRequest(self):
        """Test CalculateVoicePriceRequest"""
