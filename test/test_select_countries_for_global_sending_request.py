...
class TestSelectCountriesForGlobalSendingRequest(unittest.TestCase):
    """SelectCountriesForGlobalSendingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelectCountriesForGlobalSendingRequest:
        """Test SelectCountriesForGlobalSendingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelectCountriesForGlobalSendingRequest`
        """
        model = SelectCountriesForGlobalSendingRequest()
        if include_optional:
            return SelectCountriesForGlobalSendingRequest(
                country_list_ids = [
                    56
                    ]
            )
    ...
    def testSelectCountriesForGlobalSendingRequest(self):
        """Test SelectCountriesForGlobalSendingRequest"""
