...
class TestCancelSmsCampaign(unittest.TestCase):
    """CancelSmsCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelSmsCampaign:
        """Test CancelSmsCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelSmsCampaign`
        """
        model = CancelSmsCampaign()
        if include_optional:
    ...
    def testCancelSmsCampaign(self):
        """Test CancelSmsCampaign"""
