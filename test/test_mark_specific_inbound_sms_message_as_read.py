...
class TestMarkSpecificInboundSmsMessageAsRead(unittest.TestCase):
    """MarkSpecificInboundSmsMessageAsRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkSpecificInboundSmsMessageAsRead:
        """Test MarkSpecificInboundSmsMessageAsRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkSpecificInboundSmsMessageAsRead`
        """
        model = MarkSpecificInboundSmsMessageAsRead()
        if include_optional:
    ...
    def testMarkSpecificInboundSmsMessageAsRead(self):
        """Test MarkSpecificInboundSmsMessageAsRead"""
