...
class TestForgotUsernameRequest(unittest.TestCase):
    """ForgotUsernameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForgotUsernameRequest:
        """Test ForgotUsernameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForgotUsernameRequest`
        """
        model = ForgotUsernameRequest()
        if include_optional:
    ...
    def testForgotUsernameRequest(self):
        """Test ForgotUsernameRequest"""
