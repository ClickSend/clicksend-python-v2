...
class TestUpdateVoiceDeliveryReceiptRule(unittest.TestCase):
    """UpdateVoiceDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVoiceDeliveryReceiptRule:
        """Test UpdateVoiceDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVoiceDeliveryReceiptRule`
        """
        model = UpdateVoiceDeliveryReceiptRule()
        if include_optional:
    ...
    def testUpdateVoiceDeliveryReceiptRule(self):
        """Test UpdateVoiceDeliveryReceiptRule"""
