...
class TestViewAllowedEmailAddress(unittest.TestCase):
    """ViewAllowedEmailAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllowedEmailAddress:
        """Test ViewAllowedEmailAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllowedEmailAddress`
        """
        model = ViewAllowedEmailAddress()
        if include_optional:
    ...
    def testViewAllowedEmailAddress(self):
        """Test ViewAllowedEmailAddress"""
