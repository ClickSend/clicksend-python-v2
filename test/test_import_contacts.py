...
class TestImportContacts(unittest.TestCase):
    """ImportContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportContacts:
        """Test ImportContacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportContacts`
        """
        ...
        if include_optional:
            return ImportContacts(
                ...
                data = clicksend.models.import_contacts_data.import_contacts_data(
