...
class TestViewEmailCampaignHistory(unittest.TestCase):
    """ViewEmailCampaignHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailCampaignHistory:
        """Test ViewEmailCampaignHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailCampaignHistory`
        """
        model = ViewEmailCampaignHistory()
        if include_optional:
    ...
    def testViewEmailCampaignHistory(self):
        """Test ViewEmailCampaignHistory"""
