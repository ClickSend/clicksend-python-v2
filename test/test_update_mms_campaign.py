...
class TestUpdateMmsCampaign(unittest.TestCase):
    """UpdateMmsCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMmsCampaign:
        """Test UpdateMmsCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMmsCampaign`
        """
        model = UpdateMmsCampaign()
        if include_optional:
    ...
    def testUpdateMmsCampaign(self):
        """Test UpdateMmsCampaign"""
