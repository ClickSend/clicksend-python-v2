...
class TestDeleteStrippedStringRule(unittest.TestCase):
    """DeleteStrippedStringRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteStrippedStringRule:
        """Test DeleteStrippedStringRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteStrippedStringRule`
        """
        model = DeleteStrippedStringRule()
        if include_optional:
    ...
    def testDeleteStrippedStringRule(self):
        """Test DeleteStrippedStringRule"""
