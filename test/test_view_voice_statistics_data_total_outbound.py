...
class TestViewVoiceStatisticsDataTotalOutbound(unittest.TestCase):
    """ViewVoiceStatisticsDataTotalOutbound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceStatisticsDataTotalOutbound:
        """Test ViewVoiceStatisticsDataTotalOutbound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceStatisticsDataTotalOutbound`
        """
        model = ViewVoiceStatisticsDataTotalOutbound()
        if include_optional:
    ...
    def testViewVoiceStatisticsDataTotalOutbound(self):
        """Test ViewVoiceStatisticsDataTotalOutbound"""
