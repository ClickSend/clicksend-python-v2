...
class TestViewSmsHistory(unittest.TestCase):
    """ViewSmsHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsHistory:
        """Test ViewSmsHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsHistory`
        """
        model = ViewSmsHistory()
        if include_optional:
