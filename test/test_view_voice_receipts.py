...
class TestViewVoiceReceipts(unittest.TestCase):
    """ViewVoiceReceipts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceReceipts:
        """Test ViewVoiceReceipts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceReceipts`
        """
        model = ViewVoiceReceipts()
        if include_optional:
    ...
    def testViewVoiceReceipts(self):
        """Test ViewVoiceReceipts"""
