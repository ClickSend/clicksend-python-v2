...
class TestSendVoiceMessageRequestMessagesInner(unittest.TestCase):
    """SendVoiceMessageRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVoiceMessageRequestMessagesInner:
        """Test SendVoiceMessageRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVoiceMessageRequestMessagesInner`
        """
    ...
    def testSendVoiceMessageRequestMessagesInner(self):
        """Test SendVoiceMessageRequestMessagesInner"""
