...
class TestCreateResellerAccountRequest(unittest.TestCase):
    """CreateResellerAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateResellerAccountRequest:
        """Test CreateResellerAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateResellerAccountRequest`
        """
        model = CreateResellerAccountRequest()
        if include_optional:
            return CreateResellerAccountRequest(
                country = '',
                password = '',
                user_email = '',
                user_first_name = '',
    ...
    def testCreateResellerAccountRequest(self):
        """Test CreateResellerAccountRequest"""
