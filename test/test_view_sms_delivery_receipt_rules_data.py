...
class TestViewSmsDeliveryReceiptRulesData(unittest.TestCase):
    """ViewSmsDeliveryReceiptRulesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsDeliveryReceiptRulesData:
        """Test ViewSmsDeliveryReceiptRulesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsDeliveryReceiptRulesData`
        """
        model = ViewSmsDeliveryReceiptRulesData()
        if include_optional:
            return ViewSmsDeliveryReceiptRulesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewSmsDeliveryReceiptRulesData(self):
        """Test ViewSmsDeliveryReceiptRulesData"""
