...
class TestViewSpecificSubaccount(unittest.TestCase):
    """ViewSpecificSubaccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificSubaccount:
        """Test ViewSpecificSubaccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificSubaccount`
        """
        model = ViewSpecificSubaccount()
        if include_optional:
    ...
    def testViewSpecificSubaccount(self):
        """Test ViewSpecificSubaccount"""
