...
class TestGenerateNewApiKeyData(unittest.TestCase):
    """GenerateNewApiKeyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateNewApiKeyData:
        """Test GenerateNewApiKeyData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateNewApiKeyData`
        """
        model = GenerateNewApiKeyData()
        if include_optional:
            return GenerateNewApiKeyData(
    ...
    def testGenerateNewApiKeyData(self):
        """Test GenerateNewApiKeyData"""
