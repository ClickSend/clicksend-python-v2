...
class TestDetectAddressData(unittest.TestCase):
    """DetectAddressData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetectAddressData:
        """Test DetectAddressData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetectAddressData`
        """
        model = DetectAddressData()
        if include_optional:
            return DetectAddressData(
    ...
    def testDetectAddressData(self):
        """Test DetectAddressData"""
