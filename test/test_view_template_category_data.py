...
class TestViewTemplateCategoryData(unittest.TestCase):
    """ViewTemplateCategoryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewTemplateCategoryData:
        """Test ViewTemplateCategoryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewTemplateCategoryData`
        """
        model = ViewTemplateCategoryData()
        if include_optional:
            return ViewTemplateCategoryData(
                category_id = 4,
                name = 'Birthday'
            )
        else:
    ...
    def testViewTemplateCategoryData(self):
        """Test ViewTemplateCategoryData"""
