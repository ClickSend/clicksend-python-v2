...
class TestViewAllTransactions(unittest.TestCase):
    """ViewAllTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllTransactions:
        """Test ViewAllTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllTransactions`
        """
        model = ViewAllTransactions()
        if include_optional:
    ...
    def testViewAllTransactions(self):
        """Test ViewAllTransactions"""
