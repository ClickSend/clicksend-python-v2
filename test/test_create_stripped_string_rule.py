...
class TestCreateStrippedStringRule(unittest.TestCase):
    """CreateStrippedStringRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStrippedStringRule:
        """Test CreateStrippedStringRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStrippedStringRule`
        """
        model = CreateStrippedStringRule()
        if include_optional:
    ...
    def testCreateStrippedStringRule(self):
        """Test CreateStrippedStringRule"""
