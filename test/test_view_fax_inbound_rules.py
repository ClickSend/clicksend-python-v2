...
class TestViewFaxInboundRules(unittest.TestCase):
    """ViewFaxInboundRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxInboundRules:
        """Test ViewFaxInboundRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxInboundRules`
        """
        model = ViewFaxInboundRules()
        if include_optional:
    ...
    def testViewFaxInboundRules(self):
        """Test ViewFaxInboundRules"""
