...
class TestGlobalSendingRegistrationStatus(unittest.TestCase):
    """GlobalSendingRegistrationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalSendingRegistrationStatus:
        """Test GlobalSendingRegistrationStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalSendingRegistrationStatus`
        """
        model = GlobalSendingRegistrationStatus()
        if include_optional:
            return GlobalSendingRegistrationStatus(
                id = 1,
                name = 'NOT_INITIATED'
            )
        else:
    ...
    def testGlobalSendingRegistrationStatus(self):
        """Test GlobalSendingRegistrationStatus"""
