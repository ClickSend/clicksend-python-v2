...
class TestCopyContactToList(unittest.TestCase):
    """CopyContactToList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopyContactToList:
        """Test CopyContactToList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopyContactToList`
        """
        model = CopyContactToList()
        if include_optional:
    ...
    def testCopyContactToList(self):
        """Test CopyContactToList"""
