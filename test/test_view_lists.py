...
class TestViewLists(unittest.TestCase):
    """ViewLists unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewLists:
        """Test ViewLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewLists`
        """
        model = ViewLists()
        if include_optional:
            return ViewLists(
                ...
                data = clicksend.models.view_lists_data.view_lists_data(
                    total = 0, 
                    per_page = 10, 
                    current_page = 1, 
                    last_page = 2, 
