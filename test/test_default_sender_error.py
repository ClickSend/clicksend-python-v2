...
class TestDefaultSenderError(unittest.TestCase):
    """DefaultSenderError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultSenderError:
        """Test DefaultSenderError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultSenderError`
        """
        model = DefaultSenderError()
        if include_optional:
            return DefaultSenderError(
                http_code = 400,
    ...
    def testDefaultSenderError(self):
        """Test DefaultSenderError"""
