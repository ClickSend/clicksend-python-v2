...
class TestViewSmsTemplates(unittest.TestCase):
    """ViewSmsTemplates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsTemplates:
        """Test ViewSmsTemplates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsTemplates`
        """
        model = ViewSmsTemplates()
        if include_optional:
