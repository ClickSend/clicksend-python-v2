...
class TestDeleteEmailDeliveryReceiptRule(unittest.TestCase):
    """DeleteEmailDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteEmailDeliveryReceiptRule:
        """Test DeleteEmailDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteEmailDeliveryReceiptRule`
        """
        model = DeleteEmailDeliveryReceiptRule()
        if include_optional:
    ...
    def testDeleteEmailDeliveryReceiptRule(self):
        """Test DeleteEmailDeliveryReceiptRule"""
