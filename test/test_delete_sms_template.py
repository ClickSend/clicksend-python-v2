...
class TestDeleteSmsTemplate(unittest.TestCase):
    """DeleteSmsTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteSmsTemplate:
        """Test DeleteSmsTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteSmsTemplate`
        """
        model = DeleteSmsTemplate()
        if include_optional:
    ...
    def testDeleteSmsTemplate(self):
        """Test DeleteSmsTemplate"""
