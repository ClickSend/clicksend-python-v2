...
class TestSendMmsCampaignRequest(unittest.TestCase):
    """SendMmsCampaignRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMmsCampaignRequest:
        """Test SendMmsCampaignRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMmsCampaignRequest`
        """
        model = SendMmsCampaignRequest()
        if include_optional:
            return SendMmsCampaignRequest(
                list_id = '',
                name = '',
                var_from = '',
                body = '',
    ...
    def testSendMmsCampaignRequest(self):
        """Test SendMmsCampaignRequest"""
