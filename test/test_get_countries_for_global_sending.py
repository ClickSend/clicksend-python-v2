...
class TestGetCountriesForGlobalSending(unittest.TestCase):
    """GetCountriesForGlobalSending unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCountriesForGlobalSending:
        """Test GetCountriesForGlobalSending
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCountriesForGlobalSending`
        """
        model = GetCountriesForGlobalSending()
        if include_optional:
    ...
    def testGetCountriesForGlobalSending(self):
        """Test GetCountriesForGlobalSending"""
