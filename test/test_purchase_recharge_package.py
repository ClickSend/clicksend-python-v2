...
class TestPurchaseRechargePackage(unittest.TestCase):
    """PurchaseRechargePackage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseRechargePackage:
        """Test PurchaseRechargePackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseRechargePackage`
        """
        model = PurchaseRechargePackage()
        if include_optional:
            return PurchaseRechargePackage(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Successfully purchased a package',
                data = clicksend.models.purchase_recharge_package_data.purchase_recharge_package_data(
                    user_id = 1, 
                    amount = 50, 
                    currency = 'USD', 
                    amount_aud = 56, 
    ...
    def testPurchaseRechargePackage(self):
        """Test PurchaseRechargePackage"""
