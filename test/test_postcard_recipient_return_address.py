...
class TestPostcardRecipientReturnAddress(unittest.TestCase):
    """PostcardRecipientReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostcardRecipientReturnAddress:
        """Test PostcardRecipientReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostcardRecipientReturnAddress`
        """
        model = PostcardRecipientReturnAddress()
        if include_optional:
            return PostcardRecipientReturnAddress(
    ...
    def testPostcardRecipientReturnAddress(self):
        """Test PostcardRecipientReturnAddress"""
