...
class TestResellerTransferCredit(unittest.TestCase):
    """ResellerTransferCredit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResellerTransferCredit:
        """Test ResellerTransferCredit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResellerTransferCredit`
        """
        model = ResellerTransferCredit()
        if include_optional:
    ...
    def testResellerTransferCredit(self):
        """Test ResellerTransferCredit"""
