...
class TestViewSmsReceipts(unittest.TestCase):
    """ViewSmsReceipts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsReceipts:
        """Test ViewSmsReceipts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsReceipts`
        """
        model = ViewSmsReceipts()
        if include_optional:
            return ViewSmsReceipts(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your delivery receipts.',
                data = clicksend.models.view_sms_receipts_data.view_sms_receipts_data()
            )
        else:
            return ViewSmsReceipts(
        )
