...
class TestSendFaxData(unittest.TestCase):
    """SendFaxData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFaxData:
        """Test SendFaxData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFaxData`
        """
        model = SendFaxData()
        if include_optional:
            return SendFaxData(
