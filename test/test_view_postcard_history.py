...
class TestViewPostcardHistory(unittest.TestCase):
    """ViewPostcardHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewPostcardHistory:
        """Test ViewPostcardHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewPostcardHistory`
        """
        model = ViewPostcardHistory()
        if include_optional:
    ...
    def testViewPostcardHistory(self):
        """Test ViewPostcardHistory"""
