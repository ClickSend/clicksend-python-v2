...
class TestSendEmailVerificationTokenRequestFrom(unittest.TestCase):
    """SendEmailVerificationTokenRequestFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailVerificationTokenRequestFrom:
        """Test SendEmailVerificationTokenRequestFrom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailVerificationTokenRequestFrom`
        """
        model = SendEmailVerificationTokenRequestFrom()
        if include_optional:
            return SendEmailVerificationTokenRequestFrom(
                email_address_id = 56,
                name = ''
            )
        else:
    ...
    def testSendEmailVerificationTokenRequestFrom(self):
        """Test SendEmailVerificationTokenRequestFrom"""
