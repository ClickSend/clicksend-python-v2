...
class TestRequestAlphaTagRequestBusinessesInnerRepresentative(unittest.TestCase):
    """RequestAlphaTagRequestBusinessesInnerRepresentative unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAlphaTagRequestBusinessesInnerRepresentative:
        """Test RequestAlphaTagRequestBusinessesInnerRepresentative
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAlphaTagRequestBusinessesInnerRepresentative`
        """
        model = RequestAlphaTagRequestBusinessesInnerRepresentative()
        if include_optional:
            return RequestAlphaTagRequestBusinessesInnerRepresentative(
                first_name = '',
                last_name = '',
                email = ''
            )
    ...
    def testRequestAlphaTagRequestBusinessesInnerRepresentative(self):
        """Test RequestAlphaTagRequestBusinessesInnerRepresentative"""
