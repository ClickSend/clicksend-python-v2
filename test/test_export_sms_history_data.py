...
class TestExportSmsHistoryData(unittest.TestCase):
    """ExportSmsHistoryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportSmsHistoryData:
        """Test ExportSmsHistoryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportSmsHistoryData`
        """
        model = ExportSmsHistoryData()
        if include_optional:
            return ExportSmsHistoryData(
    ...
    def testExportSmsHistoryData(self):
        """Test ExportSmsHistoryData"""
