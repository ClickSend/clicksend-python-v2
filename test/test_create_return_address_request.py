...
class TestCreateReturnAddressRequest(unittest.TestCase):
    """CreateReturnAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateReturnAddressRequest:
        """Test CreateReturnAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateReturnAddressRequest`
        """
        model = CreateReturnAddressRequest()
        if include_optional:
            return CreateReturnAddressRequest(
                address_name = '',
                address_line_1 = '',
                address_line_2 = '',
                address_city = '',
    ...
    def testCreateReturnAddressRequest(self):
        """Test CreateReturnAddressRequest"""
