...
class TestViewLetterHistory(unittest.TestCase):
    """ViewLetterHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewLetterHistory:
        """Test ViewLetterHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewLetterHistory`
        """
        model = ViewLetterHistory()
        if include_optional:
    ...
    def testViewLetterHistory(self):
        """Test ViewLetterHistory"""
