...
class TestGetDefaultSendersList(unittest.TestCase):
    """GetDefaultSendersList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDefaultSendersList:
        """Test GetDefaultSendersList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDefaultSendersList`
        """
        model = GetDefaultSendersList()
        if include_optional:
            return GetDefaultSendersList(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Default senders retrieved successfully',
                data = clicksend.models.get_default_senders_list_data.get_default_senders_list_data(
                    data = [
                        clicksend.models.default_sender.default_sender(
    ...
    def testGetDefaultSendersList(self):
        """Test GetDefaultSendersList"""
