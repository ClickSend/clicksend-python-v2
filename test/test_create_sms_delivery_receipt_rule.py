...
class TestCreateSmsDeliveryReceiptRule(unittest.TestCase):
    """CreateSmsDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmsDeliveryReceiptRule:
        """Test CreateSmsDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmsDeliveryReceiptRule`
        """
        model = CreateSmsDeliveryReceiptRule()
        if include_optional:
    ...
    def testCreateSmsDeliveryReceiptRule(self):
        """Test CreateSmsDeliveryReceiptRule"""
