...
class TestViewStrippedStringRulesDataAllOfDataInner(unittest.TestCase):
    """ViewStrippedStringRulesDataAllOfDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewStrippedStringRulesDataAllOfDataInner:
        """Test ViewStrippedStringRulesDataAllOfDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewStrippedStringRulesDataAllOfDataInner`
        """
        model = ViewStrippedStringRulesDataAllOfDataInner()
        if include_optional:
            return ViewStrippedStringRulesDataAllOfDataInner(
                rule_id = 56,
                strip_string = ''
            )
        else:
    ...
    def testViewStrippedStringRulesDataAllOfDataInner(self):
        """Test ViewStrippedStringRulesDataAllOfDataInner"""
