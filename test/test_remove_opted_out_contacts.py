...
class TestRemoveOptedOutContacts(unittest.TestCase):
    """RemoveOptedOutContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveOptedOutContacts:
        """Test RemoveOptedOutContacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveOptedOutContacts`
        """
        model = RemoveOptedOutContacts()
        if include_optional:
    ...
    def testRemoveOptedOutContacts(self):
        """Test RemoveOptedOutContacts"""
