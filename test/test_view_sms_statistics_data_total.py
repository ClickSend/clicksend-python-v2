...
class TestViewSmsStatisticsDataTotal(unittest.TestCase):
    """ViewSmsStatisticsDataTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsStatisticsDataTotal:
        """Test ViewSmsStatisticsDataTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsStatisticsDataTotal`
        """
        model = ViewSmsStatisticsDataTotal()
        if include_optional:
            return ViewSmsStatisticsDataTotal(
    ...
    def testViewSmsStatisticsDataTotal(self):
        """Test ViewSmsStatisticsDataTotal"""
