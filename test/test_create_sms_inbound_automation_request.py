...
class TestCreateSmsInboundAutomationRequest(unittest.TestCase):
    """CreateSmsInboundAutomationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmsInboundAutomationRequest:
        """Test CreateSmsInboundAutomationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmsInboundAutomationRequest`
        """
        model = CreateSmsInboundAutomationRequest()
        if include_optional:
            return CreateSmsInboundAutomationRequest(
                dedicated_number = '',
                rule_name = '',
    ...
    def testCreateSmsInboundAutomationRequest(self):
        """Test CreateSmsInboundAutomationRequest"""
