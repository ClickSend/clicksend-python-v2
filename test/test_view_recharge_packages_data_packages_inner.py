...
class TestViewRechargePackagesDataPackagesInner(unittest.TestCase):
    """ViewRechargePackagesDataPackagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewRechargePackagesDataPackagesInner:
        """Test ViewRechargePackagesDataPackagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewRechargePackagesDataPackagesInner`
        """
        model = ViewRechargePackagesDataPackagesInner()
        if include_optional:
    ...
    def testViewRechargePackagesDataPackagesInner(self):
        """Test ViewRechargePackagesDataPackagesInner"""
