...
class TestViewEmailDeliveryReceiptRules(unittest.TestCase):
    """ViewEmailDeliveryReceiptRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailDeliveryReceiptRules:
        """Test ViewEmailDeliveryReceiptRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailDeliveryReceiptRules`
        """
        model = ViewEmailDeliveryReceiptRules()
        if include_optional:
    ...
    def testViewEmailDeliveryReceiptRules(self):
        """Test ViewEmailDeliveryReceiptRules"""
