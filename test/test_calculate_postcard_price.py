...
class TestCalculatePostcardPrice(unittest.TestCase):
    """CalculatePostcardPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculatePostcardPrice:
        """Test CalculatePostcardPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculatePostcardPrice`
        """
        model = CalculatePostcardPrice()
        if include_optional:
            return CalculatePostcardPrice(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here is some pricing.',
                data = clicksend.models.send_postcard_data.send_postcard_data(
                    total_price = 11, 
                    total_count = 1, 
                    queued_count = 1, 
                    recipients = [
    ...
    def testCalculatePostcardPrice(self):
        """Test CalculatePostcardPrice"""
