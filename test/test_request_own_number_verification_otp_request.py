...
class TestRequestOwnNumberVerificationOtpRequest(unittest.TestCase):
    """RequestOwnNumberVerificationOtpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestOwnNumberVerificationOtpRequest:
        """Test RequestOwnNumberVerificationOtpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestOwnNumberVerificationOtpRequest`
        """
        model = RequestOwnNumberVerificationOtpRequest()
        if include_optional:
            return RequestOwnNumberVerificationOtpRequest(
                label = '',
                phone_number = '',
                country = ''
            )
    ...
    def testRequestOwnNumberVerificationOtpRequest(self):
        """Test RequestOwnNumberVerificationOtpRequest"""
