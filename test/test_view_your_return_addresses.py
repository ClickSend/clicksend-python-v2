...
class TestViewYourReturnAddresses(unittest.TestCase):
    """ViewYourReturnAddresses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewYourReturnAddresses:
        """Test ViewYourReturnAddresses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewYourReturnAddresses`
        """
        model = ViewYourReturnAddresses()
        if include_optional:
    ...
    def testViewYourReturnAddresses(self):
        """Test ViewYourReturnAddresses"""
