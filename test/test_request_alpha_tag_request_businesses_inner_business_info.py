...
class TestRequestAlphaTagRequestBusinessesInnerBusinessInfo(unittest.TestCase):
    """RequestAlphaTagRequestBusinessesInnerBusinessInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAlphaTagRequestBusinessesInnerBusinessInfo:
        """Test RequestAlphaTagRequestBusinessesInnerBusinessInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAlphaTagRequestBusinessesInnerBusinessInfo`
        """
        model = RequestAlphaTagRequestBusinessesInnerBusinessInfo()
        if include_optional:
            return RequestAlphaTagRequestBusinessesInnerBusinessInfo(
                website = '',
                phone_number = ''
            )
        else:
    ...
    def testRequestAlphaTagRequestBusinessesInnerBusinessInfo(self):
        """Test RequestAlphaTagRequestBusinessesInnerBusinessInfo"""
