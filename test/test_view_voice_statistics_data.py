...
class TestViewVoiceStatisticsData(unittest.TestCase):
    """ViewVoiceStatisticsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceStatisticsData:
        """Test ViewVoiceStatisticsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceStatisticsData`
        """
        model = ViewVoiceStatisticsData()
        if include_optional:
            return ViewVoiceStatisticsData(
    ...
    def testViewVoiceStatisticsData(self):
        """Test ViewVoiceStatisticsData"""
