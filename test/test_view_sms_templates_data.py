...
class TestViewSmsTemplatesData(unittest.TestCase):
    """ViewSmsTemplatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsTemplatesData:
        """Test ViewSmsTemplatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsTemplatesData`
        """
        model = ViewSmsTemplatesData()
        if include_optional:
            return ViewSmsTemplatesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.sms_template.sms_template(
                        template_id = 1, 
    ...
    def testViewSmsTemplatesData(self):
        """Test ViewSmsTemplatesData"""
