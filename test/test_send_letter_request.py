...
class TestSendLetterRequest(unittest.TestCase):
    """SendLetterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLetterRequest:
        """Test SendLetterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLetterRequest`
        """
        model = SendLetterRequest()
        if include_optional:
    ...
    def testSendLetterRequest(self):
        """Test SendLetterRequest"""
