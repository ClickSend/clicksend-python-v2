...
class TestCancelAllVoiceMessages(unittest.TestCase):
    """CancelAllVoiceMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelAllVoiceMessages:
        """Test CancelAllVoiceMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelAllVoiceMessages`
        """
        model = CancelAllVoiceMessages()
        if include_optional:
            return CancelAllVoiceMessages(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = '5 messages have been cancelled.',
                data = clicksend.models.cancel_all_sms_data.cancel_all_sms_data(
                    count = 2, )
            )
        else:
            return CancelAllVoiceMessages(
    ...
    def testCancelAllVoiceMessages(self):
        """Test CancelAllVoiceMessages"""
