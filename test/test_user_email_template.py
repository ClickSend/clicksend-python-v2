...
class TestUserEmailTemplate(unittest.TestCase):
    """UserEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserEmailTemplate:
        """Test UserEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserEmailTemplate`
        """
    ...
    def testUserEmailTemplate(self):
        """Test UserEmailTemplate"""
