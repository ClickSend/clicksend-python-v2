...
class TestEmailDeliveryReceiptRule(unittest.TestCase):
    """EmailDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailDeliveryReceiptRule:
        """Test EmailDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailDeliveryReceiptRule`
        """
        model = EmailDeliveryReceiptRule()
        if include_optional:
            return EmailDeliveryReceiptRule(
                receipt_rule_id = 1,
    ...
    def testEmailDeliveryReceiptRule(self):
        """Test EmailDeliveryReceiptRule"""
