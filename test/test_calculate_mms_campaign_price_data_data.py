...
class TestCalculateMmsCampaignPriceDataData(unittest.TestCase):
    """CalculateMmsCampaignPriceDataData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateMmsCampaignPriceDataData:
        """Test CalculateMmsCampaignPriceDataData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateMmsCampaignPriceDataData`
        """
        model = CalculateMmsCampaignPriceDataData()
        if include_optional:
            return CalculateMmsCampaignPriceDataData(
    ...
    def testCalculateMmsCampaignPriceDataData(self):
        """Test CalculateMmsCampaignPriceDataData"""
