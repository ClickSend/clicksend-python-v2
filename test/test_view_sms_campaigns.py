...
class TestViewSmsCampaigns(unittest.TestCase):
    """ViewSmsCampaigns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsCampaigns:
        """Test ViewSmsCampaigns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsCampaigns`
        """
        model = ViewSmsCampaigns()
        if include_optional:
            return ViewSmsCampaigns(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your SMS campaigns.',
                data = clicksend.models.view_sms_campaigns_data.view_sms_campaigns_data()
            )
        else:
            return ViewSmsCampaigns(
        )
