...
class TestCreateTestSmsReceiptData(unittest.TestCase):
    """CreateTestSmsReceiptData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTestSmsReceiptData:
        """Test CreateTestSmsReceiptData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestSmsReceiptData`
        """
        model = CreateTestSmsReceiptData()
        if include_optional:
            return CreateTestSmsReceiptData(
    ...
    def testCreateTestSmsReceiptData(self):
        """Test CreateTestSmsReceiptData"""
