...
class TestCalculateMmsCampaignPrice(unittest.TestCase):
    """CalculateMmsCampaignPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateMmsCampaignPrice:
        """Test CalculateMmsCampaignPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateMmsCampaignPrice`
        """
        model = CalculateMmsCampaignPrice()
        if include_optional:
    ...
    def testCalculateMmsCampaignPrice(self):
        """Test CalculateMmsCampaignPrice"""
