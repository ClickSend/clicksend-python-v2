...
class TestViewEmailTemplates(unittest.TestCase):
    """ViewEmailTemplates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailTemplates:
        """Test ViewEmailTemplates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailTemplates`
        """
        model = ViewEmailTemplates()
        if include_optional:
            return ViewEmailTemplates(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your email templates.',
                data = clicksend.models.view_email_templates_data.view_email_templates_data(
                    total = 2, 
                    per_page = 15, 
                    current_page = 1, 
                    last_page = 1, 
    ...
    def testViewEmailTemplates(self):
        """Test ViewEmailTemplates"""
