...
class TestCancelEmailCampaignRequest(unittest.TestCase):
    """CancelEmailCampaignRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelEmailCampaignRequest:
        """Test CancelEmailCampaignRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelEmailCampaignRequest`
        """
        model = CancelEmailCampaignRequest()
        if include_optional:
            return CancelEmailCampaignRequest(
                name = '',
                subject = '',
    ...
    def testCancelEmailCampaignRequest(self):
        """Test CancelEmailCampaignRequest"""
