...
class TestCancelScheduledLetter(unittest.TestCase):
    """CancelScheduledLetter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelScheduledLetter:
        """Test CancelScheduledLetter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelScheduledLetter`
        """
        model = CancelScheduledLetter()
        if include_optional:
    ...
    def testCancelScheduledLetter(self):
        """Test CancelScheduledLetter"""
