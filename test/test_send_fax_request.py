...
class TestSendFaxRequest(unittest.TestCase):
    """SendFaxRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFaxRequest:
        """Test SendFaxRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFaxRequest`
        """
        ...
        if include_optional:
            return SendFaxRequest(
                file_url = '',
                messages = [
                    clicksend.models.send_fax_request_messages_inner.send_fax_request_messages_inner(
                        source = '', 
                        from = '', 
                        to = '', 
                        custom_string = '', )
