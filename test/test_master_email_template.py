...
class TestMasterEmailTemplate(unittest.TestCase):
    """MasterEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MasterEmailTemplate:
        """Test MasterEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MasterEmailTemplate`
        """
    ...
    def testMasterEmailTemplate(self):
        """Test MasterEmailTemplate"""
