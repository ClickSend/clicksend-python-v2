...
class TestCancelVoiceMessage(unittest.TestCase):
    """CancelVoiceMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelVoiceMessage:
        """Test CancelVoiceMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelVoiceMessage`
        """
        model = CancelVoiceMessage()
        if include_optional:
    ...
    def testCancelVoiceMessage(self):
        """Test CancelVoiceMessage"""
