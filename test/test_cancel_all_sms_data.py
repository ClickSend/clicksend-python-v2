...
class TestCancelAllSmsData(unittest.TestCase):
    """CancelAllSmsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelAllSmsData:
        """Test CancelAllSmsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelAllSmsData`
        """
        model = CancelAllSmsData()
        if include_optional:
            return CancelAllSmsData(
                count = 2
            )
        else:
            return CancelAllSmsData(
