...
class TestCreateDefaultSender(unittest.TestCase):
    """CreateDefaultSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDefaultSender:
        """Test CreateDefaultSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDefaultSender`
        """
        model = CreateDefaultSender()
        if include_optional:
    ...
    def testCreateDefaultSender(self):
        """Test CreateDefaultSender"""
