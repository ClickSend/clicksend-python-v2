...
class TestCalculateEmailCampaignPriceRequest(unittest.TestCase):
    """CalculateEmailCampaignPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailCampaignPriceRequest:
        """Test CalculateEmailCampaignPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailCampaignPriceRequest`
        """
        model = CalculateEmailCampaignPriceRequest()
        if include_optional:
            return CalculateEmailCampaignPriceRequest(
                name = '',
                subject = '',
    ...
    def testCalculateEmailCampaignPriceRequest(self):
        """Test CalculateEmailCampaignPriceRequest"""
