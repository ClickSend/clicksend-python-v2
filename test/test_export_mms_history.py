...
class TestExportMmsHistory(unittest.TestCase):
    """ExportMmsHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportMmsHistory:
        """Test ExportMmsHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportMmsHistory`
        """
        model = ExportMmsHistory()
        if include_optional:
