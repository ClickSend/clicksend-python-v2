...
class TestViewTemplatesInCategory(unittest.TestCase):
    """ViewTemplatesInCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewTemplatesInCategory:
        """Test ViewTemplatesInCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewTemplatesInCategory`
        """
        model = ViewTemplatesInCategory()
        if include_optional:
    ...
    def testViewTemplatesInCategory(self):
        """Test ViewTemplatesInCategory"""
