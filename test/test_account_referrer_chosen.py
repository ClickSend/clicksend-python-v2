...
class TestAccountReferrerChosen(unittest.TestCase):
    """AccountReferrerChosen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountReferrerChosen:
        """Test AccountReferrerChosen
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountReferrerChosen`
        """
        model = AccountReferrerChosen()
        if include_optional:
            return AccountReferrerChosen(
                id = 8,
                name = 'Other'
            )
        else:
    ...
    def testAccountReferrerChosen(self):
        """Test AccountReferrerChosen"""
