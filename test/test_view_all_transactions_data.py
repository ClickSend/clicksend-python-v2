...
class TestViewAllTransactionsData(unittest.TestCase):
    """ViewAllTransactionsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllTransactionsData:
        """Test ViewAllTransactionsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllTransactionsData`
        """
        model = ViewAllTransactionsData()
        if include_optional:
            return ViewAllTransactionsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewAllTransactionsData(self):
        """Test ViewAllTransactionsData"""
