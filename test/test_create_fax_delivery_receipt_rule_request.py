...
class TestCreateFaxDeliveryReceiptRuleRequest(unittest.TestCase):
    """CreateFaxDeliveryReceiptRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFaxDeliveryReceiptRuleRequest:
        """Test CreateFaxDeliveryReceiptRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFaxDeliveryReceiptRuleRequest`
        """
        model = CreateFaxDeliveryReceiptRuleRequest()
        if include_optional:
            return CreateFaxDeliveryReceiptRuleRequest(
                rule_name = '',
                match_type = 56,
                action = '',
                action_address = '',
    ...
    def testCreateFaxDeliveryReceiptRuleRequest(self):
        """Test CreateFaxDeliveryReceiptRuleRequest"""
