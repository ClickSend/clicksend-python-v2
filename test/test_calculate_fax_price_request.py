...
class TestCalculateFaxPriceRequest(unittest.TestCase):
    """CalculateFaxPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateFaxPriceRequest:
        """Test CalculateFaxPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateFaxPriceRequest`
        """
        model = CalculateFaxPriceRequest()
        if include_optional:
            return CalculateFaxPriceRequest(
                file_url = '',
                messages = [
                    clicksend.models.calculate_fax_price_request_messages_inner.calculate_fax_price_request_messages_inner(
                        source = '', 
                        from = '', 
                        to = '', 
                        from_email = '', 
    ...
    def testCalculateFaxPriceRequest(self):
        """Test CalculateFaxPriceRequest"""
