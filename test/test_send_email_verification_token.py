...
class TestSendEmailVerificationToken(unittest.TestCase):
    """SendEmailVerificationToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailVerificationToken:
        """Test SendEmailVerificationToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailVerificationToken`
        """
        model = SendEmailVerificationToken()
        if include_optional:
    ...
    def testSendEmailVerificationToken(self):
        """Test SendEmailVerificationToken"""
