...
class TestViewFaxHistoryData(unittest.TestCase):
    """ViewFaxHistoryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxHistoryData:
        """Test ViewFaxHistoryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxHistoryData`
        """
        model = ViewFaxHistoryData()
        if include_optional:
            return ViewFaxHistoryData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewFaxHistoryData(self):
        """Test ViewFaxHistoryData"""
