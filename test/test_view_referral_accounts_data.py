...
class TestViewReferralAccountsData(unittest.TestCase):
    """ViewReferralAccountsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewReferralAccountsData:
        """Test ViewReferralAccountsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewReferralAccountsData`
        """
        model = ViewReferralAccountsData()
        if include_optional:
            return ViewReferralAccountsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewReferralAccountsData(self):
        """Test ViewReferralAccountsData"""
