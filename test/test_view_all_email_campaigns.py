...
class TestViewAllEmailCampaigns(unittest.TestCase):
    """ViewAllEmailCampaigns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllEmailCampaigns:
        """Test ViewAllEmailCampaigns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllEmailCampaigns`
        """
        model = ViewAllEmailCampaigns()
        if include_optional:
    ...
    def testViewAllEmailCampaigns(self):
        """Test ViewAllEmailCampaigns"""
