...
class TestViewASpecificInboundSmsMessage(unittest.TestCase):
    """ViewASpecificInboundSmsMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewASpecificInboundSmsMessage:
        """Test ViewASpecificInboundSmsMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewASpecificInboundSmsMessage`
        """
        model = ViewASpecificInboundSmsMessage()
        if include_optional:
            return ViewASpecificInboundSmsMessage(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your data.',
                data = clicksend.models.inbound_sms.inbound_sms(
    ...
    def testViewASpecificInboundSmsMessage(self):
        """Test ViewASpecificInboundSmsMessage"""
