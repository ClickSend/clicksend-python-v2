...
class TestViewAccountUsageDataSmsTotal(unittest.TestCase):
    """ViewAccountUsageDataSmsTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAccountUsageDataSmsTotal:
        """Test ViewAccountUsageDataSmsTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAccountUsageDataSmsTotal`
        """
        model = ViewAccountUsageDataSmsTotal()
        if include_optional:
            return ViewAccountUsageDataSmsTotal(
                count = '',
                price = ''
            )
        else:
    ...
    def testViewAccountUsageDataSmsTotal(self):
        """Test ViewAccountUsageDataSmsTotal"""
