...
class TestDeleteFaxDeliveryReceiptRule(unittest.TestCase):
    """DeleteFaxDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteFaxDeliveryReceiptRule:
        """Test DeleteFaxDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteFaxDeliveryReceiptRule`
        """
        model = DeleteFaxDeliveryReceiptRule()
        if include_optional:
    ...
    def testDeleteFaxDeliveryReceiptRule(self):
        """Test DeleteFaxDeliveryReceiptRule"""
