...
class TestListCountriesDataInner(unittest.TestCase):
    """ListCountriesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCountriesDataInner:
        """Test ListCountriesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCountriesDataInner`
        """
        model = ListCountriesDataInner()
        if include_optional:
            return ListCountriesDataInner(
                id = 1,
                name = 'Australia',
                code = 'AU',
                region = 'Oceania'
    ...
    def testListCountriesDataInner(self):
        """Test ListCountriesDataInner"""
