...
class TestViewASpecificSmsTemplateData(unittest.TestCase):
    """ViewASpecificSmsTemplateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewASpecificSmsTemplateData:
        """Test ViewASpecificSmsTemplateData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewASpecificSmsTemplateData`
        """
        model = ViewASpecificSmsTemplateData()
        if include_optional:
            return ViewASpecificSmsTemplateData(
                template_id = 1,
...
new line 漢字 here.'
    ...
    def testViewASpecificSmsTemplateData(self):
        """Test ViewASpecificSmsTemplateData"""
