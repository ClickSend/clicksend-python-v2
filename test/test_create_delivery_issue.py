...
class TestCreateDeliveryIssue(unittest.TestCase):
    """CreateDeliveryIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDeliveryIssue:
        """Test CreateDeliveryIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDeliveryIssue`
        """
        model = CreateDeliveryIssue()
        if include_optional:
            return CreateDeliveryIssue(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'New delivery issue has been created.',
                data = clicksend.models.create_delivery_issue_data.create_delivery_issue_data(
                    issue_id = 1, 
                    user_id = 3820, 
    ...
    def testCreateDeliveryIssue(self):
        """Test CreateDeliveryIssue"""
