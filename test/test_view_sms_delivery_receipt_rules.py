...
class TestViewSmsDeliveryReceiptRules(unittest.TestCase):
    """ViewSmsDeliveryReceiptRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsDeliveryReceiptRules:
        """Test ViewSmsDeliveryReceiptRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsDeliveryReceiptRules`
        """
        model = ViewSmsDeliveryReceiptRules()
        if include_optional:
    ...
    def testViewSmsDeliveryReceiptRules(self):
        """Test ViewSmsDeliveryReceiptRules"""
