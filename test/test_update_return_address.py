...
class TestUpdateReturnAddress(unittest.TestCase):
    """UpdateReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateReturnAddress:
        """Test UpdateReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateReturnAddress`
        """
        model = UpdateReturnAddress()
        if include_optional:
    ...
    def testUpdateReturnAddress(self):
        """Test UpdateReturnAddress"""
