...
class TestCalculateLetterPriceRequest(unittest.TestCase):
    """CalculateLetterPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateLetterPriceRequest:
        """Test CalculateLetterPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateLetterPriceRequest`
        """
        model = CalculateLetterPriceRequest()
        if include_optional:
            return CalculateLetterPriceRequest(
                file_url = '',
                template_used = 56,
                duplex = 56,
                colour = 56,
                source = '',
                recipients = [
                    clicksend.models.send_postcard_request_recipients_inner.send_postcard_request_recipients_inner(
                        address_name = '', 
                        address_city = '', 
                        address_state = '', 
                        address_postal_code = '', 
    ...
    def testCalculateLetterPriceRequest(self):
        """Test CalculateLetterPriceRequest"""
