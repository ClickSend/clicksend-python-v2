...
class TestDeleteVoiceDeliveryReceiptRule(unittest.TestCase):
    """DeleteVoiceDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteVoiceDeliveryReceiptRule:
        """Test DeleteVoiceDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteVoiceDeliveryReceiptRule`
        """
        model = DeleteVoiceDeliveryReceiptRule()
        if include_optional:
    ...
    def testDeleteVoiceDeliveryReceiptRule(self):
        """Test DeleteVoiceDeliveryReceiptRule"""
