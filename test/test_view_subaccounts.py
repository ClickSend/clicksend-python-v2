...
class TestViewSubaccounts(unittest.TestCase):
    """ViewSubaccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSubaccounts:
        """Test ViewSubaccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSubaccounts`
        """
        model = ViewSubaccounts()
        if include_optional:
