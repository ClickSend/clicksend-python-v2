...
class TestViewCountries(unittest.TestCase):
    """ViewCountries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewCountries:
        """Test ViewCountries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewCountries`
        """
        model = ViewCountries()
        if include_optional:
