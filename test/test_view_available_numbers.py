...
class TestViewAvailableNumbers(unittest.TestCase):
    """ViewAvailableNumbers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAvailableNumbers:
        """Test ViewAvailableNumbers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAvailableNumbers`
        """
        model = ViewAvailableNumbers()
        if include_optional:
    ...
    def testViewAvailableNumbers(self):
        """Test ViewAvailableNumbers"""
