...
class TestGetTrackingDataInner(unittest.TestCase):
    """GetTrackingDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTrackingDataInner:
        """Test GetTrackingDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTrackingDataInner`
        """
        model = GetTrackingDataInner()
        if include_optional:
            return GetTrackingDataInner(
                open_count = 5,
    ...
    def testGetTrackingDataInner(self):
        """Test GetTrackingDataInner"""
