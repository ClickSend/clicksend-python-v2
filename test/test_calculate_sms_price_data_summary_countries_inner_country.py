...
class TestCalculateSmsPriceDataSummaryCountriesInnerCountry(unittest.TestCase):
    """CalculateSmsPriceDataSummaryCountriesInnerCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsPriceDataSummaryCountriesInnerCountry:
        """Test CalculateSmsPriceDataSummaryCountriesInnerCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsPriceDataSummaryCountriesInnerCountry`
        """
        model = CalculateSmsPriceDataSummaryCountriesInnerCountry()
        if include_optional:
            return CalculateSmsPriceDataSummaryCountriesInnerCountry(
    ...
    def testCalculateSmsPriceDataSummaryCountriesInnerCountry(self):
        """Test CalculateSmsPriceDataSummaryCountriesInnerCountry"""
