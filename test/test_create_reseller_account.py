...
class TestCreateResellerAccount(unittest.TestCase):
    """CreateResellerAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateResellerAccount:
        """Test CreateResellerAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateResellerAccount`
        """
        model = CreateResellerAccount()
        if include_optional:
    ...
    def testCreateResellerAccount(self):
        """Test CreateResellerAccount"""
