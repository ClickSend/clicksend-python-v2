...
class TestCalculateFaxPrice(unittest.TestCase):
    """CalculateFaxPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateFaxPrice:
        """Test CalculateFaxPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateFaxPrice`
        """
        model = CalculateFaxPrice()
        if include_optional:
    ...
    def testCalculateFaxPrice(self):
        """Test CalculateFaxPrice"""
