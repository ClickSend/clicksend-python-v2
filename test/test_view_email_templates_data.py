...
class TestViewEmailTemplatesData(unittest.TestCase):
    """ViewEmailTemplatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailTemplatesData:
        """Test ViewEmailTemplatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailTemplatesData`
        """
        model = ViewEmailTemplatesData()
        if include_optional:
            return ViewEmailTemplatesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewEmailTemplatesData(self):
        """Test ViewEmailTemplatesData"""
