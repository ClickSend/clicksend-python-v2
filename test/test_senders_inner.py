...
class TestSendersInner(unittest.TestCase):
    """SendersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendersInner:
        """Test SendersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendersInner`
        """
        model = SendersInner()
        if include_optional:
            return SendersInner(
