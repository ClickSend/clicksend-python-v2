...
class TestViewVoiceReceiptsData(unittest.TestCase):
    """ViewVoiceReceiptsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceReceiptsData:
        """Test ViewVoiceReceiptsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceReceiptsData`
        """
        model = ViewVoiceReceiptsData()
        if include_optional:
            return ViewVoiceReceiptsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewVoiceReceiptsData(self):
        """Test ViewVoiceReceiptsData"""
