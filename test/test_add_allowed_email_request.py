...
class TestAddAllowedEmailRequest(unittest.TestCase):
    """AddAllowedEmailRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddAllowedEmailRequest:
        """Test AddAllowedEmailRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddAllowedEmailRequest`
        """
        model = AddAllowedEmailRequest()
        if include_optional:
            return AddAllowedEmailRequest(
                email_address = '',
                var_from = '',
                from_fax = '',
                subaccount_id = ''
    ...
    def testAddAllowedEmailRequest(self):
        """Test AddAllowedEmailRequest"""
