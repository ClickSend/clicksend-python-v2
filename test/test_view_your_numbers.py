...
class TestViewYourNumbers(unittest.TestCase):
    """ViewYourNumbers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewYourNumbers:
        """Test ViewYourNumbers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewYourNumbers`
        """
        model = ViewYourNumbers()
        if include_optional:
