...
class TestSmsTemplateUpdate(unittest.TestCase):
    """SmsTemplateUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmsTemplateUpdate:
        """Test SmsTemplateUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmsTemplateUpdate`
        """
        model = SmsTemplateUpdate()
        if include_optional:
    ...
    def testSmsTemplateUpdate(self):
        """Test SmsTemplateUpdate"""
