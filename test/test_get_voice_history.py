...
class TestGetVoiceHistory(unittest.TestCase):
    """GetVoiceHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVoiceHistory:
        """Test GetVoiceHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVoiceHistory`
        """
        model = GetVoiceHistory()
        if include_optional:
