...
class TestViewYourNumbersDataAllOfDataInnerStatus(unittest.TestCase):
    """ViewYourNumbersDataAllOfDataInnerStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewYourNumbersDataAllOfDataInnerStatus:
        """Test ViewYourNumbersDataAllOfDataInnerStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewYourNumbersDataAllOfDataInnerStatus`
        """
        model = ViewYourNumbersDataAllOfDataInnerStatus()
        if include_optional:
            return ViewYourNumbersDataAllOfDataInnerStatus(
                value = 0,
    ...
    def testViewYourNumbersDataAllOfDataInnerStatus(self):
        """Test ViewYourNumbersDataAllOfDataInnerStatus"""
