...
class TestBuyNumberRequest(unittest.TestCase):
    """BuyNumberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuyNumberRequest:
        """Test BuyNumberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuyNumberRequest`
        """
        model = BuyNumberRequest()
        if include_optional:
            return BuyNumberRequest(
                dedicated_number = '+614197651956',
                type = 'sms',
                registration_data = clicksend.models.buy_number_request_registration_data.buy_number_request_registration_data(
                    business_name = 'ABD', 
