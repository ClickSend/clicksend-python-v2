...
class TestRemoveDuplicateContactsRequest(unittest.TestCase):
    """RemoveDuplicateContactsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveDuplicateContactsRequest:
        """Test RemoveDuplicateContactsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveDuplicateContactsRequest`
        """
        model = RemoveDuplicateContactsRequest()
        if include_optional:
            return RemoveDuplicateContactsRequest(
                fields = clicksend.models.remove_duplicate_contacts_request_fields.remove_duplicate_contacts_request_fields(
                    first_name = '', 
                    last_name = '', )
            )
        else:
    ...
    def testRemoveDuplicateContactsRequest(self):
        """Test RemoveDuplicateContactsRequest"""
