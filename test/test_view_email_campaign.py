...
class TestViewEmailCampaign(unittest.TestCase):
    """ViewEmailCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailCampaign:
        """Test ViewEmailCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailCampaign`
        """
        model = ViewEmailCampaign()
        if include_optional:
    ...
    def testViewEmailCampaign(self):
        """Test ViewEmailCampaign"""
