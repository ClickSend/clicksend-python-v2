...
class TestCalculateFaxPriceRequestMessagesInner(unittest.TestCase):
    """CalculateFaxPriceRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateFaxPriceRequestMessagesInner:
        """Test CalculateFaxPriceRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateFaxPriceRequestMessagesInner`
        """
        model = CalculateFaxPriceRequestMessagesInner()
        if include_optional:
            return CalculateFaxPriceRequestMessagesInner(
                source = '',
                var_from = '',
                to = '',
                from_email = '',
    ...
    def testCalculateFaxPriceRequestMessagesInner(self):
        """Test CalculateFaxPriceRequestMessagesInner"""
