...
class TestRegisterNumbers(unittest.TestCase):
    """RegisterNumbers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterNumbers:
        """Test RegisterNumbers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterNumbers`
        """
        model = RegisterNumbers()
        if include_optional:
