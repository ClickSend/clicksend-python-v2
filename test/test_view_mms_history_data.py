...
class TestViewMmsHistoryData(unittest.TestCase):
    """ViewMmsHistoryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewMmsHistoryData:
        """Test ViewMmsHistoryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewMmsHistoryData`
        """
        model = ViewMmsHistoryData()
        if include_optional:
            return ViewMmsHistoryData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.view_mms_history_data_all_of_data_inner.view_mms_history_data_allOf_data_inner(
                        direction = 'out', 
                        date = '1436932432', 
                        to = '+16783270696', 
    ...
    def testViewMmsHistoryData(self):
        """Test ViewMmsHistoryData"""
