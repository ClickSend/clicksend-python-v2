...
class TestSendSmsCampaign(unittest.TestCase):
    """SendSmsCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSmsCampaign:
        """Test SendSmsCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSmsCampaign`
        """
        model = SendSmsCampaign()
        if include_optional:
