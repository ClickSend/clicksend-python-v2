...
class TestViewAllowedEmailAddressesData(unittest.TestCase):
    """ViewAllowedEmailAddressesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllowedEmailAddressesData:
        """Test ViewAllowedEmailAddressesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllowedEmailAddressesData`
        """
        model = ViewAllowedEmailAddressesData()
        if include_optional:
            return ViewAllowedEmailAddressesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                var_from = 1,
                to = 2,
                data = [{"email_address_id":2,"email_address":"test@user.com","verified":1,"date_added":"1447736880"},{"email_address_id":3,"email_address":"test2@user.com","verified":0,"date_added":"1449042967"}]
            )
        else:
            return ViewAllowedEmailAddressesData(
        )
    ...
    def testViewAllowedEmailAddressesData(self):
        """Test ViewAllowedEmailAddressesData"""
