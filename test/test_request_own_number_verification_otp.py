...
class TestRequestOwnNumberVerificationOtp(unittest.TestCase):
    """RequestOwnNumberVerificationOtp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestOwnNumberVerificationOtp:
        """Test RequestOwnNumberVerificationOtp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestOwnNumberVerificationOtp`
        """
        model = RequestOwnNumberVerificationOtp()
        if include_optional:
    ...
    def testRequestOwnNumberVerificationOtp(self):
        """Test RequestOwnNumberVerificationOtp"""
