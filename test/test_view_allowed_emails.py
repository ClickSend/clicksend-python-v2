...
class TestViewAllowedEmails(unittest.TestCase):
    """ViewAllowedEmails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllowedEmails:
        """Test ViewAllowedEmails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllowedEmails`
        """
        model = ViewAllowedEmails()
        if include_optional:
    ...
    def testViewAllowedEmails(self):
        """Test ViewAllowedEmails"""
