...
class TestRemoveDuplicateContacts(unittest.TestCase):
    """RemoveDuplicateContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveDuplicateContacts:
        """Test RemoveDuplicateContacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveDuplicateContacts`
        """
        model = RemoveDuplicateContacts()
        if include_optional:
            return RemoveDuplicateContacts(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your list duplicate contacts has been deleted.',
                data = clicksend.models.remove_opted_out_contacts_data.remove_opted_out_contacts_data(
                    deleted = 6, )
            )
        else:
            return RemoveDuplicateContacts(
    ...
    def testRemoveDuplicateContacts(self):
        """Test RemoveDuplicateContacts"""
