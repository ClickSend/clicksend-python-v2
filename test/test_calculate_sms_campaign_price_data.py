...
class TestCalculateSmsCampaignPriceData(unittest.TestCase):
    """CalculateSmsCampaignPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsCampaignPriceData:
        """Test CalculateSmsCampaignPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsCampaignPriceData`
        """
        model = CalculateSmsCampaignPriceData()
        if include_optional:
    ...
    def testCalculateSmsCampaignPriceData(self):
        """Test CalculateSmsCampaignPriceData"""
