...
class TestImportContactsRequest(unittest.TestCase):
    """ImportContactsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportContactsRequest:
        """Test ImportContactsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportContactsRequest`
        """
        model = ImportContactsRequest()
        if include_optional:
    ...
    def testImportContactsRequest(self):
        """Test ImportContactsRequest"""
