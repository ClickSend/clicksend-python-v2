...
class TestDetectAddress(unittest.TestCase):
    """DetectAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetectAddress:
        """Test DetectAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetectAddress`
        """
        model = DetectAddress()
        if include_optional:
            return DetectAddress(
                ...
                data = clicksend.models.detect_address_data.detect_address_data(
