...
class TestCreateAllowedEmailAddress(unittest.TestCase):
    """CreateAllowedEmailAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAllowedEmailAddress:
        """Test CreateAllowedEmailAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAllowedEmailAddress`
        """
        model = CreateAllowedEmailAddress()
        if include_optional:
    ...
    def testCreateAllowedEmailAddress(self):
        """Test CreateAllowedEmailAddress"""
