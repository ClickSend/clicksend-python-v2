...
class TestCreateSmsTemplate(unittest.TestCase):
    """CreateSmsTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmsTemplate:
        """Test CreateSmsTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmsTemplate`
        """
    ...
    def testCreateSmsTemplate(self):
        """Test CreateSmsTemplate"""
