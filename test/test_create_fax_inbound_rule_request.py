...
class TestCreateFaxInboundRuleRequest(unittest.TestCase):
    """CreateFaxInboundRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFaxInboundRuleRequest:
        """Test CreateFaxInboundRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFaxInboundRuleRequest`
        """
        model = CreateFaxInboundRuleRequest()
        if include_optional:
            return CreateFaxInboundRuleRequest(
                dedicated_number = '',
                rule_name = '',
                action = '',
                action_address = '',
    ...
    def testCreateFaxInboundRuleRequest(self):
        """Test CreateFaxInboundRuleRequest"""
