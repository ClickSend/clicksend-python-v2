...
class TestViewReferralAccounts(unittest.TestCase):
    """ViewReferralAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewReferralAccounts:
        """Test ViewReferralAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewReferralAccounts`
        """
        model = ViewReferralAccounts()
        if include_optional:
    ...
    def testViewReferralAccounts(self):
        """Test ViewReferralAccounts"""
