...
class TestSendSmsData(unittest.TestCase):
    """SendSmsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSmsData:
        """Test SendSmsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSmsData`
        """
        model = SendSmsData()
        if include_optional:
            return SendSmsData(
