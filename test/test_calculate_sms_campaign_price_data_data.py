...
class TestCalculateSmsCampaignPriceDataData(unittest.TestCase):
    """CalculateSmsCampaignPriceDataData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsCampaignPriceDataData:
        """Test CalculateSmsCampaignPriceDataData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsCampaignPriceDataData`
        """
        model = CalculateSmsCampaignPriceDataData()
        if include_optional:
    ...
    def testCalculateSmsCampaignPriceDataData(self):
        """Test CalculateSmsCampaignPriceDataData"""
