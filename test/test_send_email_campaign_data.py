...
class TestSendEmailCampaignData(unittest.TestCase):
    """SendEmailCampaignData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailCampaignData:
        """Test SendEmailCampaignData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailCampaignData`
        """
        model = SendEmailCampaignData()
        if include_optional:
    ...
    def testSendEmailCampaignData(self):
        """Test SendEmailCampaignData"""
