...
class TestRequestAlphaTagRequestBusinessesInnerPartnerRepresentative(unittest.TestCase):
    """RequestAlphaTagRequestBusinessesInnerPartnerRepresentative unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAlphaTagRequestBusinessesInnerPartnerRepresentative:
        """Test RequestAlphaTagRequestBusinessesInnerPartnerRepresentative
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAlphaTagRequestBusinessesInnerPartnerRepresentative`
        """
        model = RequestAlphaTagRequestBusinessesInnerPartnerRepresentative()
        if include_optional:
            return RequestAlphaTagRequestBusinessesInnerPartnerRepresentative(
                first_name = '',
                last_name = '',
                email = '',
                title = ''
    ...
    def testRequestAlphaTagRequestBusinessesInnerPartnerRepresentative(self):
        """Test RequestAlphaTagRequestBusinessesInnerPartnerRepresentative"""
