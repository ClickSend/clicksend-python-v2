...
class TestViewEmailHistory(unittest.TestCase):
    """ViewEmailHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailHistory:
        """Test ViewEmailHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailHistory`
        """
        model = ViewEmailHistory()
        if include_optional:
