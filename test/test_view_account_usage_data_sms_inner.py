...
class TestViewAccountUsageDataSmsInner(unittest.TestCase):
    """ViewAccountUsageDataSmsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAccountUsageDataSmsInner:
        """Test ViewAccountUsageDataSmsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAccountUsageDataSmsInner`
        """
        model = ViewAccountUsageDataSmsInner()
        if include_optional:
    ...
    def testViewAccountUsageDataSmsInner(self):
        """Test ViewAccountUsageDataSmsInner"""
