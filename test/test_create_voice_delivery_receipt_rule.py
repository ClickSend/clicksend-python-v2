...
class TestCreateVoiceDeliveryReceiptRule(unittest.TestCase):
    """CreateVoiceDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateVoiceDeliveryReceiptRule:
        """Test CreateVoiceDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateVoiceDeliveryReceiptRule`
        """
        model = CreateVoiceDeliveryReceiptRule()
        if include_optional:
            return CreateVoiceDeliveryReceiptRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your new voice receipt has been added.',
                data = clicksend.models.voice_delivery_receipt_rule.voice_delivery_receipt_rule(
                    receipt_rule_id = 2, 
                    rule_name = 'My Rule 2', 
                    match_type = 3, 
                    action = 'URL', 
    ...
    def testCreateVoiceDeliveryReceiptRule(self):
        """Test CreateVoiceDeliveryReceiptRule"""
