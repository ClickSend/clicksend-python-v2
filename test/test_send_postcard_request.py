...
class TestSendPostcardRequest(unittest.TestCase):
    """SendPostcardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPostcardRequest:
        """Test SendPostcardRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPostcardRequest`
        """
        model = SendPostcardRequest()
        if include_optional:
            return SendPostcardRequest(
                file_urls = [
                    ''
                    ],
                recipients = [
    ...
    def testSendPostcardRequest(self):
        """Test SendPostcardRequest"""
