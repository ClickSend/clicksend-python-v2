...
class TestCreateEmailDeliveryReceiptRule(unittest.TestCase):
    """CreateEmailDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEmailDeliveryReceiptRule:
        """Test CreateEmailDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEmailDeliveryReceiptRule`
        """
        model = CreateEmailDeliveryReceiptRule()
        if include_optional:
            return CreateEmailDeliveryReceiptRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Automation email receipt rule has been created.',
                data = clicksend.models.email_delivery_receipt_rule.email_delivery_receipt_rule(
                    receipt_rule_id = 1, 
    ...
    def testCreateEmailDeliveryReceiptRule(self):
        """Test CreateEmailDeliveryReceiptRule"""
