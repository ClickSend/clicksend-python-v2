...
class TestCreateDeliveryIssueRequest(unittest.TestCase):
    """CreateDeliveryIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDeliveryIssueRequest:
        """Test CreateDeliveryIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDeliveryIssueRequest`
        """
        model = CreateDeliveryIssueRequest()
        if include_optional:
            return CreateDeliveryIssueRequest(
                message_id = '',
                type = '',
                description = '',
                email_address = '',
    ...
    def testCreateDeliveryIssueRequest(self):
        """Test CreateDeliveryIssueRequest"""
