...
class TestGenerateNewApiKey(unittest.TestCase):
    """GenerateNewApiKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateNewApiKey:
        """Test GenerateNewApiKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateNewApiKey`
        """
        model = GenerateNewApiKey()
        if include_optional:
            return GenerateNewApiKey(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your API Key has been regenerated.',
                data = clicksend.models.generate_new_api_key_data.generate_new_api_key_data(
    ...
    def testGenerateNewApiKey(self):
        """Test GenerateNewApiKey"""
