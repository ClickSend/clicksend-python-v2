...
class TestFaxDeliveryReceiptRule(unittest.TestCase):
    """FaxDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FaxDeliveryReceiptRule:
        """Test FaxDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FaxDeliveryReceiptRule`
        """
        model = FaxDeliveryReceiptRule()
        if include_optional:
            return FaxDeliveryReceiptRule(
                receipt_rule_id = 1,
    ...
    def testFaxDeliveryReceiptRule(self):
        """Test FaxDeliveryReceiptRule"""
