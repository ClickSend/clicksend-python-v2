...
class TestViewFaxDeliveryReceiptRule(unittest.TestCase):
    """ViewFaxDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxDeliveryReceiptRule:
        """Test ViewFaxDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxDeliveryReceiptRule`
        """
        model = ViewFaxDeliveryReceiptRule()
        if include_optional:
    ...
    def testViewFaxDeliveryReceiptRule(self):
        """Test ViewFaxDeliveryReceiptRule"""
