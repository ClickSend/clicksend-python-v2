...
class TestSendEmailVerificationTokenRequest(unittest.TestCase):
    """SendEmailVerificationTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailVerificationTokenRequest:
        """Test SendEmailVerificationTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEmailVerificationTokenRequest`
        """
        model = SendEmailVerificationTokenRequest()
        if include_optional:
            return SendEmailVerificationTokenRequest(
                to = [
                    clicksend.models.send_email_verification_token_request_to_inner.send_email_verification_token_request_to_inner(
                        email = '', 
                        name = '', )
                    ],
                var_from = clicksend.models.send_email_verification_token_request_from.send_email_verification_token_request_from(
                    email_address_id = 56, 
                    name = '', ),
                subject = '',
                body = ''
    ...
    def testSendEmailVerificationTokenRequest(self):
        """Test SendEmailVerificationTokenRequest"""
