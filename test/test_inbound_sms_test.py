...
class TestInboundSmsTest(unittest.TestCase):
    """InboundSmsTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundSmsTest:
        """Test InboundSmsTest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundSmsTest`
        """
        model = InboundSmsTest()
        if include_optional:
            return InboundSmsTest(
