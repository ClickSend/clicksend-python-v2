...
class TestViewYourReturnAddressesData(unittest.TestCase):
    """ViewYourReturnAddressesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewYourReturnAddressesData:
        """Test ViewYourReturnAddressesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewYourReturnAddressesData`
        """
        model = ViewYourReturnAddressesData()
        if include_optional:
            return ViewYourReturnAddressesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.post_return_address.post_return_address(
                        return_address_id = 4, 
                        user_id = 1, 
    ...
    def testViewYourReturnAddressesData(self):
        """Test ViewYourReturnAddressesData"""
