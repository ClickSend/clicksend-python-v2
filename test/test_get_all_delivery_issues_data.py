...
class TestGetAllDeliveryIssuesData(unittest.TestCase):
    """GetAllDeliveryIssuesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllDeliveryIssuesData:
        """Test GetAllDeliveryIssuesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllDeliveryIssuesData`
        """
        model = GetAllDeliveryIssuesData()
        if include_optional:
            return GetAllDeliveryIssuesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testGetAllDeliveryIssuesData(self):
        """Test GetAllDeliveryIssuesData"""
