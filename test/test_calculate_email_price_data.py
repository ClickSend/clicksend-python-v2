...
class TestCalculateEmailPriceData(unittest.TestCase):
    """CalculateEmailPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailPriceData:
        """Test CalculateEmailPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailPriceData`
        """
        model = CalculateEmailPriceData()
        if include_optional:
            return CalculateEmailPriceData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testCalculateEmailPriceData(self):
        """Test CalculateEmailPriceData"""
