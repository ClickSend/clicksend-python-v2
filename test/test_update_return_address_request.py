...
class TestUpdateReturnAddressRequest(unittest.TestCase):
    """UpdateReturnAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateReturnAddressRequest:
        """Test UpdateReturnAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateReturnAddressRequest`
        """
        model = UpdateReturnAddressRequest()
        if include_optional:
            return UpdateReturnAddressRequest(
                address_country = '',
                address_state = ''
            )
        else:
    ...
    def testUpdateReturnAddressRequest(self):
        """Test UpdateReturnAddressRequest"""
