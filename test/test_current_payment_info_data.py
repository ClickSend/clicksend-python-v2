...
class TestCurrentPaymentInfoData(unittest.TestCase):
    """CurrentPaymentInfoData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrentPaymentInfoData:
        """Test CurrentPaymentInfoData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrentPaymentInfoData`
        """
        model = CurrentPaymentInfoData()
        if include_optional:
            return CurrentPaymentInfoData(
    ...
    def testCurrentPaymentInfoData(self):
        """Test CurrentPaymentInfoData"""
