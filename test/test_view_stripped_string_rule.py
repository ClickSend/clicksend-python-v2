...
class TestViewStrippedStringRule(unittest.TestCase):
    """ViewStrippedStringRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewStrippedStringRule:
        """Test ViewStrippedStringRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewStrippedStringRule`
        """
        model = ViewStrippedStringRule()
        if include_optional:
    ...
    def testViewStrippedStringRule(self):
        """Test ViewStrippedStringRule"""
