...
class TestCreateDefaultSenderRequestDefaultSenderStrategiesInner(unittest.TestCase):
    """CreateDefaultSenderRequestDefaultSenderStrategiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDefaultSenderRequestDefaultSenderStrategiesInner:
        """Test CreateDefaultSenderRequestDefaultSenderStrategiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDefaultSenderRequestDefaultSenderStrategiesInner`
        """
        model = CreateDefaultSenderRequestDefaultSenderStrategiesInner()
        if include_optional:
            return CreateDefaultSenderRequestDefaultSenderStrategiesInner(
    ...
    def testCreateDefaultSenderRequestDefaultSenderStrategiesInner(self):
        """Test CreateDefaultSenderRequestDefaultSenderStrategiesInner"""
