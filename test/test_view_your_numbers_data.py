...
class TestViewYourNumbersData(unittest.TestCase):
    """ViewYourNumbersData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewYourNumbersData:
        """Test ViewYourNumbersData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewYourNumbersData`
        """
        model = ViewYourNumbersData()
        if include_optional:
    ...
    def testViewYourNumbersData(self):
        """Test ViewYourNumbersData"""
