...
class TestUpdatePaymentInfoData(unittest.TestCase):
    """UpdatePaymentInfoData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePaymentInfoData:
        """Test UpdatePaymentInfoData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePaymentInfoData`
        """
        model = UpdatePaymentInfoData()
        if include_optional:
            return UpdatePaymentInfoData(
    ...
    def testUpdatePaymentInfoData(self):
        """Test UpdatePaymentInfoData"""
