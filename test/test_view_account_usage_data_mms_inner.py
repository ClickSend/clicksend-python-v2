...
class TestViewAccountUsageDataMmsInner(unittest.TestCase):
    """ViewAccountUsageDataMmsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAccountUsageDataMmsInner:
        """Test ViewAccountUsageDataMmsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAccountUsageDataMmsInner`
        """
        model = ViewAccountUsageDataMmsInner()
        if include_optional:
            return ViewAccountUsageDataMmsInner(
                subaccount_id = 56,
                username = '',
                total_count = '',
                total_price = '',
    ...
    def testViewAccountUsageDataMmsInner(self):
        """Test ViewAccountUsageDataMmsInner"""
