...
class TestExportVoiceHistory(unittest.TestCase):
    """ExportVoiceHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportVoiceHistory:
        """Test ExportVoiceHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportVoiceHistory`
        """
        model = ExportVoiceHistory()
        if include_optional:
    ...
    def testExportVoiceHistory(self):
        """Test ExportVoiceHistory"""
