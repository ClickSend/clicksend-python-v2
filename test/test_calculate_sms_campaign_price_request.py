...
class TestCalculateSmsCampaignPriceRequest(unittest.TestCase):
    """CalculateSmsCampaignPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsCampaignPriceRequest:
        """Test CalculateSmsCampaignPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsCampaignPriceRequest`
        """
        model = CalculateSmsCampaignPriceRequest()
        if include_optional:
            return CalculateSmsCampaignPriceRequest(
                list_id = '',
                name = '',
                var_from = '',
                body = ''
    ...
    def testCalculateSmsCampaignPriceRequest(self):
        """Test CalculateSmsCampaignPriceRequest"""
