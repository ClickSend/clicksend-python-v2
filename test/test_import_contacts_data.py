...
class TestImportContactsData(unittest.TestCase):
    """ImportContactsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportContactsData:
        """Test ImportContactsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportContactsData`
        """
        model = ImportContactsData()
        if include_optional:
    ...
    def testImportContactsData(self):
        """Test ImportContactsData"""
