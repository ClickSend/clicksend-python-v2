...
class TestSendPostcard(unittest.TestCase):
    """SendPostcard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPostcard:
        """Test SendPostcard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPostcard`
        """
        model = SendPostcard()
        if include_optional:
            return SendPostcard(
