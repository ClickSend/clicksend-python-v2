...
class TestUpdateFaxInboundRule(unittest.TestCase):
    """UpdateFaxInboundRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFaxInboundRule:
        """Test UpdateFaxInboundRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFaxInboundRule`
        """
        model = UpdateFaxInboundRule()
        if include_optional:
            return UpdateFaxInboundRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your inbound fax.',
                data = clicksend.models.inbound_fax_rule.inbound_fax_rule(
                    inbound_rule_id = 1, 
                    dedicated_number = '19', 
                    rule_name = 'Email', 
                    user_id = 1, 
    ...
    def testUpdateFaxInboundRule(self):
        """Test UpdateFaxInboundRule"""
