...
class TestSendMmsData(unittest.TestCase):
    """SendMmsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMmsData:
        """Test SendMmsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMmsData`
        """
        model = SendMmsData()
        if include_optional:
            return SendMmsData(
