...
class TestMarkSmsReceiptAsReadRequest(unittest.TestCase):
    """MarkSmsReceiptAsReadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkSmsReceiptAsReadRequest:
        """Test MarkSmsReceiptAsReadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkSmsReceiptAsReadRequest`
        """
        model = MarkSmsReceiptAsReadRequest()
        if include_optional:
            return MarkSmsReceiptAsReadRequest(
                date_before = 56
            )
        else:
            return MarkSmsReceiptAsReadRequest(
    ...
    def testMarkSmsReceiptAsReadRequest(self):
        """Test MarkSmsReceiptAsReadRequest"""
