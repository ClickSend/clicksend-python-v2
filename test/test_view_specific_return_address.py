...
class TestViewSpecificReturnAddress(unittest.TestCase):
    """ViewSpecificReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificReturnAddress:
        """Test ViewSpecificReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificReturnAddress`
        """
        model = ViewSpecificReturnAddress()
        if include_optional:
            return ViewSpecificReturnAddress(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here is your data.',
                data = clicksend.models.post_return_address.post_return_address(
                    return_address_id = 4, 
                    user_id = 1, 
    ...
    def testViewSpecificReturnAddress(self):
        """Test ViewSpecificReturnAddress"""
