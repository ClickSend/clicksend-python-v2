...
class TestCalculateEmailCampaignPriceData(unittest.TestCase):
    """CalculateEmailCampaignPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailCampaignPriceData:
        """Test CalculateEmailCampaignPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailCampaignPriceData`
        """
        model = CalculateEmailCampaignPriceData()
        if include_optional:
            return CalculateEmailCampaignPriceData(
                total_count = 1,
                total_price = '0.0066',
                queued_count = 2,
    ...
    def testCalculateEmailCampaignPriceData(self):
        """Test CalculateEmailCampaignPriceData"""
