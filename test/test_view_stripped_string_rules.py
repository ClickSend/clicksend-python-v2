...
class TestViewStrippedStringRules(unittest.TestCase):
    """ViewStrippedStringRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewStrippedStringRules:
        """Test ViewStrippedStringRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewStrippedStringRules`
        """
        model = ViewStrippedStringRules()
        if include_optional:
    ...
    def testViewStrippedStringRules(self):
        """Test ViewStrippedStringRules"""
