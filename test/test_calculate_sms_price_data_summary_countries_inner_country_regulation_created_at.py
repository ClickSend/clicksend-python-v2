...
class TestCalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt(unittest.TestCase):
    """CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt:
        """Test CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt`
        """
        model = CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt()
        if include_optional:
            return CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt(
    ...
    def testCalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt(self):
        """Test CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt"""
