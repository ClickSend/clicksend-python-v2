...
class TestViewSpecificSmsReceipt(unittest.TestCase):
    """ViewSpecificSmsReceipt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificSmsReceipt:
        """Test ViewSpecificSmsReceipt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificSmsReceipt`
        """
        model = ViewSpecificSmsReceipt()
        if include_optional:
            return ViewSpecificSmsReceipt(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your receipt.',
                data = clicksend.models.sms_receipt.sms_receipt(
    ...
    def testViewSpecificSmsReceipt(self):
        """Test ViewSpecificSmsReceipt"""
