...
class TestCreateStrippedStringRuleRequest(unittest.TestCase):
    """CreateStrippedStringRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStrippedStringRuleRequest:
        """Test CreateStrippedStringRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStrippedStringRuleRequest`
        """
        model = CreateStrippedStringRuleRequest()
        if include_optional:
            return CreateStrippedStringRuleRequest(
                strip_string = ''
            )
        else:
            return CreateStrippedStringRuleRequest(
    ...
    def testCreateStrippedStringRuleRequest(self):
        """Test CreateStrippedStringRuleRequest"""
