...
class TestViewEmailDeliveryReceiptRule(unittest.TestCase):
    """ViewEmailDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailDeliveryReceiptRule:
        """Test ViewEmailDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailDeliveryReceiptRule`
        """
        model = ViewEmailDeliveryReceiptRule()
        if include_optional:
    ...
    def testViewEmailDeliveryReceiptRule(self):
        """Test ViewEmailDeliveryReceiptRule"""
