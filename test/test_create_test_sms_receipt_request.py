...
class TestCreateTestSmsReceiptRequest(unittest.TestCase):
    """CreateTestSmsReceiptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTestSmsReceiptRequest:
        """Test CreateTestSmsReceiptRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestSmsReceiptRequest`
        """
        model = CreateTestSmsReceiptRequest()
        if include_optional:
            return CreateTestSmsReceiptRequest(
                url = ''
            )
        else:
            return CreateTestSmsReceiptRequest(
    ...
    def testCreateTestSmsReceiptRequest(self):
        """Test CreateTestSmsReceiptRequest"""
