...
class TestGetAllDeliveryIssues(unittest.TestCase):
    """GetAllDeliveryIssues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllDeliveryIssues:
        """Test GetAllDeliveryIssues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllDeliveryIssues`
        """
        model = GetAllDeliveryIssues()
        if include_optional:
    ...
    def testGetAllDeliveryIssues(self):
        """Test GetAllDeliveryIssues"""
