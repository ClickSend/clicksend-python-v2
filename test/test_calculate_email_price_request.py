...
class TestCalculateEmailPriceRequest(unittest.TestCase):
    """CalculateEmailPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEmailPriceRequest:
        """Test CalculateEmailPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEmailPriceRequest`
        """
        model = CalculateEmailPriceRequest()
        if include_optional:
            return CalculateEmailPriceRequest(
                to = [
                    clicksend.models.send_email_request_to_inner.send_email_request_to_inner(
                        email = '', 
                        name = '', )
                    ],
                var_from = clicksend.models.send_email_request_from.send_email_request_from(
                    email_address_id = '', 
                    name = '', ),
                subject = '',
                body = ''
    ...
    def testCalculateEmailPriceRequest(self):
        """Test CalculateEmailPriceRequest"""
