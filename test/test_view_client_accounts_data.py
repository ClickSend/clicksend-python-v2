...
class TestViewClientAccountsData(unittest.TestCase):
    """ViewClientAccountsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewClientAccountsData:
        """Test ViewClientAccountsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewClientAccountsData`
        """
        model = ViewClientAccountsData()
        if include_optional:
            return ViewClientAccountsData(
                ...
                to = 2,
                data = [
                    clicksend.models.reseller_account.reseller_account(
                        user_id = 117, 
                        username = 'johndoe2', 
    ...
    def testViewClientAccountsData(self):
        """Test ViewClientAccountsData"""
