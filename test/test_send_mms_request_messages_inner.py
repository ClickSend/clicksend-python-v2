...
class TestSendMmsRequestMessagesInner(unittest.TestCase):
    """SendMmsRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMmsRequestMessagesInner:
        """Test SendMmsRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMmsRequestMessagesInner`
        """
    ...
    def testSendMmsRequestMessagesInner(self):
        """Test SendMmsRequestMessagesInner"""
