...
class TestViewSmsDeliveryReceiptRule(unittest.TestCase):
    """ViewSmsDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsDeliveryReceiptRule:
        """Test ViewSmsDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsDeliveryReceiptRule`
        """
        model = ViewSmsDeliveryReceiptRule()
        if include_optional:
    ...
    def testViewSmsDeliveryReceiptRule(self):
        """Test ViewSmsDeliveryReceiptRule"""
