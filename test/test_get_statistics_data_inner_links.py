...
class TestGetStatisticsDataInnerLinks(unittest.TestCase):
    """GetStatisticsDataInnerLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatisticsDataInnerLinks:
        """Test GetStatisticsDataInnerLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatisticsDataInnerLinks`
        """
        model = GetStatisticsDataInnerLinks()
        if include_optional:
            return GetStatisticsDataInnerLinks(
                total = 2,
                opened_unique = 2,
                opened_total = 5,
                unopened = 0
    ...
    def testGetStatisticsDataInnerLinks(self):
        """Test GetStatisticsDataInnerLinks"""
