...
class TestCreateDefaultSenderRequest(unittest.TestCase):
    """CreateDefaultSenderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDefaultSenderRequest:
        """Test CreateDefaultSenderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDefaultSenderRequest`
        """
        model = CreateDefaultSenderRequest()
        if include_optional:
            return CreateDefaultSenderRequest(
                country_code = 'AU',
                product_type = 'SMS',
                default_sender_strategies = [
                    clicksend.models.create_default_sender_request_default_sender_strategies_inner.create_default_sender_request_default_sender_strategies_inner(
    ...
    def testCreateDefaultSenderRequest(self):
        """Test CreateDefaultSenderRequest"""
