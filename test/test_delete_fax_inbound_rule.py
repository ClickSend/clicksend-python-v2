...
class TestDeleteFaxInboundRule(unittest.TestCase):
    """DeleteFaxInboundRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteFaxInboundRule:
        """Test DeleteFaxInboundRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteFaxInboundRule`
        """
        model = DeleteFaxInboundRule()
        if include_optional:
    ...
    def testDeleteFaxInboundRule(self):
        """Test DeleteFaxInboundRule"""
