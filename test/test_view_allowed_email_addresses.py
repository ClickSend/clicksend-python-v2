...
class TestViewAllowedEmailAddresses(unittest.TestCase):
    """ViewAllowedEmailAddresses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllowedEmailAddresses:
        """Test ViewAllowedEmailAddresses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllowedEmailAddresses`
        """
        model = ViewAllowedEmailAddresses()
        if include_optional:
    ...
    def testViewAllowedEmailAddresses(self):
        """Test ViewAllowedEmailAddresses"""
