...
class TestViewStrippedStringRulesData(unittest.TestCase):
    """ViewStrippedStringRulesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewStrippedStringRulesData:
        """Test ViewStrippedStringRulesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewStrippedStringRulesData`
        """
        model = ViewStrippedStringRulesData()
        if include_optional:
            return ViewStrippedStringRulesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
    ...
    def testViewStrippedStringRulesData(self):
        """Test ViewStrippedStringRulesData"""
