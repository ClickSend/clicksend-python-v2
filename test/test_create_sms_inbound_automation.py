...
class TestCreateSmsInboundAutomation(unittest.TestCase):
    """CreateSmsInboundAutomation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmsInboundAutomation:
        """Test CreateSmsInboundAutomation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmsInboundAutomation`
        """
        model = CreateSmsInboundAutomation()
        if include_optional:
    ...
    def testCreateSmsInboundAutomation(self):
        """Test CreateSmsInboundAutomation"""
