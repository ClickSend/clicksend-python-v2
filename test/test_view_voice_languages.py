...
class TestViewVoiceLanguages(unittest.TestCase):
    """ViewVoiceLanguages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceLanguages:
        """Test ViewVoiceLanguages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceLanguages`
        """
        model = ViewVoiceLanguages()
        if include_optional:
    ...
    def testViewVoiceLanguages(self):
        """Test ViewVoiceLanguages"""
