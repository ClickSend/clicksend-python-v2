...
class TestCancelEmailCampaign(unittest.TestCase):
    """CancelEmailCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelEmailCampaign:
        """Test CancelEmailCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelEmailCampaign`
        """
        model = CancelEmailCampaign()
        if include_optional:
    ...
    def testCancelEmailCampaign(self):
        """Test CancelEmailCampaign"""
