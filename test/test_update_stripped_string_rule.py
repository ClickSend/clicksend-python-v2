...
class TestUpdateStrippedStringRule(unittest.TestCase):
    """UpdateStrippedStringRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateStrippedStringRule:
        """Test UpdateStrippedStringRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateStrippedStringRule`
        """
        model = UpdateStrippedStringRule()
        if include_optional:
            return UpdateStrippedStringRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Strip string has been updated.',
                data = clicksend.models.view_stripped_string_rule_data.view_stripped_string_rule_data(
                    rule_id = 18, 
    ...
    def testUpdateStrippedStringRule(self):
        """Test UpdateStrippedStringRule"""
