...
class TestExportPostcardHistory(unittest.TestCase):
    """ExportPostcardHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPostcardHistory:
        """Test ExportPostcardHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPostcardHistory`
        """
        model = ExportPostcardHistory()
        if include_optional:
            return ExportPostcardHistory(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Download your file here.',
                data = clicksend.models.export_sms_history_data.export_sms_history_data(
    ...
    def testExportPostcardHistory(self):
        """Test ExportPostcardHistory"""
