...
class TestCreateResellerAccountData(unittest.TestCase):
    """CreateResellerAccountData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateResellerAccountData:
        """Test CreateResellerAccountData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateResellerAccountData`
        """
        model = CreateResellerAccountData()
        if include_optional:
            return CreateResellerAccountData(
                user_id = 117,
                username = 'johndoe2',
    ...
    def testCreateResellerAccountData(self):
        """Test CreateResellerAccountData"""
