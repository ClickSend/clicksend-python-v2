...
class TestCurrentPaymentInfo(unittest.TestCase):
    """CurrentPaymentInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrentPaymentInfo:
        """Test CurrentPaymentInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrentPaymentInfo`
        """
        model = CurrentPaymentInfo()
        if include_optional:
            return CurrentPaymentInfo(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Customer payment info.',
                data = clicksend.models.current_payment_info_data.current_payment_info_data(
    ...
    def testCurrentPaymentInfo(self):
        """Test CurrentPaymentInfo"""
