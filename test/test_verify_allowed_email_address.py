...
class TestVerifyAllowedEmailAddress(unittest.TestCase):
    """VerifyAllowedEmailAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAllowedEmailAddress:
        """Test VerifyAllowedEmailAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAllowedEmailAddress`
        """
        model = VerifyAllowedEmailAddress()
        if include_optional:
            return VerifyAllowedEmailAddress(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Email address verified.',
                data = clicksend.models.email_address.email_address(
                    email_address_id = 2, 
    ...
    def testVerifyAllowedEmailAddress(self):
        """Test VerifyAllowedEmailAddress"""
