...
class TestSmsReceipt(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SmsReceipt:
        """Test SmsReceipt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmsReceipt`
        """
        model = SmsReceipt()
        if include_optional:
            return SmsReceipt(
