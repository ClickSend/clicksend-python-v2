...
class TestPostcardRecipient(unittest.TestCase):
    """PostcardRecipient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostcardRecipient:
        """Test PostcardRecipient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostcardRecipient`
        """
        model = PostcardRecipient()
        if include_optional:
            return PostcardRecipient(
                user_id = 1,
                subaccount_id = 13,
                ...
                file_url = 'https://rest.clicksend.com/files/6A559A74-486D-4012-84D7-F3FE11904CB1.pdf',
    ...
    def testPostcardRecipient(self):
        """Test PostcardRecipient"""
