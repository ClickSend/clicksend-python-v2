...
class TestSendMmsCampaign(unittest.TestCase):
    """SendMmsCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMmsCampaign:
        """Test SendMmsCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMmsCampaign`
        """
        model = SendMmsCampaign()
        if include_optional:
