...
class TestBuyNumberRequestRegistrationData(unittest.TestCase):
    """BuyNumberRequestRegistrationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuyNumberRequestRegistrationData:
        """Test BuyNumberRequestRegistrationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuyNumberRequestRegistrationData`
        """
        model = BuyNumberRequestRegistrationData()
        if include_optional:
            return BuyNumberRequestRegistrationData(
                business_name = 'ABD',
    ...
    def testBuyNumberRequestRegistrationData(self):
        """Test BuyNumberRequestRegistrationData"""
