...
class TestUpdateDefaultSenderRequest(unittest.TestCase):
    """UpdateDefaultSenderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDefaultSenderRequest:
        """Test UpdateDefaultSenderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDefaultSenderRequest`
        """
        model = UpdateDefaultSenderRequest()
        if include_optional:
            return UpdateDefaultSenderRequest(
    ...
    def testUpdateDefaultSenderRequest(self):
        """Test UpdateDefaultSenderRequest"""
