...
class TestUpdateDefaultSender(unittest.TestCase):
    """UpdateDefaultSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDefaultSender:
        """Test UpdateDefaultSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDefaultSender`
        """
        model = UpdateDefaultSender()
        if include_optional:
    ...
    def testUpdateDefaultSender(self):
        """Test UpdateDefaultSender"""
