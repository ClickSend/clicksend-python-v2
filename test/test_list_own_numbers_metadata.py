...
class TestListOwnNumbersMetadata(unittest.TestCase):
    """ListOwnNumbersMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOwnNumbersMetadata:
        """Test ListOwnNumbersMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOwnNumbersMetadata`
        """
        model = ListOwnNumbersMetadata()
        if include_optional:
            return ListOwnNumbersMetadata(
    ...
    def testListOwnNumbersMetadata(self):
        """Test ListOwnNumbersMetadata"""
