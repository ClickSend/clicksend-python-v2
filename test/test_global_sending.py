...
class TestGlobalSending(unittest.TestCase):
    """GlobalSending unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalSending:
        """Test GlobalSending
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalSending`
        """
        model = GlobalSending()
        if include_optional:
