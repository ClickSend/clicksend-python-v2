...
class TestUpdateEmailDeliveryReceiptRule(unittest.TestCase):
    """UpdateEmailDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEmailDeliveryReceiptRule:
        """Test UpdateEmailDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateEmailDeliveryReceiptRule`
        """
        model = UpdateEmailDeliveryReceiptRule()
        if include_optional:
    ...
    def testUpdateEmailDeliveryReceiptRule(self):
        """Test UpdateEmailDeliveryReceiptRule"""
