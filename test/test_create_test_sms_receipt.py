...
class TestCreateTestSmsReceipt(unittest.TestCase):
    """CreateTestSmsReceipt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTestSmsReceipt:
        """Test CreateTestSmsReceipt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestSmsReceipt`
        """
        model = CreateTestSmsReceipt()
        if include_optional:
            return CreateTestSmsReceipt(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Receipt has been added',
                data = clicksend.models.create_test_sms_receipt_data.create_test_sms_receipt_data(
    ...
    def testCreateTestSmsReceipt(self):
        """Test CreateTestSmsReceipt"""
