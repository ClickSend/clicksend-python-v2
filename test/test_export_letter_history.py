...
class TestExportLetterHistory(unittest.TestCase):
    """ExportLetterHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportLetterHistory:
        """Test ExportLetterHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportLetterHistory`
        """
        model = ExportLetterHistory()
        if include_optional:
    ...
    def testExportLetterHistory(self):
        """Test ExportLetterHistory"""
