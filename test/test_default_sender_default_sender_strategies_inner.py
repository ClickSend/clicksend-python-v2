...
class TestDefaultSenderDefaultSenderStrategiesInner(unittest.TestCase):
    """DefaultSenderDefaultSenderStrategiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultSenderDefaultSenderStrategiesInner:
        """Test DefaultSenderDefaultSenderStrategiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultSenderDefaultSenderStrategiesInner`
        """
        model = DefaultSenderDefaultSenderStrategiesInner()
        if include_optional:
            return DefaultSenderDefaultSenderStrategiesInner(
    ...
    def testDefaultSenderDefaultSenderStrategiesInner(self):
        """Test DefaultSenderDefaultSenderStrategiesInner"""
