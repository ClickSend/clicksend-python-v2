...
class TestAgreeToRulesAndRegulation(unittest.TestCase):
    """AgreeToRulesAndRegulation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgreeToRulesAndRegulation:
        """Test AgreeToRulesAndRegulation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgreeToRulesAndRegulation`
        """
        model = AgreeToRulesAndRegulation()
        if include_optional:
    ...
    def testAgreeToRulesAndRegulation(self):
        """Test AgreeToRulesAndRegulation"""
