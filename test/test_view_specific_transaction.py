...
class TestViewSpecificTransaction(unittest.TestCase):
    """ViewSpecificTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificTransaction:
        """Test ViewSpecificTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificTransaction`
        """
        model = ViewSpecificTransaction()
        if include_optional:
            return ViewSpecificTransaction(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here is your transaction.',
                data = clicksend.models.view_all_transactions_data_all_of_data_inner.view_all_transactions_data_allOf_data_inner(
    ...
    def testViewSpecificTransaction(self):
        """Test ViewSpecificTransaction"""
