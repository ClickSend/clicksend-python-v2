...
class TestViewFaxHistory(unittest.TestCase):
    """ViewFaxHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewFaxHistory:
        """Test ViewFaxHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewFaxHistory`
        """
        model = ViewFaxHistory()
        if include_optional:
