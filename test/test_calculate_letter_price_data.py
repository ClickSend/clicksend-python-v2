...
class TestCalculateLetterPriceData(unittest.TestCase):
    """CalculateLetterPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateLetterPriceData:
        """Test CalculateLetterPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateLetterPriceData`
        """
        model = CalculateLetterPriceData()
        if include_optional:
            return CalculateLetterPriceData(
                total_price = 1.87,
                total_cost = 1,
    ...
    def testCalculateLetterPriceData(self):
        """Test CalculateLetterPriceData"""
