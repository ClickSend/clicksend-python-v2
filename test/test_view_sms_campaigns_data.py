...
class TestViewSmsCampaignsData(unittest.TestCase):
    """ViewSmsCampaignsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSmsCampaignsData:
        """Test ViewSmsCampaignsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSmsCampaignsData`
        """
        model = ViewSmsCampaignsData()
        if include_optional:
            return ViewSmsCampaignsData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.sms_campaign.sms_campaign(
                        sms_campaign_id = 7, 
                        name = 'My Campaign 1', 
                        user_id = 1, 
                        subaccount_id = 1, 
    ...
    def testViewSmsCampaignsData(self):
        """Test ViewSmsCampaignsData"""
