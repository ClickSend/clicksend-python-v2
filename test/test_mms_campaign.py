...
class TestMmsCampaign(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MmsCampaign:
        """Test MmsCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MmsCampaign`
        """
        model = MmsCampaign()
        if include_optional:
            return MmsCampaign(
                ...
                total_count = 1,
                list_name = 'test',
                media_file_url = 'http://rest.clicksend.clicksend/files/8EA5FA8C-3216-4A5D-86EA-6BE78050E439.jpg'
            )
        else:
            return MmsCampaign(
        )
