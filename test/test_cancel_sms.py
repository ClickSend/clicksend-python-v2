...
class TestCancelSms(unittest.TestCase):
    """CancelSms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelSms:
        """Test CancelSms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelSms`
        """
        model = CancelSms()
        if include_optional:
            return CancelSms(
