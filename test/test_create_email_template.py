...
class TestCreateEmailTemplate(unittest.TestCase):
    """CreateEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEmailTemplate:
        """Test CreateEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEmailTemplate`
        """
    ...
    def testCreateEmailTemplate(self):
        """Test CreateEmailTemplate"""
