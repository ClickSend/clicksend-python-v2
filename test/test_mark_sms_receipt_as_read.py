...
class TestMarkSmsReceiptAsRead(unittest.TestCase):
    """MarkSmsReceiptAsRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkSmsReceiptAsRead:
        """Test MarkSmsReceiptAsRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkSmsReceiptAsRead`
        """
        model = MarkSmsReceiptAsRead()
        if include_optional:
    ...
    def testMarkSmsReceiptAsRead(self):
        """Test MarkSmsReceiptAsRead"""
