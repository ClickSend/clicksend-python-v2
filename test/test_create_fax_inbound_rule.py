...
class TestCreateFaxInboundRule(unittest.TestCase):
    """CreateFaxInboundRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFaxInboundRule:
        """Test CreateFaxInboundRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFaxInboundRule`
        """
        model = CreateFaxInboundRule()
        if include_optional:
    ...
    def testCreateFaxInboundRule(self):
        """Test CreateFaxInboundRule"""
