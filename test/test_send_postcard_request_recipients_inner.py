...
class TestSendPostcardRequestRecipientsInner(unittest.TestCase):
    """SendPostcardRequestRecipientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPostcardRequestRecipientsInner:
        """Test SendPostcardRequestRecipientsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPostcardRequestRecipientsInner`
        """
        model = SendPostcardRequestRecipientsInner()
        if include_optional:
            return SendPostcardRequestRecipientsInner(
                address_name = '',
                address_city = '',
                address_state = '',
                address_postal_code = '',
    ...
    def testSendPostcardRequestRecipientsInner(self):
        """Test SendPostcardRequestRecipientsInner"""
