...
class TestCreateAllowedEmailAddressRequest(unittest.TestCase):
    """CreateAllowedEmailAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAllowedEmailAddressRequest:
        """Test CreateAllowedEmailAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAllowedEmailAddressRequest`
        """
        model = CreateAllowedEmailAddressRequest()
        if include_optional:
            return CreateAllowedEmailAddressRequest(
                email_address = ''
            )
        else:
            return CreateAllowedEmailAddressRequest(
    ...
    def testCreateAllowedEmailAddressRequest(self):
        """Test CreateAllowedEmailAddressRequest"""
