...
class TestViewASpecificSmsTemplate(unittest.TestCase):
    """ViewASpecificSmsTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewASpecificSmsTemplate:
        """Test ViewASpecificSmsTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewASpecificSmsTemplate`
        """
...
new line 漢字 here.', )
    ...
    def testViewASpecificSmsTemplate(self):
        """Test ViewASpecificSmsTemplate"""
