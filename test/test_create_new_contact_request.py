...
class TestCreateNewContactRequest(unittest.TestCase):
    """CreateNewContactRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNewContactRequest:
        """Test CreateNewContactRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNewContactRequest`
        """
        model = CreateNewContactRequest()
        if include_optional:
            return CreateNewContactRequest(
                phone_number = '',
                first_name = '',
                last_name = '',
                custom_1 = '',
    ...
    def testCreateNewContactRequest(self):
        """Test CreateNewContactRequest"""
