...
class TestCreateTestInboundSmsRequest(unittest.TestCase):
    """CreateTestInboundSmsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTestInboundSmsRequest:
        """Test CreateTestInboundSmsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestInboundSmsRequest`
        """
        model = CreateTestInboundSmsRequest()
        if include_optional:
            return CreateTestInboundSmsRequest(
                url = '',
                webhook_type = ''
            )
        else:
    ...
    def testCreateTestInboundSmsRequest(self):
        """Test CreateTestInboundSmsRequest"""
