...
class TestViewAllTransactionsDataAllOfDataInner(unittest.TestCase):
    """ViewAllTransactionsDataAllOfDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewAllTransactionsDataAllOfDataInner:
        """Test ViewAllTransactionsDataAllOfDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewAllTransactionsDataAllOfDataInner`
        """
        model = ViewAllTransactionsDataAllOfDataInner()
        if include_optional:
            return ViewAllTransactionsDataAllOfDataInner(
    ...
    def testViewAllTransactionsDataAllOfDataInner(self):
        """Test ViewAllTransactionsDataAllOfDataInner"""
