...
class TestGetDefaultSendersListData(unittest.TestCase):
    """GetDefaultSendersListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDefaultSendersListData:
        """Test GetDefaultSendersListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDefaultSendersListData`
        """
        model = GetDefaultSendersListData()
        if include_optional:
            return GetDefaultSendersListData(
                data = [
    ...
    def testGetDefaultSendersListData(self):
        """Test GetDefaultSendersListData"""
