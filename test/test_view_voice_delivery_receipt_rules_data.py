...
class TestViewVoiceDeliveryReceiptRulesData(unittest.TestCase):
    """ViewVoiceDeliveryReceiptRulesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewVoiceDeliveryReceiptRulesData:
        """Test ViewVoiceDeliveryReceiptRulesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewVoiceDeliveryReceiptRulesData`
        """
        model = ViewVoiceDeliveryReceiptRulesData()
        if include_optional:
            return ViewVoiceDeliveryReceiptRulesData(
                total = 2,
                per_page = 15,
                current_page = 1,
                last_page = 1,
                ...
                to = 2,
                data = [
                    clicksend.models.voice_delivery_receipt_rule.voice_delivery_receipt_rule(
                        receipt_rule_id = 2, 
                        rule_name = 'My Rule 2', 
                        match_type = 3, 
                        action = 'URL', 
    ...
    def testViewVoiceDeliveryReceiptRulesData(self):
        """Test ViewVoiceDeliveryReceiptRulesData"""
