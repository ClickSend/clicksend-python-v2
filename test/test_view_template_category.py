...
class TestViewTemplateCategory(unittest.TestCase):
    """ViewTemplateCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewTemplateCategory:
        """Test ViewTemplateCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewTemplateCategory`
        """
        model = ViewTemplateCategory()
        if include_optional:
            return ViewTemplateCategory(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Here are your data.',
                data = clicksend.models.view_template_category_data.view_template_category_data(
                    category_id = 4, 
                    name = 'Birthday', )
            )
        else:
    ...
    def testViewTemplateCategory(self):
        """Test ViewTemplateCategory"""
