...
class TestCancelAllSms(unittest.TestCase):
    """CancelAllSms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelAllSms:
        """Test CancelAllSms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelAllSms`
        """
        model = CancelAllSms()
        if include_optional:
            return CancelAllSms(
