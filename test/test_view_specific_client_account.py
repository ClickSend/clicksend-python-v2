...
class TestViewSpecificClientAccount(unittest.TestCase):
    """ViewSpecificClientAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewSpecificClientAccount:
        """Test ViewSpecificClientAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewSpecificClientAccount`
        """
        model = ViewSpecificClientAccount()
        if include_optional:
    ...
    def testViewSpecificClientAccount(self):
        """Test ViewSpecificClientAccount"""
