...
class TestSendFaxRequestMessagesInner(unittest.TestCase):
    """SendFaxRequestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFaxRequestMessagesInner:
        """Test SendFaxRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFaxRequestMessagesInner`
        """
        model = SendFaxRequestMessagesInner()
        if include_optional:
            return SendFaxRequestMessagesInner(
                source = '',
                var_from = '',
                to = '',
                custom_string = ''
    ...
    def testSendFaxRequestMessagesInner(self):
        """Test SendFaxRequestMessagesInner"""
