...
class TestSendLetter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLetter:
        """Test SendLetter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLetter`
        """
        model = SendLetter()
        if include_optional:
            return SendLetter(
                ...
                data = clicksend.models.send_letter_data.send_letter_data(
                    recipients = [
