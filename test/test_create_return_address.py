...
class TestCreateReturnAddress(unittest.TestCase):
    """CreateReturnAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateReturnAddress:
        """Test CreateReturnAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateReturnAddress`
        """
        model = CreateReturnAddress()
        if include_optional:
    ...
    def testCreateReturnAddress(self):
        """Test CreateReturnAddress"""
