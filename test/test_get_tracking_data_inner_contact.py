...
class TestGetTrackingDataInnerContact(unittest.TestCase):
    """GetTrackingDataInnerContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTrackingDataInnerContact:
        """Test GetTrackingDataInnerContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTrackingDataInnerContact`
        """
        model = GetTrackingDataInnerContact()
        if include_optional:
            return GetTrackingDataInnerContact(
                contact_id = '224466',
                first_name = 'John',
                last_name = 'Doe',
    ...
    def testGetTrackingDataInnerContact(self):
        """Test GetTrackingDataInnerContact"""
