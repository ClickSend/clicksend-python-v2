...
class TestUpdateFaxDeliveryReceiptRule(unittest.TestCase):
    """UpdateFaxDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFaxDeliveryReceiptRule:
        """Test UpdateFaxDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFaxDeliveryReceiptRule`
        """
        model = UpdateFaxDeliveryReceiptRule()
        if include_optional:
            return UpdateFaxDeliveryReceiptRule(
                http_code = 200,
                response_code = 'SUCCESS',
                response_msg = 'Your rule incoming fax receipt has been updated.',
                data = clicksend.models.fax_delivery_receipt_rule.fax_delivery_receipt_rule(
                    receipt_rule_id = 1, 
    ...
    def testUpdateFaxDeliveryReceiptRule(self):
        """Test UpdateFaxDeliveryReceiptRule"""
