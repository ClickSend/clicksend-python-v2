...
class TestGetStatisticsDataInnerDeviceInner(unittest.TestCase):
    """GetStatisticsDataInnerDeviceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatisticsDataInnerDeviceInner:
        """Test GetStatisticsDataInnerDeviceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatisticsDataInnerDeviceInner`
        """
        model = GetStatisticsDataInnerDeviceInner()
        if include_optional:
            return GetStatisticsDataInnerDeviceInner(
                label = 'mobile',
                count = 2
            )
        else:
    ...
    def testGetStatisticsDataInnerDeviceInner(self):
        """Test GetStatisticsDataInnerDeviceInner"""
