...
class TestMasterEmailTemplateThumbnail(unittest.TestCase):
    """MasterEmailTemplateThumbnail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MasterEmailTemplateThumbnail:
        """Test MasterEmailTemplateThumbnail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MasterEmailTemplateThumbnail`
        """
        model = MasterEmailTemplateThumbnail()
        if include_optional:
            return MasterEmailTemplateThumbnail(
    ...
    def testMasterEmailTemplateThumbnail(self):
        """Test MasterEmailTemplateThumbnail"""
