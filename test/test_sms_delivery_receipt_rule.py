...
class TestSmsDeliveryReceiptRule(unittest.TestCase):
    """SmsDeliveryReceiptRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmsDeliveryReceiptRule:
        """Test SmsDeliveryReceiptRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmsDeliveryReceiptRule`
        """
        model = SmsDeliveryReceiptRule()
        if include_optional:
            return SmsDeliveryReceiptRule(
                receipt_rule_id = 5,
                rule_name = 'My Rule',
                match_type = 0,
                action = 'EMAIL_FIXED',
    ...
    def testSmsDeliveryReceiptRule(self):
        """Test SmsDeliveryReceiptRule"""
