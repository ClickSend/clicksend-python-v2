...
class TestViewEmailTemplate(unittest.TestCase):
    """ViewEmailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewEmailTemplate:
        """Test ViewEmailTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewEmailTemplate`
        """
        model = ViewEmailTemplate()
        if include_optional:
    ...
    def testViewEmailTemplate(self):
        """Test ViewEmailTemplate"""
