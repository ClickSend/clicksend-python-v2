...
class TestDefaultSenderErrorDetailsInner(unittest.TestCase):
    """DefaultSenderErrorDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultSenderErrorDetailsInner:
        """Test DefaultSenderErrorDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultSenderErrorDetailsInner`
        """
        model = DefaultSenderErrorDetailsInner()
        if include_optional:
            return DefaultSenderErrorDetailsInner(
                var_field = 'default_sender_strategies[0].sender_id',
    ...
    def testDefaultSenderErrorDetailsInner(self):
        """Test DefaultSenderErrorDetailsInner"""
