...
class TestGenerateNewApiKeyRequest(unittest.TestCase):
    """GenerateNewApiKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateNewApiKeyRequest:
        """Test GenerateNewApiKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateNewApiKeyRequest`
        """
        model = GenerateNewApiKeyRequest()
        if include_optional:
            return GenerateNewApiKeyRequest(
                access_sms = 56,
                email = '',
                notes = ''
            )
    ...
    def testGenerateNewApiKeyRequest(self):
        """Test GenerateNewApiKeyRequest"""
