...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.MmsApi(api_client)
    ...
    try:
        ...
        print("The response of MmsApi->calculate_mms_price:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MmsApi->calculate_mms_price: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MmsApi->export_mms_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MmsApi->export_mms_history: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MmsApi->send_mms:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MmsApi->send_mms: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MmsApi->view_mms_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MmsApi->view_mms_history: %s\n" % e)
```
