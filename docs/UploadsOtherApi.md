# clicksend.UploadsOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**upload_a_media_file**](UploadsOtherApi.md#upload_a_media_file) | **POST** /v3/uploads | Upload Media File
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.UploadsOtherApi(api_client)
    ...
    try:
        ...
        print("Exception when calling UploadsOtherApi->upload_a_media_file: %s\n" % e)
```
