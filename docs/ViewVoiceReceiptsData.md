...
json = "{}"
# create an instance of ViewVoiceReceiptsData from a JSON string
view_voice_receipts_data_instance = ViewVoiceReceiptsData.from_json(json)
# print the JSON string representation of the object
print(ViewVoiceReceiptsData.to_json())

# convert the object into a dict
view_voice_receipts_data_dict = view_voice_receipts_data_instance.to_dict()
# create an instance of ViewVoiceReceiptsData from a dict
view_voice_receipts_data_from_dict = ViewVoiceReceiptsData.from_dict(view_voice_receipts_data_dict)
```
