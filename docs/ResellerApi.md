...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.ResellerApi(api_client)
    ...
    try:
        ...
        print("The response of ResellerApi->create_reseller_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResellerApi->create_reseller_account: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ResellerApi->reseller_transfer_credit:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResellerApi->reseller_transfer_credit: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ResellerApi->update_client_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResellerApi->update_client_account: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ResellerApi->view_client_accounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResellerApi->view_client_accounts: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ResellerApi->view_specific_client_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResellerApi->view_specific_client_account: %s\n" % e)
```
