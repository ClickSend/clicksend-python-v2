...
json = "{}"
# create an instance of ViewAllEmailCampaignsData from a JSON string
view_all_email_campaigns_data_instance = ViewAllEmailCampaignsData.from_json(json)
# print the JSON string representation of the object
print(ViewAllEmailCampaignsData.to_json())

# convert the object into a dict
view_all_email_campaigns_data_dict = view_all_email_campaigns_data_instance.to_dict()
# create an instance of ViewAllEmailCampaignsData from a dict
view_all_email_campaigns_data_from_dict = ViewAllEmailCampaignsData.from_dict(view_all_email_campaigns_data_dict)
```
