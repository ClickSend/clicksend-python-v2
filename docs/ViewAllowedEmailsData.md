...
json = "{}"
# create an instance of ViewAllowedEmailsData from a JSON string
view_allowed_emails_data_instance = ViewAllowedEmailsData.from_json(json)
# print the JSON string representation of the object
print(ViewAllowedEmailsData.to_json())

# convert the object into a dict
view_allowed_emails_data_dict = view_allowed_emails_data_instance.to_dict()
# create an instance of ViewAllowedEmailsData from a dict
view_allowed_emails_data_from_dict = ViewAllowedEmailsData.from_dict(view_allowed_emails_data_dict)
```
