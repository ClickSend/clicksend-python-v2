...
json = "{}"
# create an instance of ViewSmsCampaignsData from a JSON string
view_sms_campaigns_data_instance = ViewSmsCampaignsData.from_json(json)
# print the JSON string representation of the object
print(ViewSmsCampaignsData.to_json())

# convert the object into a dict
view_sms_campaigns_data_dict = view_sms_campaigns_data_instance.to_dict()
# create an instance of ViewSmsCampaignsData from a dict
view_sms_campaigns_data_from_dict = ViewSmsCampaignsData.from_dict(view_sms_campaigns_data_dict)
```
