...
json = "{}"
# create an instance of ViewAllTransactionsData from a JSON string
view_all_transactions_data_instance = ViewAllTransactionsData.from_json(json)
# print the JSON string representation of the object
print(ViewAllTransactionsData.to_json())

# convert the object into a dict
view_all_transactions_data_dict = view_all_transactions_data_instance.to_dict()
# create an instance of ViewAllTransactionsData from a dict
view_all_transactions_data_from_dict = ViewAllTransactionsData.from_dict(view_all_transactions_data_dict)
```
