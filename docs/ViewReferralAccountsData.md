...
json = "{}"
# create an instance of ViewReferralAccountsData from a JSON string
view_referral_accounts_data_instance = ViewReferralAccountsData.from_json(json)
# print the JSON string representation of the object
print(ViewReferralAccountsData.to_json())

# convert the object into a dict
view_referral_accounts_data_dict = view_referral_accounts_data_instance.to_dict()
# create an instance of ViewReferralAccountsData from a dict
view_referral_accounts_data_from_dict = ViewReferralAccountsData.from_dict(view_referral_accounts_data_dict)
```
