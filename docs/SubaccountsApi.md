...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.SubaccountsApi(api_client)
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountsApi->delete_subaccount:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountsApi->delete_subaccount: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountsApi->generate_new_api_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountsApi->generate_new_api_key: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountsApi->update_subaccount:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountsApi->update_subaccount: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountsApi->view_specific_subaccount:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountsApi->view_specific_subaccount: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountsApi->view_subaccounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountsApi->view_subaccounts: %s\n" % e)
```
