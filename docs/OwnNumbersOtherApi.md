# clicksend.OwnNumbersOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_own_number**](OwnNumbersOtherApi.md#delete_own_number) | **DELETE** /v3/own-numbers/{own_number_id} | Delete Own Number
[**get_own_number_detail**](OwnNumbersOtherApi.md#get_own_number_detail) | **GET** /v3/own-numbers/{own_number_id} | Get Own Number Detail
[**list_own_numbers**](OwnNumbersOtherApi.md#list_own_numbers) | **GET** /v3/own-numbers | List Own Numbers
[**request_own_number_verification_otp**](OwnNumbersOtherApi.md#request_own_number_verification_otp) | **POST** /v3/own-numbers/verifications | Request Own Number Verification OTP
[**update_own_number**](OwnNumbersOtherApi.md#update_own_number) | **PATCH** /v3/own-numbers/{own_number_id} | Update Own Number
[**verify_own_number_otp**](OwnNumbersOtherApi.md#verify_own_number_otp) | **POST** /v3/own-numbers/verifications/{verification_id}/verify | Verify Own Number OTP
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.OwnNumbersOtherApi(api_client)
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->delete_own_number:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->delete_own_number: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->get_own_number_detail:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->get_own_number_detail: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->list_own_numbers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->list_own_numbers: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->request_own_number_verification_otp:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->request_own_number_verification_otp: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->update_own_number:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->update_own_number: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OwnNumbersOtherApi->verify_own_number_otp:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OwnNumbersOtherApi->verify_own_number_otp: %s\n" % e)
```
