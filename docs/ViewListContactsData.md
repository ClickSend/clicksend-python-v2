...
view_list_contacts_data_instance = ViewListContactsData.from_json(json)
# print the JSON string representation of the object
print(ViewListContactsData.to_json())

# convert the object into a dict
view_list_contacts_data_dict = view_list_contacts_data_instance.to_dict()
# create an instance of ViewListContactsData from a dict
view_list_contacts_data_from_dict = ViewListContactsData.from_dict(view_list_contacts_data_dict)
```
