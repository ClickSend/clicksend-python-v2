...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.StatisticsApi(api_client)
    content_type = 'application/json' # str |  (optional)

    try:
        # View SMS Statistics
        api_response = api_instance.view_sms_statistics(content_type=content_type)
        print("The response of StatisticsApi->view_sms_statistics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StatisticsApi->view_sms_statistics: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StatisticsApi->view_voice_statistics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StatisticsApi->view_voice_statistics: %s\n" % e)
```
