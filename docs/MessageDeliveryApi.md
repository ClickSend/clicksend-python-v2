...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.MessageDeliveryApi(api_client)
    ...
    try:
        ...
        print("The response of MessageDeliveryApi->create_delivery_issue:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MessageDeliveryApi->create_delivery_issue: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MessageDeliveryApi->get_all_delivery_issues:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MessageDeliveryApi->get_all_delivery_issues: %s\n" % e)
```
