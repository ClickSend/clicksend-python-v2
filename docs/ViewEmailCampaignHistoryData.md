...
json = "{}"
# create an instance of ViewEmailCampaignHistoryData from a JSON string
view_email_campaign_history_data_instance = ViewEmailCampaignHistoryData.from_json(json)
# print the JSON string representation of the object
print(ViewEmailCampaignHistoryData.to_json())

# convert the object into a dict
view_email_campaign_history_data_dict = view_email_campaign_history_data_instance.to_dict()
# create an instance of ViewEmailCampaignHistoryData from a dict
view_email_campaign_history_data_from_dict = ViewEmailCampaignHistoryData.from_dict(view_email_campaign_history_data_dict)
```
