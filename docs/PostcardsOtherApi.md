# clicksend.PostcardsOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**calculate_postcard_price**](PostcardsOtherApi.md#calculate_postcard_price) | **POST** /v3/post/postcards/price | Calculate Postcard Price
[**cancel_scheduled_postcard**](PostcardsOtherApi.md#cancel_scheduled_postcard) | **PUT** /v3/post/postcards/{message_id}/cancel | Cancel Scheduled Postcard
[**export_postcard_history**](PostcardsOtherApi.md#export_postcard_history) | **GET** /v3/post/postcards/history/export | Export Postcard History
[**send_postcard**](PostcardsOtherApi.md#send_postcard) | **POST** /v3/post/postcards/send | Send Postcard
[**view_postcard_history**](PostcardsOtherApi.md#view_postcard_history) | **GET** /v3/post/postcards/history | View Postcard History
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.PostcardsOtherApi(api_client)
    ...
    try:
        ...
        print("The response of PostcardsOtherApi->calculate_postcard_price:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostcardsOtherApi->calculate_postcard_price: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostcardsOtherApi->cancel_scheduled_postcard:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostcardsOtherApi->cancel_scheduled_postcard: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostcardsOtherApi->export_postcard_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostcardsOtherApi->export_postcard_history: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostcardsOtherApi->send_postcard:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostcardsOtherApi->send_postcard: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostcardsOtherApi->view_postcard_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostcardsOtherApi->view_postcard_history: %s\n" % e)
```
