# clicksend.AlphaTagsOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_alpha_tag**](AlphaTagsOtherApi.md#delete_alpha_tag) | **DELETE** /v3/alpha-tags/{alpha_tag_id} | Delete Alpha Tag
[**get_alpha_tag**](AlphaTagsOtherApi.md#get_alpha_tag) | **GET** /v3/alpha-tags/{alpha_tag_id} | Get Alpha Tag
[**list_alpha_tags**](AlphaTagsOtherApi.md#list_alpha_tags) | **GET** /v3/alpha-tags | List Alpha Tags
[**request_alpha_tag**](AlphaTagsOtherApi.md#request_alpha_tag) | **POST** /v3/alpha-tags | Request Alpha Tag
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.AlphaTagsOtherApi(api_client)
    ...
    try:
        ...
        print("Exception when calling AlphaTagsOtherApi->delete_alpha_tag: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AlphaTagsOtherApi->get_alpha_tag:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AlphaTagsOtherApi->get_alpha_tag: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AlphaTagsOtherApi->list_alpha_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AlphaTagsOtherApi->list_alpha_tags: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AlphaTagsOtherApi->request_alpha_tag:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AlphaTagsOtherApi->request_alpha_tag: %s\n" % e)
```
