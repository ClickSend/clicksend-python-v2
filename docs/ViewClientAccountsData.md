...
json = "{}"
# create an instance of ViewClientAccountsData from a JSON string
view_client_accounts_data_instance = ViewClientAccountsData.from_json(json)
# print the JSON string representation of the object
print(ViewClientAccountsData.to_json())

# convert the object into a dict
view_client_accounts_data_dict = view_client_accounts_data_instance.to_dict()
# create an instance of ViewClientAccountsData from a dict
view_client_accounts_data_from_dict = ViewClientAccountsData.from_dict(view_client_accounts_data_dict)
```
