...
json = "{}"
# create an instance of ViewSmsTemplatesData from a JSON string
view_sms_templates_data_instance = ViewSmsTemplatesData.from_json(json)
# print the JSON string representation of the object
print(ViewSmsTemplatesData.to_json())

# convert the object into a dict
view_sms_templates_data_dict = view_sms_templates_data_instance.to_dict()
# create an instance of ViewSmsTemplatesData from a dict
view_sms_templates_data_from_dict = ViewSmsTemplatesData.from_dict(view_sms_templates_data_dict)
```
