# clicksend.UrlShorteningOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**short_url_get_statistics**](UrlShorteningOtherApi.md#short_url_get_statistics) | **GET** /v3/short-url/statistics/{source}/{source_id} | Get Statistics
[**short_url_get_tracking**](UrlShorteningOtherApi.md#short_url_get_tracking) | **GET** /v3/short-url/tracking/{long_url_id} | Get Tracking
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.UrlShorteningOtherApi(api_client)
    ...
    try:
        ...
        print("The response of UrlShorteningOtherApi->short_url_get_statistics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UrlShorteningOtherApi->short_url_get_statistics: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UrlShorteningOtherApi->short_url_get_tracking:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UrlShorteningOtherApi->short_url_get_tracking: %s\n" % e)
```
