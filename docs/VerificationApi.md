...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.VerificationApi(api_client)
    ...
    try:
        ...
        print("The response of VerificationApi->forgot_password:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VerificationApi->forgot_password: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VerificationApi->forgot_username:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VerificationApi->forgot_username: %s\n" % e)
```
