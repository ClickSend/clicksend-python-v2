...
json = "{}"
# create an instance of ViewSmsDeliveryReceiptRulesData from a JSON string
view_sms_delivery_receipt_rules_data_instance = ViewSmsDeliveryReceiptRulesData.from_json(json)
# print the JSON string representation of the object
print(ViewSmsDeliveryReceiptRulesData.to_json())

# convert the object into a dict
view_sms_delivery_receipt_rules_data_dict = view_sms_delivery_receipt_rules_data_instance.to_dict()
# create an instance of ViewSmsDeliveryReceiptRulesData from a dict
view_sms_delivery_receipt_rules_data_from_dict = ViewSmsDeliveryReceiptRulesData.from_dict(view_sms_delivery_receipt_rules_data_dict)
```
