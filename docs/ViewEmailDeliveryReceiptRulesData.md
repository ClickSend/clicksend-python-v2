...
json = "{}"
# create an instance of ViewEmailDeliveryReceiptRulesData from a JSON string
view_email_delivery_receipt_rules_data_instance = ViewEmailDeliveryReceiptRulesData.from_json(json)
# print the JSON string representation of the object
print(ViewEmailDeliveryReceiptRulesData.to_json())

# convert the object into a dict
view_email_delivery_receipt_rules_data_dict = view_email_delivery_receipt_rules_data_instance.to_dict()
# create an instance of ViewEmailDeliveryReceiptRulesData from a dict
view_email_delivery_receipt_rules_data_from_dict = ViewEmailDeliveryReceiptRulesData.from_dict(view_email_delivery_receipt_rules_data_dict)
```
