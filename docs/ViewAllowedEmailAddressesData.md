...
json = "{}"
# create an instance of ViewAllowedEmailAddressesData from a JSON string
view_allowed_email_addresses_data_instance = ViewAllowedEmailAddressesData.from_json(json)
# print the JSON string representation of the object
print(ViewAllowedEmailAddressesData.to_json())

# convert the object into a dict
view_allowed_email_addresses_data_dict = view_allowed_email_addresses_data_instance.to_dict()
# create an instance of ViewAllowedEmailAddressesData from a dict
view_allowed_email_addresses_data_from_dict = ViewAllowedEmailAddressesData.from_dict(view_allowed_email_addresses_data_dict)
```
