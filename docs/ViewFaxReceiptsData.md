...
json = "{}"
# create an instance of ViewFaxReceiptsData from a JSON string
view_fax_receipts_data_instance = ViewFaxReceiptsData.from_json(json)
# print the JSON string representation of the object
print(ViewFaxReceiptsData.to_json())

# convert the object into a dict
view_fax_receipts_data_dict = view_fax_receipts_data_instance.to_dict()
# create an instance of ViewFaxReceiptsData from a dict
view_fax_receipts_data_from_dict = ViewFaxReceiptsData.from_dict(view_fax_receipts_data_dict)
```
