...
json = "{}"
# create an instance of ResellerAccount from a JSON string
reseller_account_instance = ResellerAccount.from_json(json)
# print the JSON string representation of the object
print(ResellerAccount.to_json())

# convert the object into a dict
reseller_account_dict = reseller_account_instance.to_dict()
# create an instance of ResellerAccount from a dict
reseller_account_from_dict = ResellerAccount.from_dict(reseller_account_dict)
```
