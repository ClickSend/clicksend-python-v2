# clicksend.InternationalMessagingOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**agree_to_rules_and_regulation**](InternationalMessagingOtherApi.md#agree_to_rules_and_regulation) | **POST** /v3/user-countries/agree | Agree to rules and regulation
[**get_countries_for_global_sending**](InternationalMessagingOtherApi.md#get_countries_for_global_sending) | **GET** /v3/user-countries | Get Countries for Global Sending
[**list_countries**](InternationalMessagingOtherApi.md#list_countries) | **GET** /v3/country-list | International Messaging
[**select_countries_for_global_sending**](InternationalMessagingOtherApi.md#select_countries_for_global_sending) | **POST** /v3/user-countries | Select Countries for Global Sending
[**timezones**](InternationalMessagingOtherApi.md#timezones) | **GET** /v3/timezones | Timezones
[**view_countries**](InternationalMessagingOtherApi.md#view_countries) | **GET** /v3/countries | View Countries
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.InternationalMessagingOtherApi(api_client)

    try:
        # Agree to rules and regulation
        api_response = api_instance.agree_to_rules_and_regulation()
        print("The response of InternationalMessagingOtherApi->agree_to_rules_and_regulation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->agree_to_rules_and_regulation: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternationalMessagingOtherApi->get_countries_for_global_sending:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->get_countries_for_global_sending: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternationalMessagingOtherApi->list_countries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->list_countries: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternationalMessagingOtherApi->select_countries_for_global_sending:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->select_countries_for_global_sending: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternationalMessagingOtherApi->timezones:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->timezones: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternationalMessagingOtherApi->view_countries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternationalMessagingOtherApi->view_countries: %s\n" % e)
```
