...
json = "{}"
# create an instance of ViewAvailableNumbersData from a JSON string
view_available_numbers_data_instance = ViewAvailableNumbersData.from_json(json)
# print the JSON string representation of the object
print(ViewAvailableNumbersData.to_json())

# convert the object into a dict
view_available_numbers_data_dict = view_available_numbers_data_instance.to_dict()
# create an instance of ViewAvailableNumbersData from a dict
view_available_numbers_data_from_dict = ViewAvailableNumbersData.from_dict(view_available_numbers_data_dict)
```
