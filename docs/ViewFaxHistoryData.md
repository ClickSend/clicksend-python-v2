...
json = "{}"
# create an instance of ViewFaxHistoryData from a JSON string
view_fax_history_data_instance = ViewFaxHistoryData.from_json(json)
# print the JSON string representation of the object
print(ViewFaxHistoryData.to_json())

# convert the object into a dict
view_fax_history_data_dict = view_fax_history_data_instance.to_dict()
# create an instance of ViewFaxHistoryData from a dict
view_fax_history_data_from_dict = ViewFaxHistoryData.from_dict(view_fax_history_data_dict)
```
