...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.NumbersApi(api_client)
    ...
    try:
        ...
        print("The response of NumbersApi->purchase_dedicated_number:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NumbersApi->purchase_dedicated_number: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NumbersApi->register_numbers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NumbersApi->register_numbers: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NumbersApi->view_available_numbers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NumbersApi->view_available_numbers: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NumbersApi->view_your_numbers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NumbersApi->view_your_numbers: %s\n" % e)
```
