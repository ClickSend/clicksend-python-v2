...
json = "{}"
# create an instance of ViewMmsHistoryData from a JSON string
view_mms_history_data_instance = ViewMmsHistoryData.from_json(json)
# print the JSON string representation of the object
print(ViewMmsHistoryData.to_json())

# convert the object into a dict
view_mms_history_data_dict = view_mms_history_data_instance.to_dict()
# create an instance of ViewMmsHistoryData from a dict
view_mms_history_data_from_dict = ViewMmsHistoryData.from_dict(view_mms_history_data_dict)
```
