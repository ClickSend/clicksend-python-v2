...
json = "{}"
# create an instance of ViewFaxDeliveryReceiptRulesData from a JSON string
view_fax_delivery_receipt_rules_data_instance = ViewFaxDeliveryReceiptRulesData.from_json(json)
# print the JSON string representation of the object
print(ViewFaxDeliveryReceiptRulesData.to_json())

# convert the object into a dict
view_fax_delivery_receipt_rules_data_dict = view_fax_delivery_receipt_rules_data_instance.to_dict()
# create an instance of ViewFaxDeliveryReceiptRulesData from a dict
view_fax_delivery_receipt_rules_data_from_dict = ViewFaxDeliveryReceiptRulesData.from_dict(view_fax_delivery_receipt_rules_data_dict)
```
