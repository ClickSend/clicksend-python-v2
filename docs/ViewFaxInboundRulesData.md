...
json = "{}"
# create an instance of ViewFaxInboundRulesData from a JSON string
view_fax_inbound_rules_data_instance = ViewFaxInboundRulesData.from_json(json)
# print the JSON string representation of the object
print(ViewFaxInboundRulesData.to_json())

# convert the object into a dict
view_fax_inbound_rules_data_dict = view_fax_inbound_rules_data_instance.to_dict()
# create an instance of ViewFaxInboundRulesData from a dict
view_fax_inbound_rules_data_from_dict = ViewFaxInboundRulesData.from_dict(view_fax_inbound_rules_data_dict)
```
