...
json = "{}"
# create an instance of ViewSmsHistoryData from a JSON string
view_sms_history_data_instance = ViewSmsHistoryData.from_json(json)
# print the JSON string representation of the object
print(ViewSmsHistoryData.to_json())

# convert the object into a dict
view_sms_history_data_dict = view_sms_history_data_instance.to_dict()
# create an instance of ViewSmsHistoryData from a dict
view_sms_history_data_from_dict = ViewSmsHistoryData.from_dict(view_sms_history_data_dict)
```
