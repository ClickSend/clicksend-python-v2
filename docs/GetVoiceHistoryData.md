...
json = "{}"
# create an instance of GetVoiceHistoryData from a JSON string
get_voice_history_data_instance = GetVoiceHistoryData.from_json(json)
# print the JSON string representation of the object
print(GetVoiceHistoryData.to_json())

# convert the object into a dict
get_voice_history_data_dict = get_voice_history_data_instance.to_dict()
# create an instance of GetVoiceHistoryData from a dict
get_voice_history_data_from_dict = GetVoiceHistoryData.from_dict(get_voice_history_data_dict)
```
