...
json = "{}"
# create an instance of ViewPostcardHistoryData from a JSON string
view_postcard_history_data_instance = ViewPostcardHistoryData.from_json(json)
# print the JSON string representation of the object
print(ViewPostcardHistoryData.to_json())

# convert the object into a dict
view_postcard_history_data_dict = view_postcard_history_data_instance.to_dict()
# create an instance of ViewPostcardHistoryData from a dict
view_postcard_history_data_from_dict = ViewPostcardHistoryData.from_dict(view_postcard_history_data_dict)
```
