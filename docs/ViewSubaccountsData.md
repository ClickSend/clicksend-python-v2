...
json = "{}"
# create an instance of ViewSubaccountsData from a JSON string
view_subaccounts_data_instance = ViewSubaccountsData.from_json(json)
# print the JSON string representation of the object
print(ViewSubaccountsData.to_json())

# convert the object into a dict
view_subaccounts_data_dict = view_subaccounts_data_instance.to_dict()
# create an instance of ViewSubaccountsData from a dict
view_subaccounts_data_from_dict = ViewSubaccountsData.from_dict(view_subaccounts_data_dict)
```
