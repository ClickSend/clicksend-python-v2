...
json = "{}"
# create an instance of ViewAllMmsCampaignsData from a JSON string
view_all_mms_campaigns_data_instance = ViewAllMmsCampaignsData.from_json(json)
# print the JSON string representation of the object
print(ViewAllMmsCampaignsData.to_json())

# convert the object into a dict
view_all_mms_campaigns_data_dict = view_all_mms_campaigns_data_instance.to_dict()
# create an instance of ViewAllMmsCampaignsData from a dict
view_all_mms_campaigns_data_from_dict = ViewAllMmsCampaignsData.from_dict(view_all_mms_campaigns_data_dict)
```
