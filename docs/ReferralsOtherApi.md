# clicksend.ReferralsOtherApi

All URIs are relative to *https://rest.clicksend.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**view_referral_accounts**](ReferralsOtherApi.md#view_referral_accounts) | **GET** /v3/referral/accounts/ | View Referral Accounts
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.ReferralsOtherApi(api_client)
    content_type = 'application/json' # str |  (optional)

    try:
        # View Referral Accounts
        api_response = api_instance.view_referral_accounts(content_type=content_type)
        print("The response of ReferralsOtherApi->view_referral_accounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReferralsOtherApi->view_referral_accounts: %s\n" % e)
```
