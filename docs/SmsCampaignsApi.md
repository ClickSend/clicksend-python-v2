...
with clicksend.ApiClient(configuration) as api_client:
    ...
    api_instance = clicksend.SmsCampaignsApi(api_client)
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->calculate_sms_campaign_price:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmsCampaignsApi->calculate_sms_campaign_price: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->cancel_sms_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmsCampaignsApi->cancel_sms_campaign: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->send_sms_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmsCampaignsApi->send_sms_campaign: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->update_sms_campaign:\n")
        pprint(api_response)
    except Exception as e:
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->view_sms_campaigns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmsCampaignsApi->view_sms_campaigns: %s\n" % e)
```
...
with clicksend.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmsCampaignsApi->view_specific_sms_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmsCampaignsApi->view_specific_sms_campaign: %s\n" % e)
```
